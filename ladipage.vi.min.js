"function" != typeof String.prototype.startsWith && (String.prototype.startsWith = function (t) {
    ...
    var i = this.length >>> 0, a = new Array(i), n = this, o = 0, r = -1;
    if (void 0 === e) for (; ++r !== i;) if (r in this) if (t(n[r], r, n)) a[o++] = n[r]; else for (; ++r !== i;) r in this && t.call(e, n[r], r, n) && (a[o++] = n[r]);
    return a.length = o, a
    ...
    "use strict";
    var t = Object.prototype.hasOwnProperty, e = !{toString: null}.propertyIsEnumerable("toString"), i = ["toString", "toLocaleString", "valueOf", "hasOwnProperty", "isPrototypeOf", "propertyIsEnumerable", "constructor"], a = i.length;
    return function (n) {
...
LadiPageScriptV2.prototype.init = function () {
    this.const = {
        ...
        POSITION_TYPE: {default: "default", top: "top", bottom: "bottom", top_left: "top_left", top_center: "top_center", top_right: "top_right", center_left: "center_left", center_right: "center_right", bottom_left: "bottom_left", bottom_center: "bottom_center", bottom_right: "bottom_right"},
        COLLECTION_TYPE: {carousel: "carousel", readmore: "readmore"},
        INPUT_TYPE: {tel: "tel", password: "password", text: "text", date: "date", select_multiple: "select_multiple", number: "number", email: "email", textarea: "textarea", select: "select", radio: "radio", checkbox: "checkbox", facebook_checkbox_plugin_transactional: "facebook_checkbox_plugin_transactional", facebook_checkbox_plugin_promotional: "facebook_checkbox_plugin_promotional", file: "file", image_choices: "image_choices", product_variant: "product_variant"},
        ...
        TOOLTIP_POSITION: {top_left: "top_left", top_middle: "top_middle", top_right: "top_right", bottom_left: "bottom_left", bottom_middle: "bottom_middle", bottom_right: "bottom_right", left_top: "left_top", left_middle: "left_middle", left_bottom: "left_bottom", right_top: "right_top", right_middle: "right_middle", right_bottom: "right_bottom"},
...
var Base64 = {
    _keyStr: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", encode: function (t) {
        var e, i, a, n, o, r, d, s = "", l = 0;
        for (t = Base64._utf8_encode(t); l < t.length;) n = (e = t.charCodeAt(l++)) >> 2, o = (3 & e) << 4 | (i = t.charCodeAt(l++)) >> 4, r = (15 & i) << 2 | (a = t.charCodeAt(l++)) >> 6, d = 63 & a, isNaN(i) ? r = d = 64 : isNaN(a) && (d = 64), s = s + Base64._keyStr.charAt(n) + Base64._keyStr.charAt(o) + Base64._keyStr.charAt(r) + Base64._keyStr.charAt(d);
        return s
    }, decode: function (t) {
        var e, i, a, n, o, r, d = "", s = 0;
        for (t = t.replace(/[^A-Za-z0-9\+\/\=]/g, ""); s < t.length;) e = Base64._keyStr.indexOf(t.charAt(s++)) << 2 | (n = Base64._keyStr.indexOf(t.charAt(s++))) >> 4, i = (15 & n) << 4 | (o = Base64._keyStr.indexOf(t.charAt(s++))) >> 2, a = (3 & o) << 6 | (r = Base64._keyStr.indexOf(t.charAt(s++))), d += String.fromCharCode(e), 64 != o && (d += String.fromCharCode(i)), 64 != r && (d += String.fromCharCode(a));
...
}, LadiFormApi = LadiFormApi || {}, LadiPageCommand = LadiPageCommand || [], LadiPageTrackingCommandList = LadiPageTrackingCommandList || [], LadiPageTrackingCommand = {
    push: function (t, e) {
        isFunctionLadiPage(t) && isFunctionLadiPage(e) && (t() ? e() : LadiPageTrackingCommandList.push({callback1: t, callback2: e}))
    }
};
LadiPageScriptV2.prototype.loadDataset = function (t, e, i, a, n, o, r, d) {
    ...
    for (var e = this, i = 0, a = [], n = document.querySelectorAll(".ladi-section[data-global-id]"), o = 0; o < n.length; o++) {
        var r = n[o], d = r.getAttribute("data-global-id");
    ...
    var s = function (n) {
        ...
        i == a.length && function (t) {
            ...
            document.querySelectorAll('.ladi-section-global[data-dataset="true"]').length > 0 && !e.runtime.has_dataset && (e.runtime.has_dataset = !0, e.runtime.hasOwnProperty("cdn_url") && e.runtime.hasOwnProperty("version") && e.loadScript(e.runtime.cdn_url + "dataset.min.js?v=" + e.runtime.version)), e.runtime.isLoadHtmlGlobal = !0, e.run(t)
        })
    };
    a.forEach(function (t) {
        var a = t.id, n = document.getElementById(a), o = LadiPageScript.const.API_SECTION_GLOBAL_HTML.format(e.runtime.store_id, t.data_global_id);
        e.sendRequest("GET", o, null, !0, null, function (o, r, d) {
            if (d.readyState == XMLHttpRequest.DONE) {
                var l = document.createElement("div");
                l.innerHTML = o, isEmptyLadiPage(l.querySelector('div.ladi-section-global[data-id="' + t.id + '"] .ladi-section[data-global-id="' + t.data_global_id + '"]')) ? n.parentElement.removeChild(n) : n.outerHTML = o, function (t) {
                    i++;
                    var a = document.querySelector('.ladi-section-global[data-id="' + t + '"] > script');
                    if (isEmptyLadiPage(a)) s(); else {
                        var n = null;
                        try {
    ...
    var r = this;
    if (a != n) {
        var d = "style_update_height_element", s = !0;
    ...
    var a = this, n = document.getElementById(t), o = null;
    if (!isEmptyLadiPage(n)) {
        var r = document.getElementById(t + "_button_unmute"), d = isEmptyLadiPage(r);
        if (e == a.const.VIDEO_TYPE.youtube) {
            ...
            if (a.runtime.isYouTubeIframeAPIReady) {
                ...
                if (!isEmptyLadiPage(l)) {
                    if (d && i && isFunctionLadiPage(l.unMute) && l.unMute(), !d && i && isFunctionLadiPage(l.mute) && l.mute(), !isFunctionLadiPage(l[o])) return void a.runTimeout(function () {
                        a.runEventReplayVideo(t, e, i)
                    }, 100);
                    l[o](), s = !0
                }
            }
            s || (d && i && a.postMessageWindow(n.contentWindow, {event: "command", func: "unMute", args: []}, "*"), !d && i && a.postMessageWindow(n.contentWindow, {event: "command", func: "mute", args: []}, "*"), a.postMessageWindow(n.contentWindow, {event: "command", func: o, args: []}, "*"))
        }
    ...
    var c = this, u = c.runtime.isVideoButtonUnmute;
    (c.runtime.isDesktop || r || d || n || a) && (u = !1);
    var p = function (t, i) {
        if (u && !t.hasAttribute("data-remove-button-unmute")) {
            var a = t.id + "_button_unmute", n = document.getElementById(a);
    ...
    if (!isEmptyLadiPage(m)) {
        ...
        if (e == c.const.VIDEO_TYPE.youtube) {
            var v = c.getVideoId(e, i), P = function () {
                try {
                    ...
                    }, c.loadScript("https://www.youtube.com/iframe_api")), !c.runtime.isYouTubeIframeAPIReady) return void c.runtime.list_youtube_ready_exec.push(P);
                    ...
                    new window.YT.Player(t, {
                        videoId: v, playerVars: {rel: 0, modestbranding: 0, playsinline: n || a || s || u ? 1 : 0, controls: !n && o ? 1 : 0}, events: {
                            onReady: g, onStateChange: function (i) {
        ...
        if (e == c.const.VIDEO_TYPE.direct) {
            isEmptyLadiPage(_) || m.setAttribute("poster", _), m.setAttribute("preload", "auto"), m.setAttribute("controlslist", "nodownload"), m.setAttribute("loop", ""), r || d || m.setAttribute("autoplay", ""), (n || a || s || u) && (m.setAttribute("playsinline", ""), m.setAttribute("webkit-playsinline", "")), !n && o && m.setAttribute("controls", ""), a || u ? m.setAttribute("muted", "") : m.removeAttribute("muted"), n && m.classList.add("opacity-0");
            var h = function () {
                n && (m = document.getElementById(t)).classList.remove("opacity-0")
            };
            m.removeAttribute("src"), m.setAttribute("data-src", i), m.outerHTML = m.outerHTML.replaceAll("data-src=", "src="), m = document.getElementById(t), isFunctionLadiPage(l) && l(m), m.addEventListener("loadedmetadata", function (t) {
                p(m)
            }), m.addEventListener("error", h), m.addEventListener("playing", function (t) {
                if (n) {
                    var e = function () {
                        m.currentTime >= .1 ? h() : c.runTimeout(e, 100)
                    };
                    e()
                }
                p(m, !0);
    ...
    if (!isEmptyLadiPage(r)) {
        ...
        if (o || n || this.pauseAllVideo(), isEmptyLadiPage(d)) {
            var s = r.getElementsByClassName("ladi-video")[0], l = t + "_player";
            e == this.const.VIDEO_TYPE.youtube && (s.innerHTML = s.innerHTML + '<iframe id="' + l + '" class="iframe-video-preload" data-video-type="' + e + '" style="position: absolute; width: 100%; height: 100%; top: 0; left: 0;" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>', this.runEventPlayVideo(l, e, i, n, !1, a, o)), e == this.const.VIDEO_TYPE.direct && (s.innerHTML = s.innerHTML + '<video id="' + l + '" class="iframe-video-preload" data-video-type="' + e + '" style="position: absolute; width: 100%; height: 100%; top: 0; left: 0; object-fit: cover;"></video>', this.runEventPlayVideo(l, e, i, n, !1, a, o))
    ...
    var d = t.split("/"), s = d.indexOf("");
    if (-1 != s && d.length > s + 1 && (d[s + 1] = d[s + 1].toLowerCase()), s = d.indexOf(this.const.STATIC_W_DOMAIN.toLowerCase()), this.checkResizeImage(t) && -1 != s && (d.length == s + 3 || d.length == s + 6 && "ls" == d[3] && "product" == d[5] || d.length == s + 4 && "luid" == d[3] && "avatar" == d[4] || d.length == s + 4 && "rbg" == d[4])) {
        var l = d[s + 1].toLowerCase(), c = !0;
        if (l.startsWith("s")) {
            var u = l.split("x");
    ...
    var t = this, e = t.runtime.story_page;
    if (isObjectLadiPage(e)) {
        ...
        if (!isEmptyLadiPage(i)) {
            ...
            if (0 != n.length) {
                ...
                l(o, !1), t.runtime.tmp.story_page_timeout_id = t.runTimeout(c, 300), document.addEventListener("mousedown", function (e) {
                    ...
                    isEmptyLadiPage(t.runtime.tmp.current_default_popup_id) && (t.runtime.tmp.story_page_scroll = !0, t.removeTimeout(t.runtime.tmp.story_page_scroll_timeout_id), t.removeTimeout(t.runtime.tmp.story_page_timeout_id), t.runtime.tmp.story_page_scroll_timeout_id = t.runTimeout(function () {
                        var a = 0, n = e.type == t.const.STORY_PAGE.horizontal ? i.scrollLeft / i.clientWidth : i.scrollTop / i.clientHeight;
    ...
    if (isObjectLadiPage(t)) {
        ...
        e.conversion_name = t.event_value, e.google_ads_conversion = t.event_id, e.google_ads_label = t.event_label, e.purchase_value = t.purchase_value, e.event_category = "LadiPageThankYouPage", this.runEventTracking(null, e), delete this.runtime.thankyou_page
    }
    ...
    try {
        for (var e = document.querySelectorAll(".ladi-section .ladi-section-background iframe.ladi-section-background-video"), i = 0; i < e.length; i++) {
            var a = e[i], n = parseFloatLadiPage(a.getAttribute("width")) || 0, o = parseFloatLadiPage(a.getAttribute("height")) || 0;
            if (!(n <= 0 || o <= 0)) {
                var r = t.findAncestor(a, "ladi-section-background"), d = r.clientWidth, s = o / n * d;
                s < r.clientHeight && (d = r.clientHeight / s * d, s = r.clientHeight);
                var l = (r.clientHeight - s) / 2, c = (r.clientWidth - d) / 2;
                a.style.setProperty("top", (parseFloatLadiPage(l) || 0) + "px"), a.style.setProperty("left", (parseFloatLadiPage(c) || 0) + "px"), a.style.setProperty("width", (parseFloatLadiPage(d) || 0) + "px"), a.style.setProperty("height", (parseFloatLadiPage(s) || 0) + "px")
            }
        }
    } catch (t) {
    }
    ...
    try {
        ...
        for (var e = document.querySelectorAll("#" + t.runtime.builder_section_popup_id + " .ladi-container > .ladi-element"), i = 0; i < e.length; i++) "none" != getComputedStyle(e[i]).display && (t.runtime.tmp.is_resize_all = !0, window.ladi(e[i].id).show(!0, {checkHidePopupOther: !1}));
    ...
    if (e instanceof LadiPageScriptV2 || (e = LadiPageScript), e.runtime.tmp.is_loaded_func_done) {
        ...
        if (t && isObjectLadiPage(e.runtime.story_page)) {
            ...
            for (var d = document.querySelectorAll(".ladi-gallery .ladi-gallery-view-item.selected:not(.ladi-lazyload)"), s = 0; s < d.length; s++) if (isEmptyLadiPage(d[s].getAttribute("data-lazyload"))) {
    ...
    var e = t.getURLSearchParams(null, null, !0), i = e.ladishow, a = e.ladihide, n = e.laditop, o = window.location.hash;
    ...
    try {
        var r = window.ladi("LADI_CAMP_END_DATE").get_cookie(), d = window.ladi("LADI_CAMP_CONFIG").get_cookie();
    ...
    if (isObjectLadiPage(window.ladi_conversion_api) && isObjectLadiPage(window.ladi_conversion_api.facebook) && isArrayLadiPage(window.ladi_conversion_api.facebook.pixels) && isArrayLadiPage(window.ladi_conversion_api.facebook.events) && isFunctionLadiPage(window.fbq)) {
        window.ladi_conversion_api.facebook.pixels = window.ladi_conversion_api.facebook.pixels.unique(), window.ladi_conversion_api.facebook.fbc = window.ladi("_fbc").get_cookie(), window.ladi_conversion_api.facebook.fbp = window.ladi("_fbp").get_cookie();
        ...
        this.runtime.tmp.runTrackingAnalytics("ConversionApi", {data: window.ladi_conversion_api}), delete window.ladi_conversion_api.facebook.fbc, delete window.ladi_conversion_api.facebook.fbp, delete window.ladi_conversion_api.facebook.events
    }
    ...
    var i = this.createTmpElement("a", "", {href: t}), a = this.getURLSearchParams(e, null, !1);
    if (!isEmptyLadiPage(i.href) && !isEmptyLadiPage(i.host)) {
        ...
        var o = [];
        isArrayLadiPage(window.LadiPageURLSearchParamsCustom) && (o = window.LadiPageURLSearchParamsCustom), isStringLadiPage(window.LadiPageURLSearchParamsCustom) && (o = [window.LadiPageURLSearchParamsCustom]), o.forEach(function (t) {
            isEmptyLadiPage(n[t]) && !isEmptyLadiPage(a[t]) && (i.search = i.search + (isEmptyLadiPage(i.search) ? "?" : "&") + t + "=" + encodeURIComponent(a[t]))
        })
    }
    return i.href
    ...
    var a = {}, n = isNullLadiPage(t);
    if (t = n ? window.location.search : t, !isEmptyLadiPage(t)) for (var o = t.substr(1).split("&"), r = 0; r < o.length; ++r) {
        var d = o[r].split("=", 2);
    ...
    var r = this, d = function (s) {
        var l = s[e], c = function (s, u) {
            if (l.list.length <= s) 0 == s ? d({}) : isFunctionLadiPage(o) && o(r.const.LANG.REQUEST_SEND_ERROR, 0, u, e); else {
                var p = {};
                p.timeout = l.timeout, p.onreadystatechange = function () {
    ...
    if (this.runtime.has_popupx && this.runtime.request_through_parent) {
        var d = this.randomId();
        return this.runtime.tmp["request_callback_id_" + d] = r, void this.runtime.tmp.runActionPopupX({request_data: {method: t, url: e, data: i, async: a, headers: n, options: o, callback_id: d}, action: {type: "send_request_with_option"}})
    }
    var s = new XMLHttpRequest;
    if (isFunctionLadiPage(this.runtime.send_request_response[e]) && this.runtime.send_request_response[e](e, i, r)) return;
    isFunctionLadiPage(r) && (s.onreadystatechange = function () {
        var t = null;
        try {
            t = this.responseText
        } catch (t) {
    ...
    isEmptyLadiPage(e.runtime.current_element_mouse_down_gallery_control) || (i = document.querySelector('[data-runtime-id="' + e.runtime.current_element_mouse_down_gallery_control + '"]'), a = t.pageX - e.runtime.current_element_mouse_down_gallery_control_position_x, n = parseFloatLadiPage(i.getElementsByClassName("ladi-gallery-control-box")[0].getAttribute("data-left")) || 0, (n += a) < (o = (parseFloatLadiPage(getComputedStyle(i.getElementsByClassName("ladi-gallery-control")[0]).width) || 0) - (parseFloatLadiPage(getComputedStyle(i.getElementsByClassName("ladi-gallery-control-box")[0]).width) || 0)) && (n = o), n > 0 && (n = 0), i.getElementsByClassName("ladi-gallery-control-box")[0].style.setProperty("left", n + "px"))
    ...
    if (isEmptyLadiPage(e.runtime.current_element_mouse_down_gallery_view) || (i = document.querySelector('[data-runtime-id="' + e.runtime.current_element_mouse_down_gallery_view + '"]')).querySelectorAll(".ladi-gallery-view-item.selected").length > 0 && i.querySelectorAll(".ladi-gallery-view-item.selected")[0].style.removeProperty("left"), !isEmptyLadiPage(e.runtime.current_element_mouse_down_gallery_control)) if ((i = document.querySelector('[data-runtime-id="' + e.runtime.current_element_mouse_down_gallery_control + '"]')).getElementsByClassName("ladi-gallery-control-box")[0].removeAttribute("data-left"), i.getElementsByClassName("ladi-gallery-control-box")[0].style.removeProperty("transition-duration"), i.getElementsByClassName("ladi-gallery-control-arrow-left")[0].classList.remove("opacity-0"), i.getElementsByClassName("ladi-gallery-control-arrow-right")[0].classList.remove("opacity-0"), i.getElementsByClassName("ladi-gallery")[0].classList.contains("ladi-gallery-top") || i.getElementsByClassName("ladi-gallery")[0].classList.contains("ladi-gallery-bottom")) {
        var o = parseFloatLadiPage(i.getElementsByClassName("ladi-gallery-control-box")[0].style.getPropertyValue("left")) || 0, r = parseFloatLadiPage(getComputedStyle(i.getElementsByClassName("ladi-gallery-control-box")[0]).width) || 0;
        r = (r = -(r -= parseFloatLadiPage(getComputedStyle(i.getElementsByClassName("ladi-gallery-control")[0]).width) || 0)) > 0 ? 0 : r, o > 0 && (o = 0), o >= 0 && i.getElementsByClassName("ladi-gallery-control-arrow-left")[0].classList.add("opacity-0"), o <= r && i.getElementsByClassName("ladi-gallery-control-arrow-right")[0].classList.add("opacity-0")
    } else {
        var d = parseFloatLadiPage(i.getElementsByClassName("ladi-gallery-control-box")[0].style.getPropertyValue("top")) || 0, s = parseFloatLadiPage(getComputedStyle(i.getElementsByClassName("ladi-gallery-control-box")[0]).height) || 0;
        s = (s = -(s -= parseFloatLadiPage(getComputedStyle(i.getElementsByClassName("ladi-gallery-control")[0]).height) || 0)) > 0 ? 0 : s, d > 0 && (d = 0), d >= 0 && i.getElementsByClassName("ladi-gallery-control-arrow-left")[0].classList.add("opacity-0"), d <= s && i.getElementsByClassName("ladi-gallery-control-arrow-right")[0].classList.add("opacity-0")
    }
    ...
    if (e instanceof LadiPageScriptV2 || (e = LadiPageScript), e.runtime.isRun) {
        if (!isEmptyLadiPage(e.runtime.eventData) && !e.runtime.tmp.is_run_show_popup) {
            ...
            if (Object.keys(e.runtime.eventData).forEach(function (t) {
                var a = e.runtime.eventData[t], n = null, r = null, d = null, s = Object.keys(e.runtime.list_scroll_func), l = [];
                l = "gallery" == a.type ? document.querySelectorAll("#" + t) : [d = document.getElementById(t)];
                for (var c = 0; c < l.length; c++) if (d = l[c], !isEmptyLadiPage(d)) {
                    var u = "gallery" == a.type ? d.getAttribute("data-runtime-id") : d.getAttribute("id");
                    if (-1 != s.indexOf(u)) {
                        var p = !1;
                        "section" == a.type ? (n = d.offsetTop, (window.scrollY >= n && window.scrollY <= n + d.offsetHeight || window.scrollY + e.getHeightDevice() >= n && window.scrollY + e.getHeightDevice() <= n + d.offsetHeight || n >= window.scrollY && window.scrollY + e.getHeightDevice() >= n) && (p = !0)) : (n = e.getElementBoundingClientRect(d).y + window.scrollY, (window.scrollY >= n && window.scrollY <= n + d.offsetHeight || window.scrollY + e.getHeightDevice(!0) >= n && window.scrollY + e.getHeightDevice(!0) <= n + d.offsetHeight || n >= window.scrollY && window.scrollY + e.getHeightDevice(!0) >= n) && (p = !0)), p && (r = e.runtime.list_scroll_func[u], delete e.runtime.list_scroll_func[u], r())
                    }
                }
                ...
                if (!isEmptyLadiPage(m) && (d = document.getElementById(t), !isEmptyLadiPage(d) && !d.classList.contains("ladi-animation"))) {
                    ...
                    var _ = window.scrollY >= n && window.scrollY <= n + d.offsetHeight || window.scrollY + e.getHeightDevice(!0) >= n && window.scrollY + e.getHeightDevice(!0) <= n + d.offsetHeight || n >= window.scrollY && window.scrollY + e.getHeightDevice(!0) >= n;
                    e.runtime.tmp.isFirstScroll && g > 0 && d.classList.add("ladi-animation-hidden"), _ && (d.classList.add("ladi-animation"), e.runTimeout(function () {
                        d.classList.remove("ladi-animation-hidden")
                    }, 1e3 * g))
                }
                if (isEmptyLadiPage(i) || -1 != o.indexOf(t)) {
                    var y = null, f = null, v = null;
                    if (a[e.runtime.device + ".option.sticky"] && (y = a[e.runtime.device + ".option.sticky_position"], f = parseFloatLadiPage(a[e.runtime.device + ".option.sticky_position_top"]), v = parseFloatLadiPage(a[e.runtime.device + ".option.sticky_position_bottom"])), !e.runtime.has_popupx && !isEmptyLadiPage(y)) {
                        var P = document.getElementById(t);
                        if (!isEmptyLadiPage(P) && P.clientWidth > 0 && P.clientHeight > 0 && -1 != ["default", "top", "bottom"].indexOf(y)) {
                            var h = e.getElementBoundingClientRect(P), L = P.getAttribute("data-top"), E = P.getAttribute("data-left");
                            isEmptyLadiPage(L) ? (P.setAttribute("data-top", h.y + window.scrollY), L = h.y) : L = parseFloatLadiPage(L), isEmptyLadiPage(E) ? (P.setAttribute("data-left", h.x + window.scrollX), E = h.x) : E = parseFloatLadiPage(E);
                            var b = null, A = null, w = e.getHeightDevice(), T = document.getElementsByClassName("ladi-wraper")[0], S = 0, O = 0, C = 0, N = 0;
                            if ("default" == y && (f >= L - window.scrollY ? (b = f + "px", A = E + "px", f <= 0 && (S = P.clientHeight), C = P.clientHeight) : w - v - P.clientHeight <= L - window.scrollY && (b = "calc(100% - " + (v + P.clientHeight) + "px)", A = E + "px", v <= 0 && (O = P.clientHeight), N = P.clientHeight)), "top" == y && (f >= L - window.scrollY || w - 0 < L - window.scrollY) && (b = f + "px", A = E + "px", f <= 0 && (S = P.clientHeight), C = P.clientHeight), "bottom" == y && (w - v - P.clientHeight <= L - window.scrollY || 0 > L + P.clientHeight - window.scrollY) && (b = "calc(100% - " + (v + P.clientHeight) + "px)", A = E + "px", v <= 0 && (O = P.clientHeight), N = P.clientHeight), isEmptyLadiPage(b) || isEmptyLadiPage(A)) P.style.removeProperty("top"), P.style.removeProperty("left"), P.style.removeProperty("width"), P.style.removeProperty("position"), P.style.removeProperty("z-index"), T.getAttribute("data-padding-top-id") == t && (T.removeAttribute("data-padding-top-id"), T.style.removeProperty("padding-top")), T.getAttribute("data-padding-bottom-id") == t && (T.removeAttribute("data-padding-bottom-id"), T.style.removeProperty("padding-bottom")); else if ("section" == a.type && (e.runtime.is_mobile_only ? P.style.setProperty("width", T.clientWidth + "px") : e.runtime.isDesktop && P.style.setProperty("width", "100%"), S > 0 && (T.setAttribute("data-padding-top-id", t), T.style.setProperty("padding-top", S + "px")), O > 0 && (T.setAttribute("data-padding-bottom-id", t), T.style.setProperty("padding-bottom", O + "px")), C > 0 && T.setAttribute("data-scroll-padding-top", C), N > 0 && T.setAttribute("data-scroll-padding-bottom", N)), P.style.setProperty("top", b), P.style.setProperty("left", A), P.style.setProperty("position", "fixed"), P.style.setProperty("z-index", "90000050"), !P.hasAttribute("data-sticky")) {
                                ...
                                for (var k = P.getElementsByClassName("ladi-animation-hidden"); k.length > 0;) k[0].classList.add("ladi-animation"), k[0].classList.remove("ladi-animation-hidden");
                                P.classList.remove("ladi-lazyload");
                                for (var I = P.getElementsByClassName("ladi-lazyload"); I.length > 0;) I[0].classList.remove("ladi-lazyload")
                            }
                        }
                    }
                }
                if ("popup" == a.type) {
                    ...
                    isEmptyLadiPage(a["option.popup_welcome_page_scroll_to"]) || (d = document.getElementById(a["option.popup_welcome_page_scroll_to"]), !isEmptyLadiPage(d) && d.offsetHeight > 0 && (n = d.offsetTop, (window.scrollY >= n && window.scrollY <= n + d.offsetHeight || window.scrollY + e.getHeightDevice() >= n && window.scrollY + e.getHeightDevice() <= n + d.offsetHeight || n >= window.scrollY && window.scrollY + e.getHeightDevice() >= n) && (e.runtime.scroll_show_popup[t] = !0, window.ladi(t).show())))
                }
                if ("section" == a.type) {
                    if (!isEmptyLadiPage(e.runtime.scroll_to_section[t])) return;
                    d = document.getElementById(t), isEmptyLadiPage(d) || (n = d.offsetTop, (window.scrollY >= n && window.scrollY <= n + d.offsetHeight || window.scrollY + e.getHeightDevice() >= n && window.scrollY + e.getHeightDevice() <= n + d.offsetHeight || n >= window.scrollY && window.scrollY + e.getHeightDevice() >= n) && (e.runtime.scroll_to_section[t] = !0, e.runEventTracking(t, {is_form: !1})))
                }
            }), e.runtime.isClient) {
                if (e.runtime.is_popupx) return;
                for (var s = Math.round((window.scrollY + e.getHeightDevice()) / document.body.clientHeight * 100), l = function (t) {
                    LadiPageTrackingCommand.push(function () {
                    ...
                    LadiPageTrackingCommand.push(function () {
                        ...
                        window.gtag("event", "ScrollDepth_" + t + "_percent", {event_category: "LadiPageScrollDepth", event_label: window.location.host + window.location.pathname, non_interaction: !0})
                    })
                }, p = 1; p < e.const.PERCENT_TRACKING_SCROLL.length; p++) {
                    var m = e.const.PERCENT_TRACKING_SCROLL[p];
                    s > e.const.PERCENT_TRACKING_SCROLL[p - 1] && s <= m && -1 == e.runtime.scroll_depth.indexOf(m) && (e.runtime.scroll_depth.push(m), c(m), u(m), l(s))
                }
            }
            if (e.runtime.tmp.isFirstScroll = !1, !isEmptyLadiPage(t)) {
                var g = 0, _ = Object.values(e.runtime.list_scrolling_exec);
                if (isEmptyLadiPage(e.runtime.tmp.timeout_scrolling_id)) for (g = 0; g < _.length; g++) _[g]();
                e.removeTimeout(e.runtime.tmp.timeout_scrolling_id), e.runtime.tmp.timeout_scrolling_id = e.runTimeout(function () {
                    for (delete e.runtime.tmp.timeout_scrolling_id, _ = Object.values(e.runtime.list_scrolled_exec), g = 0; g < _.length; g++) _[g]()
                }, 1e3)
            }
        }
    ...
    var o = this, r = document.querySelectorAll("#" + this.runtime.builder_section_popup_id + " .ladi-container > .ladi-element"), d = !1, s = !1;
    ...
    if (isEmptyLadiPage(t)) for (u = 0; u < r.length; u++) c.push(r[u].id); else c.push(t);
    if (c.forEach(function (t) {
        ...
        if (!isEmptyLadiPage(i)) {
            ...
            isEmptyLadiPage(n) || (a = parseFloatLadiPage(n.getAttribute("data-timeout-id")) || null, o.removeTimeout(a), n.removeAttribute("data-timeout-id")), o.pauseAllVideo(i), isEmptyLadiPage(i.style.getPropertyValue("display")) || (d = !0), i.style.removeProperty("display"), i.style.removeProperty("z-index");
            var c = i.hasAttribute("data-popup-backdrop"), u = o.runtime.eventData[t];
    ...
    }), d && isFunctionLadiPage(i) && i(), a && l(), !n && s) {
    ...
    if (!isEmptyLadiPage(e)) {
        ...
        if (!n || !isEmptyLadiPage(r) && isObjectLadiPage(o.runtime.eventData) && !isEmptyLadiPage(o.runtime.eventData[e])) {
            ...
            var d = function (t) {
                ...
                isEmptyLadiPage(a) ? l += n ? "#" + o.runtime.backdrop_popup_id + " { display: none !important;}" : "#" + o.runtime.backdrop_popup_id + " { display: block !important;}" : (l += "#" + o.runtime.backdrop_popup_id + " { display: block !important; " + a + "}", r.setAttribute("data-popup-backdrop", !0)), i == o.const.POSITION_TYPE.default && "true" != r.getAttribute("data-dropbox") && (!function () {
                    if (!o.runtime.has_popupx && n) {
                        ...
                        "block" != r.style.getPropertyValue("display") || isEmptyLadiPage(o.runtime.tmp.bodyScrollY) || (t = o.runtime.tmp.bodyScrollY), l += "body {", 0 == r.getElementsByClassName("ladi-google-recaptcha-checkbox").length && (l += "position: fixed !important;"), l += "width: 100% !important;", l += "top: -" + t + "px !important;", l += "}", o.runtime.tmp.bodyScrollY = t
                    }
                    for (var a = document.querySelectorAll("#" + o.runtime.builder_section_popup_id + " .ladi-container > .ladi-element"), d = 0; d < a.length; d++) a[d].id != e && a[d].style.setProperty("z-index", "1", "important");
                    s = 500
                }(), o.runtime.tmp.current_default_popup_id = e);
                var c = "block" == r.style.getPropertyValue("display");
                if (isArrayLadiPage(o.runtime.list_show_popup_func[e])) for (; o.runtime.list_show_popup_func[e].length > 0;) {
                    o.runtime.list_show_popup_func[e].shift()()
                }
                var u = r.hasAttribute("data-scroll"), p = r.hasAttribute("data-fixed-close"), m = !1, g = r.getElementsByClassName("ladi-popup")[0], _ = 1e3 * (parseFloatLadiPage(getComputedStyle(g).animationDuration) || 0), y = 1e3 * (parseFloatLadiPage(getComputedStyle(g).animationDelay) || 0), f = parseFloatLadiPage(r.getAttribute("data-timeout-id")) || null;
                o.removeTimeout(f), f = parseFloatLadiPage(r.getAttribute("data-timeout-id-2")) || null, o.removeTimeout(f), !n || "true" == r.getAttribute("data-dropbox") || o.runtime.tmp.is_resize_all || o.runtime.tmp.is_wait_popup || isEmptyLadiPage(r.style.getPropertyValue("max-height")) && r.style.setProperty("visibility", "hidden"), r.classList.add("ladi-animation-hidden"), "block" != getComputedStyle(r).display && r.style.setProperty("display", "block", "important"), f = o.runTimeout(function () {
                ...
                if (n && !isEmptyLadiPage(r) && "true" != r.getAttribute("data-dropbox")) {
                    ...
                    isEmptyLadiPage(P) && ((P = document.createElement("div")).className = "popup-close", r.appendChild(P), P.addEventListener("click", function (t) {
                        t.stopPropagation(), o.runRemovePopup(e, n)
                    })), f = parseFloatLadiPage(P.getAttribute("data-timeout-id")) || null, o.removeTimeout(f), "true" == r.getAttribute("data-scroll") && (P.style.removeProperty("right"), P.style.removeProperty("top"), P.style.removeProperty("position")), o.runtime.has_popupx && o.runtime.tmp.popupx_is_inline && P.classList.add("ladi-hidden");
                    var h = function () {
                        if (P = r.getElementsByClassName("popup-close")[0], !isEmptyLadiPage(P)) if ("true" == r.getAttribute("data-scroll")) {
                            var t = o.getElementBoundingClientRect(r), e = t.y, i = window.innerWidth - t.x - t.width;
                    ...
                    h(), v = function () {
                        ...
                        }, _ + y + 100), P.setAttribute("data-timeout-id", f)
                ...
                var L = function () {
                    ...
                    }, t), isEmptyLadiPage(f) || r.setAttribute("data-timeout-id-2", f), r.style.removeProperty("visibility")
                };
                if (t) L(); else {
                    f = o.runTimeout(function () {
                        "none" == getComputedStyle(r).display ? (s -= 100, L()) : d(!0), r.removeAttribute("data-timeout-id-2")
                    }, 100), r.setAttribute("data-timeout-id-2", f)
                }
    ...
    for (var e = null, i = [{startStr: "+84", endStr: "(9|8|7|5|3)[0-9]{8}", listRegex: [{str_start: "0", str_input: "0"}, {str_start: "\\+84", str_input: "+84"}]}], a = 0; a < i.length; a++) for (var n = 0; n < i[a].listRegex.length; n++) {
    ...
    if (isObjectLadiPage(window.ladi_global_tracking) && isArrayLadiPage(window.ladi_global_tracking.thankyou_page)) for (; window.ladi_global_tracking.thankyou_page.length > 0;) {
    ...
    if (isArrayLadiPage(LadiPageCommand)) for (var e = 0; e < LadiPageCommand.length; e++) if (isFunctionLadiPage(t) && t(LadiPageCommand[e])) {
    ...
    if (this.runtime.isClient) {
        var r = null, d = null, s = null, l = null, c = null, u = o.runtime.currency, p = o.runtime.eventData[t], m = null, g = e.is_form, _ = e.is_click && e.count_data_event > 0 && o.runtime.tracking_button_click, y = e.is_thankyou_page;
        if (y) r = e.conversion_name, d = e.google_ads_conversion, s = e.google_ads_label, c = isEmptyLadiPage(e.purchase_value) ? null : parseFloatLadiPage(e.purchase_value) || 0; else {
            if (isEmptyLadiPage(t) || !isObjectLadiPage(p)) return;
            m = p.type, g && "form" == m ? (r = p["option.form_conversion_name"], d = p["option.form_google_ads_conversion"], s = p["option.form_google_ads_label"], l = p["option.form_event_custom_script"], c = isEmptyLadiPage(p["option.form_purchase_value"]) ? null : parseFloatLadiPage(p["option.form_purchase_value"]) || 0, o.runtime.shopping && (c = o.getCartCheckoutPrice(c))) : (r = p["option.conversion_name"], d = p["option.google_ads_conversion"], s = p["option.google_ads_label"], l = p["option.event_custom_script"])
        }
        var f = function (t) {
            var e = null, a = null, n = "trackCustom", d = [], s = null, l = function () {
                return {eventID: "ladi." + Date.now() + "." + (Math.floor(9e10 * Math.random()) + 1e10)}
            };
            isEmptyLadiPage(r) || (-1 != ["AddPaymentInfo", "AddToCart", "AddToWishlist", "CompleteRegistration", "Contact", "CustomizeProduct", "Donate", "FindLocation", "InitiateCheckout", "Lead", "PageView", "Purchase", "Schedule", "Search", "StartTrial", "SubmitApplication", "Subscribe", "ViewContent"].indexOf(r) && (n = "track"), isEmptyLadiPage(c) || isEmptyLadiPage(u) || ((e = {}).value = c, e.currency = u), !t && isObjectLadiPage(window.ladi_conversion_api) && isObjectLadiPage(window.ladi_conversion_api.facebook) && isArrayLadiPage(window.ladi_conversion_api.facebook.pixels) && (a = l()), d.push({
                fbq_track_name: n,
                conversion_name: r,
                fbq_data: e,
                fbq_event_data: a
                ...
                isObjectLadiPage(i) && (isObjectLadiPage(a) || (a = {}), a.email = i.email, a.phone = i.phone), s = [{key: e.fbq_track_name, name: e.conversion_name, custom_data: e.fbq_data, data: a}], o.runConversionApi("facebook", "events", s), t && (o.runtime.tmp.runActionPopupX({fbq_track_name: e.fbq_track_name, conversion_name: e.conversion_name, fbq_data: e.fbq_data, fbq_event_data: e.fbq_event_data, action: {type: "run_tracking_fbq"}}), o.runtime.tmp.runActionPopupX({type: "facebook", key: "events", keyData: s, action: {type: "run_conversion_api"}}))
            })), _ && (n = "trackCustom", e = null, a = null, d = [], !t && isObjectLadiPage(window.ladi_conversion_api) && isObjectLadiPage(window.ladi_conversion_api.facebook) && isArrayLadiPage(window.ladi_conversion_api.facebook.pixels) && (a = l()), d.push({fbq_track_name: n, conversion_name: "ClickButton", fbq_data: e, fbq_event_data: a}), d.forEach(function (e) {
                LadiPageTrackingCommand.push(function () {
                    return isFunctionLadiPage(window.fbq)
                }, function () {
                    window.fbq(e.fbq_track_name, e.conversion_name, e.fbq_data, e.fbq_event_data)
                }), s = [{key: e.fbq_track_name, name: e.conversion_name, custom_data: e.fbq_data, data: e.fbq_event_data}], o.runConversionApi("facebook", "events", s), t && (o.runtime.tmp.runActionPopupX({fbq_track_name: e.fbq_track_name, conversion_name: e.conversion_name, fbq_data: e.fbq_data, fbq_event_data: e.fbq_event_data, action: {type: "run_tracking_fbq"}}), o.runtime.tmp.runActionPopupX({type: "facebook", key: "events", keyData: s, action: {type: "run_conversion_api"}}))
            }))
        }, v = function (t) {
            if (isObjectLadiPage(i)) {
                var a = o.convertPhoneNumberFormData(i.phone), n = {};
                isEmptyLadiPage(i.email) || (n.email = i.email), isEmptyLadiPage(a) ? isEmptyLadiPage(i.phone) || (n.phone_number = i.phone) : n.phone_number = a, Object.keys(n).length > 0 && LadiPageTrackingCommand.push(function () {
                    return isFunctionLadiPage(window.gtag)
                }, function () {
                    window.gtag("set", "user_data", n)
                })
            }
            isEmptyLadiPage(d) || isEmptyLadiPage(s) || (t ? o.runtime.tmp.runActionPopupX({conversion_name: "conversion", gtag_data: {send_to: "AW-" + d + "/" + s}, action: {type: "run_tracking_gtag"}}) : LadiPageTrackingCommand.push(function () {
                return isFunctionLadiPage(window.gtag)
            }, function () {
                window.gtag("event", "conversion", {send_to: "AW-" + d + "/" + s})
            }));
            var l = null;
            if (!isEmptyLadiPage(r)) {
                var g = "";
                ...
                l = {event_category: g, event_label: window.location.host + window.location.pathname}, isEmptyLadiPage(c) || isEmptyLadiPage(u) || (l.value = c, l.currency = u), t ? o.runtime.tmp.runActionPopupX({conversion_name: r, gtag_data: l, action: {type: "run_tracking_gtag"}}) : LadiPageTrackingCommand.push(function () {
                    return isFunctionLadiPage(window.gtag)
                }, function () {
                    window.gtag("event", r, l)
                })
            }
        }, P = function (t) {
            var e = null;
            if (isObjectLadiPage(i) && (e = {email: i.email, phone_number: o.convertPhoneNumberFormData(i.phone)}), isObjectLadiPage(e) && !isEmptyLadiPage(e.phone_number) && (t ? o.runtime.tmp.runActionPopupX({ttq_identify_data: e, action: {type: "run_identify_ttq"}}) : LadiPageTrackingCommand.push(function () {
                return !isNullLadiPage(window.ttq)
            }, function () {
                ...
                var a = null;
                "CompletePayment" != r || isEmptyLadiPage(c) || isEmptyLadiPage(u) || ((a = {content_id: o.runtime.ladipage_id, content_type: "product"}).value = c, a.currency = u), t ? o.runtime.tmp.runActionPopupX({conversion_name: r, ttq_data: a, action: {type: "run_tracking_ttq"}}) : LadiPageTrackingCommand.push(function () {
                    return !isNullLadiPage(window.ttq)
                }, function () {
                    isObjectLadiPage(a) ? window.ttq.track(r, a) : window.ttq.track(r)
                })
            }
            _ && (o.runLadiPageCommand(function (e) {
                if (e.tiktokViewContent && e.clickButton) return t ? o.runtime.tmp.runActionPopupX({conversion_name: e.name, action: {type: "run_tracking_ttq"}}) : LadiPageTrackingCommand.push(function () {
                    return !isNullLadiPage(window.ttq)
                }, function () {
                    window.ttq.track(e.name)
                }), !0
            }), t ? o.runtime.tmp.runActionPopupX({conversion_name: "ClickButton", action: {type: "run_tracking_ttq"}}) : LadiPageTrackingCommand.push(function () {
                return !isNullLadiPage(window.ttq)
            }, function () {
        ...
        if (!isEmptyLadiPage(a)) {
            var h = !1;
            return isEmptyLadiPage(d) || isEmptyLadiPage(s) || (h = !0), isEmptyLadiPage(r) || (h = !0), isEmptyLadiPage(l) || (h = !0), _ && (h = !0), -1 != ["section", "popup", "countdown"].indexOf(m) && (h = !1), void (h && a.addEventListener("click", function (r) {
    ...
    var i = t, a = this.runtime.replacePrefixStart, n = this.runtime.replacePrefixEnd, o = this.runtime.replaceNewPrefixStart, r = this.runtime.replaceNewPrefixEnd;
    if (e) {
        var d = o;
        o = a, a = d, d = r, r = n, n = d
    }
    for (var s = new RegExp(a + "[^" + a + "$" + n + "]*" + n, "gi"), l = null, c = function (t) {
        i = i.replaceAll(t, t.replaceAll(a, o).replaceAll(n, r))
    }; null !== (l = s.exec(t));) l.index === s.lastIndex && s.lastIndex++, l.forEach(c);
    return i
    ...
    if (!isEmptyLadiPage(t) && 0 != e.length) {
        ...
        for (var r = this, d = function (t) {
            ...
            if (3 !== t.nodeType) r.highlightText(t, e, i, a); else if (d.test(t.textContent)) {
                var s = document.createDocumentFragment(), l = 0;
                t.textContent.replace(d, function (e, i) {
                    var n = document.createTextNode(t.textContent.slice(l, i)), o = null;
    ...
    }; null !== (u = c.exec(t));) u.index === c.lastIndex && c.lastIndex++, u.forEach(m);
    return p = p.unique(), r.highlightText(i, p, !0, function (t) {
        var e = document.createElement("span");
        return e.setAttribute("data-replace-str", t), e
    }), r.runtime.isDesktop && e && !isEmptyLadiPage(l) && ["fb://profile/", "fb://page/?id=", "fb://page/"].forEach(function (t) {
    ...
    if (!isEmptyLadiPage(o)) {
        ...
        for (var p = o.querySelectorAll(".ladi-element .ladi-form-item-container [name]"), m = 0; m < p.length; m++) {
            var g = null, _ = null, y = !1, f = null, v = p[m].getAttribute("type");
            ...
            if (!isNullLadiPage(g)) {
                if (_ = isArrayLadiPage(g) ? g[0] : g, _ = isNullLadiPage(_) ? "" : _, _ = String(_), "INPUT" == p[m].tagName) if ("checkbox" == v || "radio" == v) {
                    var b = !1;
                    if ("checkbox" == v) {
                        var A = g;
    ...
    if (t = this.convertDataReplaceStr(t, !1, null, !1, e), this.runtime.has_popupx) this.runtime.tmp.popupx_show_message_callback = i, this.runtime.tmp.runActionPopupX({message: t, action: {type: "show_message"}}); else {
        ...
        d.className = "ladipage-message-close", n.appendChild(d), d.textContent = this.const.LANG.ALERT_BUTTON_TEXT, d.focus(), d.addEventListener("click", function (t) {
    ...
    var i = function (i) {
        ...
        try {
            ...
            var a = document.execCommand("paste"), n = t.value;
    ...
    if (t.addEventListener("click", a), "ontouchstart" in window) {
        var n = 0, o = 0, r = i.getWidthDevice(), d = Math.max(1, Math.floor(.01 * r)), s = null;
        t.addEventListener("touchstart", function (e) {
            ...
            e = i.getEventCursorData(e), Math.abs(e.screenX - n) <= d && Math.abs(e.screenY - o) <= d && a(e), s = i.runTimeout(function () {
    ...
    var i = Math.floor(t / 1e3), a = i % 86400, n = a % 3600, o = Math.floor(i / 86400), r = Math.floor(a / 3600), d = Math.floor(n / 60), s = n % 60;
    ...
    (n.type = "text/javascript", isFunctionLadiPage(i) && (a = i, i = e, e = null), i && (n.async = !0), isObjectLadiPage(e)) && Object.keys(e).forEach(function (t) {
    ...
    var t = Date.now(), e = window.performance && window.performance.now && 1e3 * window.performance.now() || 0;
    ...
    if (e.runtime.isLoadHtmlGlobal) {
        ...
        try {
            ...
            e.runtime.tmp.cookie_ladi_data = d, d = JSON.parse(Base64.decode(d || Base64.encode("{}"))), Object.keys(d).forEach(function (t) {
        ...
        }, l = e.getURLSearchParams(null, null, !0), c = e.getURLSearchParams(window.location.search, null, !0), u = s(l), p = Object.keys(u), m = "";
        ...
        }), window.ladi(e.const.TRACKING_NAME).delete_cookie("/"), m != window.location.search && e.historyReplaceState(window.location.pathname + m + window.location.hash);
        ...
        var _ = Object.keys(e.runtime.eventData), y = [], f = window.ladi("LADI_CLIENT_ID").get_cookie(), v = parseFloatLadiPage(window.ladi("LADI_PAGE_VIEW").get_cookie()) || 0, P = parseFloatLadiPage(window.ladi("LADI_FORM_SUBMIT").get_cookie()) || 0, h = window.ladi("LADI_FUNNEL_NEXT_URL").get_cookie(), L = window.ladi("LADI_CAMP_ID").get_cookie(), E = window.ladi("LADI_CAMP_NAME").get_cookie(), b = window.ladi("LADI_CAMP_TYPE").get_cookie(), A = window.ladi("LADI_CAMP_TARGET_URL").get_cookie(), w = window.ladi("LADI_CAMP_ORIGIN_URL").get_cookie(),
            T = parseFloatLadiPage(window.ladi("LADI_CAMP_PAGE_VIEW").get_cookie()) || 0, S = parseFloatLadiPage(window.ladi("LADI_CAMP_FORM_SUBMIT").get_cookie()) || 0, O = window.ladi("LADI_CAMP_CONFIG").get_cookie(), C = function (t, i, a) {
                if ("FormSubmit" == t && isEmptyLadiPage(f)) isFunctionLadiPage(a) && a(); else if (!e.runtime.is_popupx || e.runtime.has_popupx) {
                    var n = e.runtime.publish_platform, o = e.runtime.store_id, r = e.runtime.time_zone, d = window.location.host, s = window.location.href, l = e.runtime.ladipage_id, c = {event: t, pixel_id: o, time_zone: r, domain: d, url: s, ladipage_id: l, publish_platform: n, data: []};
                ...
                var o = null, r = null, d = null, s = 0;
                if (isEmptyLadiPage(i) || "POPUP_PRODUCT" != i.id) if (isEmptyLadiPage(i) || "POPUP_BLOG" != i.id) isFunctionLadiPage(n) && n(); else {
                    ...
                    var l = function () {
                        ...
                        if (Object.keys(o.product).forEach(function (t) {
                            ...
                            for (s = 0; s < r.length; s++) e.runtime.tmp.runLadiSaleProductKey(r[s].id, !1, !1, d, o, !0, null, !0), t = r[s], void 0, a = e.runtime.eventData[t.id], isFunctionLadiPage(e.runtime.tmp.runOptionAction) && isObjectLadiPage(a) && e.runtime.tmp.runOptionAction(t, t.id, a.type, a, o);
                            for (s = 0; s < r.length; s++) for (var g = r[s].querySelectorAll(".ladi-headline img, .ladi-paragraph img"), _ = 0; _ < g.length; _++) m(g[_]);
                            isFunctionLadiPage(n) && n(), p(), e.runTimeout(function () {
                    ...
                    if (isEmptyLadiPage(a["option.product_variant_id"])) {
                        ...
                        var c = e.findAncestor(t, "ladi-collection-item"), u = null;
                        if (isEmptyLadiPage(c)) {
                            for (var p = document.querySelectorAll('[data-variant="true"] select[data-store-id="' + o.store_info.id + '"][data-product-id="' + o.product.product_id + '"]'), m = 0; m < p.length; m++) if (isEmptyLadiPage(e.findAncestor(p[m], "ladi-collection-item"))) {
                                u = p[m];
                                break
                            }
                ...
                var a = e.runtime.eventData[t.id], n = i.findIndex(function (t) {
                ...
                n = -1 != n, i.forEach(function (i) {
                    if (i.action_type == e.const.ACTION_TYPE.complete) {
                        ...
                        if (i.type == e.const.DATA_ACTION_TYPE.section) {
                            var d = 0, s = document.getElementById(i.action);
                        ...
                        if (i.type == e.const.DATA_ACTION_TYPE.popup && (o = document.getElementById(i.action), isEmptyLadiPage(o) || N(t, o, a, function () {
                            ...
                            window.ladi(t).show()
                        })), i.type == e.const.DATA_ACTION_TYPE.change_index && (r = window.ladi(i.action), isFunctionLadiPage(r[i.change_index_type]) ? r[i.change_index_type]() : r.index(i.change_index_number || 1)), i.type == e.const.DATA_ACTION_TYPE.set_value && (r = window.ladi(i.action), isEmptyLadiPage(r) || (i.is_clipboard ? e.getTextClipboard(i.str, function (e, a) {
                            r.value(e ? a : i.str), I(t, e, !0)
                ...
                e.removeTimeout(n);
                var o = "hint-{0}-middle-s-small-hint-anim-d-short", r = !0;
                ...
                if (t = t || document.getElementById(i), !isEmptyLadiPage(t)) {
                    ...
                    var c = n["option.is_submit_form"], u = n["option.data_submit_form_id"];
                    if (!n["option.action_funnel"] || isEmptyLadiPage(h)) if (!c || isEmptyLadiPage(u)) {
                        ...
                        p.forEach(function (a) {
                            if (a.action_type == e.const.ACTION_TYPE.action || a.action_type == e.const.ACTION_TYPE["1st_click"] || a.action_type == e.const.ACTION_TYPE["2nd_click"]) {
                                if (f++, a.type == e.const.DATA_ACTION_TYPE.set_value_2nd && t.addEventListener("click", function (e) {
                                    if (d(t, e) && l(a)) {
                                    ...
                                    t.addEventListener("click", function (i) {
                                        d(t, i) && l(a) && "true" == t.getAttribute("data-action") && (r = a.action, isEmptyLadiPage(a.action_mapping) || (r = a.action_mapping), isEmptyLadiPage(r) || (r = e.getLinkUTMRedirect(r, null), r = e.convertDataReplaceStr(r, !0), window.ladi(r).open_url(a.target, a.nofollow)))
                                    });
                                    var s = function () {
                                ...
                                if (a.type == e.const.DATA_ACTION_TYPE.email && t.addEventListener("click", function (e) {
                                    ...
                                    if (d(t, i) && l(a)) {
                                        var n = 0, o = document.getElementById(a.action);
                                        if (!isEmptyLadiPage(o)) {
                                    ...
                                    if (d(t, e) && l(a)) {
                                        var i = document.getElementById(a.action);
                                        isEmptyLadiPage(i) || N(t, i, n, function () {
                                    ...
                                    d(t, e) && l(a) && (isArrayLadiPage(a.hidden_ids) && a.hidden_ids.forEach(function (t) {
                                        window.ladi(t).hide()
                ...
                if (t = t || document.getElementById(i), !isEmptyLadiPage(t)) {
                    ...
                    n.forEach(function (i) {
                        if (i.action_type == e.const.ACTION_TYPE.hover && (i.type == e.const.DATA_ACTION_TYPE.dropbox && (t.addEventListener("mouseenter", function (e) {
                            ...
                            isArrayLadiPage(i.hidden_ids) && i.hidden_ids.forEach(function (t) {
                                window.ladi(t).hide()
                            }), isArrayLadiPage(i.show_ids) && i.show_ids.forEach(function (t) {
                                window.ladi(t).show()
                            })
                            ...
                            isEmptyLadiPage(a) || a.set_style(t, i, !0), t.addEventListener("mouseenter", function (e) {
                ...
                "countdown" != a || isEmptyLadiPage(n) || (i = i || document.getElementById(t), isEmptyLadiPage(i) || (i.setAttribute("data-type", n), n != e.const.COUNTDOWN_TYPE.countdown || isEmptyLadiPage(o) || i.setAttribute("data-minute", o), n != e.const.COUNTDOWN_TYPE.endtime || isEmptyLadiPage(s) || i.setAttribute("data-endtime", s), n != e.const.COUNTDOWN_TYPE.daily || isEmptyLadiPage(r) || isEmptyLadiPage(d) || (i.setAttribute("data-daily-start", r), i.setAttribute("data-daily-end", d))))
            }, q = function (t, e, i, a) {
                ...
                _.forEach(function (t) {
                    ...
                    if (!isEmptyLadiPage(i) && "true" != i.getAttribute("data-action")) {
                        var a = e.runtime.eventData[t], n = a["option.data_event"];
                        ...
                        !function (t, i) {
                            i.forEach(function (i) {
                                if (i.action_type == e.const.ACTION_TYPE.action && i.type == e.const.DATA_ACTION_TYPE.link) if (isEmptyLadiPage(t.getAttribute("href"))) t.removeAttribute("href"); else {
                ...
                for (var t = document.querySelectorAll(".ladi-headline a[href], .ladi-paragraph a[href], .ladi-list-paragraph a[href]"), i = 0; i < t.length; i++) if (isEmptyLadiPage(t[i].getAttribute("href"))) t[i].removeAttribute("href"); else {
                    var a = e.getLinkUTMRedirect(t[i].href, null);
                    t[i].setAttribute("data-replace-href", a), t[i].href = e.convertDataReplaceStr(a, !0)
                }
            }, M = function () {
                for (var t = 1e3, i = 0; i < LadiPageTrackingCommandList.length; i++) {
                    var a = LadiPageTrackingCommandList[i];
                    if (isFunctionLadiPage(a.callback1) && a.callback1()) {
                        try {
                            isFunctionLadiPage(a.callback2) && a.callback2()
                        } catch (t) {
                        }
                        LadiPageTrackingCommandList.splice(i, 1), t = 0;
                        break
                    }
                }
                e.runTimeout(M, t)
                ...
                if (t) {
                    ...
                    }, a = !1, n = isArrayLadiPage(e.runtime.DOMAIN_FREE) ? e.runtime.DOMAIN_FREE : [], o = window.location.href;
                    ["/", ".", "/"].forEach(function (t) {
                    ...
                    n.forEach(function (t) {
                        ...
                        if (-1 != t || a || e.runTimeout(i, 3e3), 200 == t) {
                            var o = JSON.parse(n), r = !1, d = null, s = null;
                            isObjectLadiPage(o.data) ? (r = 1 == o.data.verified_domain, d = o.data.google_captcha, s = o.data.places_autocomplete) : r = 1 == o.data, a || r || e.runTimeout(i, 3e3), isObjectLadiPage(d) && function (t, i, a) {
                                if (!isEmptyLadiPage(t)) {
                                    var n = !1;
                                    a.type == e.const.FORM_CONFIG_TYPE.google_recaptcha_enterprise && (i = !0), a.type == e.const.FORM_CONFIG_TYPE.google_recaptcha_checkbox && (n = !0), e.runtime.tmp.google_captcha = {api_key: t, enterprise: i, checkbox: n, type: a.type}, window.onloadRecaptchaCheckboxCallback = function () {
                                        for (var i = function (e) {
                                            ...
                                            var o = e.findAncestor(a[n], "ladi-element"), r = e.findAncestor(o, "ladi-form");
                                            if (!isEmptyLadiPage(r)) {
                                        ...
                                        for (var s = document.querySelectorAll("#POPUP_CHECKOUT .ladi-button"), l = 0; l < s.length; l++) {
                                            var c = e.findAncestor(s[l], "ladi-element"), u = e.runtime.eventData[c.id];
                            ...
                            }(d.site_key, d.enterprise, d), isObjectLadiPage(s) && (l = s.api_key, isEmptyLadiPage(l) || (window.onloadGooglePlacesAutocompleteCallback = function () {
                                var t = document.querySelectorAll("[data-places-autocomplete-country]"), e = null, i = 0, a = {}, n = function (n) {
                                    for (i = 0; i < t.length; i++) (e = t[i].querySelector('input[name="address"]')).removeAttribute("data-focus");
                                    (e = n.target).setAttribute("data-focus", !0), a = e.getAttribute("data-attrs"), isEmptyLadiPage(a) && ((a = {style: e.getAttribute("style"), placeholder: e.getAttribute("placeholder"), disabled: e.disabled}).style = isEmptyLadiPage(a.style) ? "" : a.style, a.placeholder = isEmptyLadiPage(a.placeholder) ? "" : a.placeholder, a.disabled = !isNullLadiPage(a.disabled) && a.disabled, e.setAttribute("data-attrs", encodeURIComponent(JSON.stringify(a))))
                                };
                                for (i = 0; i < t.length; i++) {
                                    var o = t[i].getAttribute("data-places-autocomplete-country"), r = {types: ["address"]};
                                    (o = isEmptyLadiPage(o) ? [] : (o = (o = o.split(",")).removeSpace()).unique()).length > 0 && (r.componentRestrictions = {country: o}), (e = t[i].querySelector('input[name="address"]')).addEventListener("focus", n), new google.maps.places.Autocomplete(e, r)
                                }
                                t.length > 0 && (window.gm_authFailure = function () {
                                    for (i = 0; i < t.length; i++) e = t[i].querySelector('input[name="address"]'), a = e.getAttribute("data-attrs"), a = isEmptyLadiPage(a) ? {style: "", placeholder: "", disabled: !1} : JSON.parse(decodeURIComponentLadiPage(a)), e.setAttribute("style", a.style), e.setAttribute("placeholder", a.placeholder), e.disabled = a.disabled, "true" == e.getAttribute("data-focus") && e.focus()
                                })
                ...
                if (isEmptyLadiPage(e.runtime.current_element_mouse_down_gallery_view) && isEmptyLadiPage(e.runtime.current_element_mouse_down_gallery_control)) {
                    ...
                    if (isEmptyLadiPage(e.runtime.timeout_gallery[o]) && (!e.runtime.tmp.gallery_playing_video || !i)) {
                        ...
                        if (0 != r.length && 0 != r.length) {
                            ...
                            i ? s ? l >= c - 1 ? (l = c - 2, s = !1) : l++ : l <= 0 ? (l = 1, s = !0) : l-- : s ? l++ : l--, l < 0 && (l = 0), l >= c - 1 && (l = c - 1), isEmptyLadiPage(a) && (a = s ? "next" : "prev"), isEmptyLadiPage(n) && (n = s ? "left" : "right"), e.runtime.tmp.gallery_playing_video && !r[l].classList.contains("selected") && e.pauseAllVideo(), r[l].classList.add(a);
                            ...
                            e.runtime.timeout_gallery[o] = e.runTimeout(function () {
                                r[l].classList.add(n), e.runtime.timeout_gallery[o] = e.runTimeout(function () {
                                    for (var t = 0; t < r.length; t++) t == l ? r[t].classList.add("selected") : r[t].classList.remove("selected"), r[t].style.removeProperty("left"), r[t].classList.remove(a), r[t].classList.remove(n);
                            ...
                            var g = e.getElementBoundingClientRect(t), _ = e.getElementBoundingClientRect(t.getElementsByClassName("ladi-gallery-control-item")[l]);
                            if (t.getElementsByClassName("ladi-gallery-control-arrow-left")[0].classList.remove("opacity-0"), t.getElementsByClassName("ladi-gallery-control-arrow-right")[0].classList.remove("opacity-0"), t.getElementsByClassName("ladi-gallery")[0].classList.contains("ladi-gallery-top") || t.getElementsByClassName("ladi-gallery")[0].classList.contains("ladi-gallery-bottom")) {
                                var y = parseFloatLadiPage(getComputedStyle(t.getElementsByClassName("ladi-gallery-control")[0]).width) || 0, f = parseFloatLadiPage(getComputedStyle(t.getElementsByClassName("ladi-gallery-control-item")[l]).width) || 0, v = _.x - g.x - (y - f) / 2;
                                ...
                                v < (P = (P = -(P -= parseFloatLadiPage(getComputedStyle(t.getElementsByClassName("ladi-gallery-control")[0]).width) || 0)) > 0 ? 0 : P) && (v = P), t.getElementsByClassName("ladi-gallery-control-box")[0].style.setProperty("left", v + "px"), v >= 0 && t.getElementsByClassName("ladi-gallery-control-arrow-left")[0].classList.add("opacity-0"), v <= P && t.getElementsByClassName("ladi-gallery-control-arrow-right")[0].classList.add("opacity-0")
                            } else {
                                var h = parseFloatLadiPage(getComputedStyle(t.getElementsByClassName("ladi-gallery-control")[0]).height) || 0, L = parseFloatLadiPage(getComputedStyle(t.getElementsByClassName("ladi-gallery-control-item")[l]).height) || 0, E = _.y - g.y - (h - L) / 2;
                                ...
                                E < (b = (b = -(b -= parseFloatLadiPage(getComputedStyle(t.getElementsByClassName("ladi-gallery-control")[0]).height) || 0)) > 0 ? 0 : b) && (E = b), t.getElementsByClassName("ladi-gallery-control-box")[0].style.setProperty("top", E + "px"), E >= 0 && t.getElementsByClassName("ladi-gallery-control-arrow-left")[0].classList.add("opacity-0"), E <= b && t.getElementsByClassName("ladi-gallery-control-arrow-right")[0].classList.add("opacity-0")
                            }
                            t.setAttribute("data-is-next", s), t.setAttribute("data-current", l), t.getElementsByClassName("ladi-gallery-view-arrow-left")[0].classList.remove("opacity-0"), t.getElementsByClassName("ladi-gallery-view-arrow-right")[0].classList.remove("opacity-0"), l <= 0 && t.getElementsByClassName("ladi-gallery-view-arrow-left")[0].classList.add("opacity-0"), l >= c - 1 && t.getElementsByClassName("ladi-gallery-view-arrow-right")[0].classList.add("opacity-0"), (t.getElementsByClassName("ladi-gallery")[0].classList.contains("ladi-gallery-left") || t.getElementsByClassName("ladi-gallery")[0].classList.contains("ladi-gallery-right")) && e.reloadLazyload(!1), !i && t.hasAttribute("data-loaded") && t.setAttribute("data-stop", !0)
                        }
                    }
                }
            }, j = function (t, i, a) {
                var n = i.getAttribute("data-video-type"), o = i.getAttribute("data-video-url"), r = i.getAttribute("data-index"), d = t.getAttribute("data-runtime-id") + "_" + r + "_player", s = document.getElementById(d);
                a || (e.pauseAllVideo(), e.runtime.tmp.gallery_playing_video = !0), isEmptyLadiPage(s) ? (n == e.const.VIDEO_TYPE.youtube && (s = document.createElement("iframe"), i.parentElement.insertBefore(s, i.nextSibling), s.outerHTML = '<iframe id="' + d + '" class="iframe-video-preload" data-video-type="' + n + '" style="position: absolute; width: 100%; height: 100%; top: 0; left: 0;" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>', e.runEventPlayVideo(d, n, o, !1, !1, !0, a, !1, !0)), n == e.const.VIDEO_TYPE.direct && (s = document.createElement("video"), i.parentElement.insertBefore(s, i.nextSibling), s.outerHTML = '<video id="' + d + '" class="iframe-video-preload" data-video-type="' + n + '" style="position: absolute; width: 100%; height: 100%; top: 0; left: 0; object-fit: cover;"></video>', e.runEventPlayVideo(d, n, o, !1, !1, !0, a, !1, !0))) : e.runEventReplayVideo(d, n, !0)
            }, H = function (t, i, a, n) {
                if ("gallery" == n && (a || (i = document.getElementById(t)), !isEmptyLadiPage(i))) {
                    ...
                    var r = function (t) {
                        t.stopPropagation(), j(i, t.target, !1)
                    }, d = i.classList.contains("preload");
                    if (o > 0) {
                        for (var s = 0; s < o; s++) {
                            var l = i.getElementsByClassName("ladi-gallery-view-item")[s];
                            isEmptyLadiPage(l) || (d && j(i, l, d), l.classList.contains("play-video") && l.addEventListener("click", r))
                        }
                ...
                t.stopPropagation();
                var a = e.runtime.eventData[i.id], n = a[e.runtime.device + ".option.gallery_control.autoplay"], o = a[e.runtime.device + ".option.gallery_control.autoplay_time"], r = 0;
                ...
                (c = "true" == c.toLowerCase()) ? d-- : d++, i.setAttribute("data-current", d), i.setAttribute("data-next-time", Date.now() + 1e3 * r), V(i, !1, s, l)
            }, U = function () {
                _.forEach(function (t) {
                    var i = e.runtime.eventData[t];
                    if ("gallery" == i.type) for (var a = document.querySelectorAll("#" + t), n = 0; n < a.length; n++) {
                        var o = a[n];
                        if ("true" == o.getAttribute("data-scrolled") && "true" != o.getAttribute("data-stop")) {
                            var r = i[e.runtime.device + ".option.gallery_control.autoplay"], d = i[e.runtime.device + ".option.gallery_control.autoplay_time"], s = 0;
                            if (r && !isEmptyLadiPage(d) && (s = d), s > 0) {
                                var l = o.getAttribute("data-next-time"), c = Date.now();
                                isEmptyLadiPage(l) && (l = c + 1e3 * (s - 1), o.setAttribute("data-next-time", l)), c >= l && (V(o, !0), o.setAttribute("data-next-time", c + 1e3 * s))
                            }
                        }
                    }
                })
                ...
                if ("gallery" == a.type) {
                    ...
                    var o = a[e.runtime.device + ".option.gallery_control.autoplay"], r = a[e.runtime.device + ".option.gallery_control.autoplay_time"], d = 0;
                    ...
                    i.getElementsByClassName("ladi-gallery-view-arrow-left")[0].addEventListener("click", function (t) {
                        t.stopPropagation(), i.setAttribute("data-is-next", !1), i.setAttribute("data-next-time", Date.now() + 1e3 * d), V(i, !1)
                    }), i.getElementsByClassName("ladi-gallery-view-item").length > 1 && i.getElementsByClassName("ladi-gallery-view-arrow-right")[0].classList.remove("opacity-0"), i.getElementsByClassName("ladi-gallery-view-arrow-right")[0].addEventListener("click", function (t) {
                        t.stopPropagation(), i.setAttribute("data-is-next", !0), i.setAttribute("data-next-time", Date.now() + 1e3 * d), V(i, !1)
                        ...
                        if (!isEmptyLadiPage(e)) {
                            ...
                            if (i.getElementsByClassName("ladi-gallery-control-arrow-left")[0].classList.remove("opacity-0"), i.getElementsByClassName("ladi-gallery-control-arrow-right")[0].classList.remove("opacity-0"), i.getElementsByClassName("ladi-gallery")[0].classList.contains("ladi-gallery-top") || i.getElementsByClassName("ladi-gallery")[0].classList.contains("ladi-gallery-bottom")) {
                                ...
                                s = (s = -(s -= parseFloatLadiPage(getComputedStyle(i.getElementsByClassName("ladi-gallery-control")[0]).height) || 0)) > 0 ? 0 : s, r > 0 && (r = 0), i.getElementsByClassName("ladi-gallery-control-box")[0].style.setProperty("top", r + "px"), r >= 0 && i.getElementsByClassName("ladi-gallery-control-arrow-left")[0].classList.add("opacity-0"), r <= s && i.getElementsByClassName("ladi-gallery-control-arrow-right")[0].classList.add("opacity-0")
                            }
                        ...
                        if (!isEmptyLadiPage(e)) {
                            ...
                            if (i.getElementsByClassName("ladi-gallery-control-arrow-left")[0].classList.remove("opacity-0"), i.getElementsByClassName("ladi-gallery-control-arrow-right")[0].classList.remove("opacity-0"), i.getElementsByClassName("ladi-gallery")[0].classList.contains("ladi-gallery-top") || i.getElementsByClassName("ladi-gallery")[0].classList.contains("ladi-gallery-bottom")) {
                                ...
                                var s = parseFloatLadiPage(getComputedStyle(i.getElementsByClassName("ladi-gallery-control-box")[0]).height) || 0;
                                r < (s = (s = -(s -= parseFloatLadiPage(getComputedStyle(i.getElementsByClassName("ladi-gallery-control")[0]).height) || 0)) > 0 ? 0 : s) && (r = s), i.getElementsByClassName("ladi-gallery-control-box")[0].style.setProperty("top", r + "px"), r >= 0 && i.getElementsByClassName("ladi-gallery-control-arrow-left")[0].classList.add("opacity-0"), r <= s && i.getElementsByClassName("ladi-gallery-control-arrow-right")[0].classList.add("opacity-0")
                            }
                            i.setAttribute("data-next-time", Date.now() + 1e3 * d)
                        }
                ...
                if ((isEmptyLadiPage(e.runtime.timenext_carousel[t]) || !(e.runtime.timenext_carousel[t] > Date.now())) && isEmptyLadiPage(e.runtime.current_element_mouse_down_carousel)) {
                    ...
                    if (!isEmptyLadiPage(a)) {
                        ...
                        var o = parseFloatLadiPage(a.getAttribute("data-current")) || 0, r = parseFloatLadiPage(e.runtime.eventData[t][e.runtime.device + ".option.carousel_crop.width"]) || 0, d = parseFloatLadiPage(e.runtime.eventData[t][e.runtime.device + ".option.carousel_crop.width_item"]) || 0;
                        ...
                        var c = e.getElementBoundingClientRect(a), u = c.x + o * d - c.x - (a.clientWidth - d) / 2;
                        u = -u > 0 ? 0 : -u;
                        var p = -(r - a.clientWidth);
                        u < p && (u = p), a.getElementsByClassName("ladi-carousel-content")[0].style.setProperty("left", u + "px"), a.setAttribute("data-is-next", n), a.setAttribute("data-current", o), i || a.setAttribute("data-stop", !0);
                        var m = a.getElementsByClassName("ladi-carousel-arrow-left")[0], g = a.getElementsByClassName("ladi-carousel-arrow-right")[0];
                ...
                var i, a = document.getElementsByClassName("ladi-form"), n = 0, o = null, r = null, d = null, c = null, u = null, p = null, m = null, _ = null, y = null, f = null, v = null, P = null, L = null, E = null, b = null, w = null, T = null, S = null, N = e.runtime.shopping, I = null, x = ["utm_source", "utm_medium", "utm_campaign", "utm_term", "utm_content"], D = ["name", "email", "phone", "address", "ward", "district", "state", "country"], R = ["email", "phone"], F = e.copy(e.runtime.list_set_value_name_country).reverse(), q = function (t, i) {
                    ...
                    var n = e.runtime.tmp["form_data_ladi_" + f];
                    ...
                    var d = !0, s = t.getElementsByClassName("ladi-survey");
                    for (_ = 0; _ < s.length; _++) {
                        ...
                        if (!isEmptyLadiPage(l)) {
                            ...
                            if (!isEmptyLadiPage(c) && c["option.survey_setting.input_required"] && !isEmptyLadiPage(c["option.survey_setting.input_name"])) {
                                var u = l.id, p = t.querySelector('.ladi-element.ladi-form-item-survey[data-name="' + c["option.survey_setting.input_name"] + '"]');
                    ...
                    var g = !0, _ = 0, y = function () {
                        var e = t.querySelector('[name="' + S[_].name + '"]');
                        isEmptyLadiPage(e) || e.focus()
                    };
                    for (_ = 0; _ < S.length; _++) if (!i || S[_].name == a) {
                        var v = r[S[_].name];
                        if (!isEmptyLadiPage(v)) try {
                            if (!new RegExp("^" + S[_].pattern + "$", S[_].pattern_flag).test(v)) {
                                i || e.showMessage(S[_].title, null, y), g = !1;
                                break
                            }
                        } catch (t) {
                        }
                    ...
                    r = {}, d = {}, c = {};
                    for (var a = t.querySelectorAll(".ladi-element .ladi-form-item-container [name]"), n = {}, o = null, l = 0; l < a.length; l++) o = a[l].getAttribute("name"), n[o] = parseInt(a[l].getAttribute("tabindex")) || 0;
                    var p = Object.keys(n).sort(function (t, e) {
                        return n[t] - n[e]
                    });
                    if (p.only(e.runtime.list_set_value_name_country).length == e.runtime.list_set_value_name_country.length) for (var g = 0; g < p.length; g++) {
                    ...
                    for (var f = 0; f < a.length; f++) {
                        o = a[f].getAttribute("name"), a[f].required && -1 == T.indexOf(o) && T.push(o);
                        var v = null;
                        if ("INPUT" == a[f].tagName) {
                            v = a[f].getAttribute("type").trim().toLowerCase();
                            var P = a[f].getAttribute("pattern"), h = a[f].getAttribute("title");
                            if ("email" == v ? S.push({name: o, pattern: '(([^<>()\\[\\]\\\\.,;:\\s@"]+(\\.[^<>()\\[\\]\\\\.,;:\\s@"]+)*)|(".+"))@((\\[[0-9]{1,3}\\.[0-9]{1,3}\\.[0-9]{1,3}\\.[0-9]{1,3}\\])|(([a-zA-Z\\-0-9]+\\.)+[a-zA-Z]{2,}))', pattern_flag: "gi", title: e.const.LANG.FORM_INPUT_EMAIL_REGEX}) : isEmptyLadiPage(P) || S.push({name: o, pattern: P, title: isEmptyLadiPage(h) ? e.const.LANG.FORM_INPUT_TEXT_REGEX : h}), "checkbox" == v) {
                        ...
                        if (r[o] = a[f].value, a[f].classList.contains("ladi-form-control-file") && (r[o] = JSON.parse(a[f].getAttribute("data-path-file") || "[]"), c[o] = !0), "coupon" == o && "INPUT" == a[f].tagName && "text" == v && "true" == a[f].getAttribute("data-replace-coupon") && (r[o] = e.runtime.tmp.current_use_coupon || ""), "INPUT" == a[f].tagName && "date" == v && !isEmptyLadiPage(r[o])) {
                            var L = a[f].getAttribute("date-format") || "dd-mm-yyyy", E = new Date(r[o]);
                            L = (L = (L = (L = L.replaceAll("dd", (E.getDate() < 10 ? "0" : "") + E.getDate())).replaceAll("mm", (E.getMonth() + 1 < 10 ? "0" : "") + (E.getMonth() + 1))).replaceAll("yyyy", E.getFullYear())).replaceAll("yy", E.getFullYear() - 2e3), r[o] = L
                        }
                    }
                    i || D.forEach(function (t) {
                        isNullLadiPage(r[t]) || (window.ladi("_ladipage_" + t).set_cookie(r[t], 365, "/", window.location.host), isArrayLadiPage(e.runtime.DOMAIN_SET_COOKIE) && e.runtime.DOMAIN_SET_COOKIE.forEach(function (e) {
                            e != window.location.host && window.ladi("_ladipage_" + t).set_cookie(r[t], 365, "/", e)
                        }))
                    }), u = s(r)
                }, Y = function (t, i, a, d, s) {
                    var l = {form_config_id: _, ladi_form_id: f, ladipage_id: e.runtime.ladipage_id, tracking_form: [], form_data: [], data_key: d};
                    if (a) l.status_send = e.const.STATUS_SEND.capture; else if (l.status_send = e.const.STATUS_SEND.sendform, N) {
                        var u = window.ladi("_checkout_token").get_cookie();
                        isEmptyLadiPage(u) || (l.checkout_token = u)
                    }
                    if (!isEmptyLadiPage(v)) {
                        var p = v.getElementsByClassName("ladiflow-widget")[0];
                        isEmptyLadiPage(p) || (isObjectLadiPage(l.options) || (l.options = {}), l.options.ladiflow_trigger_id = p.getAttribute("ladiflow-trigger-id"), l.options.ladiflow_ref = p.getAttribute("ladiflow-ref"), l.options.ladiflow_page_id = p.getAttribute("page_id"), l.options.ladiflow_checkbox_user_ref = p.getAttribute("user_ref"), l.options.ladiflow_store_id = p.getAttribute("ladiflow-store-id"), n = 1e3, o = function () {
                    ...
                    isEmptyLadiPage(P) || ["option.sync_ladisales_form_account_id", "option.sync_ladiflow_form_account_id", "option.sync_ladishare_form_account_id", "option.sync_ladichat_form_account_id"].forEach(function (t) {
                        isEmptyLadiPage(P[t]) || (isObjectLadiPage(l.options) || (l.options = {}), isArrayLadiPage(l.options.external_form_config_ids) || (l.options.external_form_config_ids = []), l.options.external_form_config_ids.push(P[t]))
                    }), i.isFormOtp && !isEmptyLadiPage(y) && (isObjectLadiPage(l.options) || (l.options = {}), isObjectLadiPage(l.options.external_otp_config) || (l.options.external_otp_config = {}), l.options.external_otp_config.otp_config_id = y), isObjectLadiPage(l.options) && (l.options = JSON.stringify(l.options)), isEmptyLadiPage(L) || (l.total_revenue = L), isEmptyLadiPage(e.runtime.time_zone) || (l.time_zone = e.runtime.time_zone);
                    ...
                    if (m.forEach(function (t) {
                        ...
                        if (!isNullLadiPage(E)) {
                            l.form_data.push({name: "cart_products", value: E, is_ladipage: !0}), isEmptyLadiPage(e.runtime.tmp.add_to_cart_shipping_method_id) || l.form_data.push({name: "cart_shipping", value: e.runtime.tmp.add_to_cart_shipping_method_id + "|" + (e.runtime.tmp.add_to_cart_fee_shipping || 0), is_ladipage: !0});
                            var T = l.form_data.findIndex(function (t) {
                                return "coupon" == t.name
                            });
                            -1 != T && (l.form_data[T].is_ladipage = !0)
                        }
                        isEmptyLadiPage(L) || l.form_data.push({name: "cart_revenue", value: L, is_ladipage: !0}), isEmptyLadiPage(e.runtime.tmp.current_use_coupon) || l.form_data.push({name: "cart_coupon_amount", value: e.runtime.tmp.add_to_cart_discount || 0, is_ladipage: !0})
                    }
                    l.tracking_form.push({name: "url_page", value: window.location.href}), e.runtime.has_popupx && l.tracking_form.push({name: "origin_url_page", value: e.runtime.tmp.popupx_origin_url}), x.forEach(function (t) {
                        var e = I[t];
                        e = isNullLadiPage(e) ? "" : e, l.tracking_form.push({name: t, value: e})
                    }), l.tracking_form.push({name: "variant_url", value: A}), l.tracking_form.push({name: "variant_content", value: e.generateVariantContentString(O, !0)}), isEmptyLadiPage(g) || l.tracking_form.push({name: e.const.REF_NAME, value: g}), e.runtime.tmp["form_data_ladi_tmp_" + f] = e.copy(l);
                    var S = e.runtime.tmp["form_data_ladi_" + f];
                    isObjectLadiPage(S) && (l = e.copy(S)), isEmptyLadiPage(b) || (l.captcha_token = b, l.captcha_type = w);
                    i.isFormOtp && (i.isSetOtpId && function () {
                        var t = "_otp_id_" + f, a = window.ladi(t).get_cookie(), n = !1, o = e.runtime.tmp["cookie_cache_otp_" + f];
                        isEmptyLadiPage(a) && isObjectLadiPage(o) && !isEmptyLadiPage(o[t]) && (a = o[t], n = !0);
                        var r = new Date, d = [];
                        isEmptyLadiPage(a) ? d = [e.randomId(), r.getTime(), 1] : ((d = a.split("|"))[1] = parseInt(d[1]) || Date.now(), d[2] = parseInt(d[2]) || 1, i.isSendOtp || (d[2] += 1), d.splice(3)), d[2] <= 1 ? l.otp_send = e.const.OTP_TYPE.send : l.otp_send = e.const.OTP_TYPE.resend, r.setTime(d[1] + 9e5), a = d.join("|"), n ? (o[t] = a, e.runtime.tmp["cookie_cache_otp_" + f] = o) : window.ladi(t).set_cookie(a, r), d.splice(1), a = d.join("|"), l.otp_id = a
                    }(), l.is_capture = i.isCapture, l.otp_type = e.const.OTP_TYPE.sms, l.status_send = e.const.STATUS_SEND.otp), i.isSendOtp && (l.otp_code = i.otp_code, l.status_send = e.const.STATUS_SEND.sendform), isFunctionLadiPage(s) && s(l)
                }, V = function (t) {
                    t.reset();
                    var i = t.getElementsByClassName("ladi-survey-option");
                    for (Q = 0; Q < i.length; Q++) i[Q].classList.remove("selected");
                    var a = t.querySelectorAll(".ladi-element .ladi-form-item-container .ladi-form-checkbox-item input");
                    for (Q = 0; Q < a.length; Q++) {
                        var n = e.findAncestor(a[Q], "ladi-form-checkbox-item").querySelector("span");
                        isEmptyLadiPage(n) || n.setAttribute("data-checked", a[Q].checked)
                    }
                    ...
                    if (!isEmptyLadiPage(o)) {
                        ...
                        isEmptyLadiPage(u) || (u = u.getElementsByClassName("ladi-form")[0], V(u))
                    }
                    for (var p = document.querySelectorAll('[data-combobox-type="delivery_method"]'), m = 0; m < p.length; m++) p[m].hasAttribute("data-placeholder") && (p[m].innerHTML = '<option value="">' + p[m].getAttribute("data-placeholder") + "</option>"), p[m].setAttribute("data-selected", "");
                    for (var g = document.querySelectorAll(".ladi-google-recaptcha-checkbox[data-widget-id]"), _ = 0; _ < g.length; _++) {
                        ...
                        isEmptyLadiPage(y) || window.grecaptcha && isObjectLadiPage(e.runtime.tmp.google_captcha) && e.runtime.tmp.google_captcha.checkbox && isFunctionLadiPage(window.grecaptcha.reset) && window.grecaptcha.reset(y)
                    }
                    e.runtime.tmp.add_to_cart_shipping_method_id = null
                }, j = function (t, i, a, n) {
                    M(a, !1), B(a, !1, null) && (Y(0, i, !1, n, function (t) {
                        e.sendRequest("POST", e.const.API_FORM_DATA, JSON.stringify(t), !0, {"Content-Type": "application/json"})
                    }), e.showMessage(e.const.LANG.FORM_SEND_DATA_NO_CONFIG), V(a))
                }, H = function () {
                    e.showMessage(e.const.LANG.FORM_CAPTCHA_ERROR)
                }, G = function (t, i, a, n, o) {
                    if (u = {}, p = {}, m = [], T = [], S = [], M(t, a), B(t, a, n)) {
                        for (var d = t.querySelectorAll(".ladi-element .ladi-form-item-container [name]"), s = {}, l = null, c = 0; c < d.length; c++) l = e.findAncestor(d[c], "ladi-element"), s[d[c].getAttribute("name")] = l.id;
                        var g = i["option.form_setting"], _ = Object.keys(s);
                        if ((g.mapping_form_id || []).forEach(function (i) {
                            ...
                            if (!isEmptyLadiPage(r)) {
                                ...
                                if (!a || !isEmptyLadiPage(u) && u["option.form_auto_capture"]) {
                                    ...
                                    }), a) for (c = 0; c < p.length; c++) e.fireEvent(p[c], "focusout")
                                }
                            }
                        }), !a) {
                            ...
                            if (!isArrayLadiPage(y)) {
                                var f = e.copy(g);
                                if (y = [], isObjectLadiPage(f) && (f.type = f.event_type, f.value = f.event_value, f.is_hide_parent = f.event_is_hide_parent, f.change_index_type = f.event_change_index_type, f.change_index_number = f.event_change_index_number, !isEmptyLadiPage(f.value))) {
                                    if (f.type != e.const.DATA_ACTION_TYPE.section && f.type != e.const.DATA_ACTION_TYPE.popup || y.push({action_type: e.const.ACTION_TYPE.complete, type: f.type, action: f.value}), f.type == e.const.DATA_ACTION_TYPE.section && f.is_hide_parent || f.type == e.const.DATA_ACTION_TYPE.popup) {
                                        var v = e.findAncestor(t, "ladi-popup"), P = e.findAncestor(t, "ladi-section"), h = null;
                                        isEmptyLadiPage(v) ? isEmptyLadiPage(P) || (h = P.id) : h = (v = e.findAncestor(v, "ladi-element")).id, isEmptyLadiPage(h) || y.push({action_type: e.const.ACTION_TYPE.complete, type: e.const.DATA_ACTION_TYPE.hidden_show, hidden_ids: [h], show_ids: []})
                                    }
                                    f.type == e.const.DATA_ACTION_TYPE.change_index && y.push({action_type: e.const.ACTION_TYPE.complete, type: f.type, action: f.value, change_index_type: f.change_index_type, change_index_number: f.change_index_number})
                                }
                            }
                            k(t, y)
                        }
                ...
                }, U = function (i, a, s, l, g, A) {
                    if (I = e.getURLSearchParams(null, null, !1), n = 0, o = null, r = {}, d = {}, c = {}, u = {}, p = {}, m = [], _ = null, y = null, f = null, v = null, P = null, L = null, E = null, b = a.captcha_token, isObjectLadiPage(e.runtime.tmp.google_captcha) && (w = e.runtime.tmp.google_captcha.type, !s && isEmptyLadiPage(b) && a.hasOwnProperty("captcha_token"))) H(); else {
                        T = [], S = [], N = e.findAncestor(i, "ladi-popup"), isEmptyLadiPage(N) ? N = !1 : (N = e.findAncestor(N, "ladi-element"), N = !isEmptyLadiPage(N) && "POPUP_CHECKOUT" == N.id);
                        var O = i.getElementsByClassName("ladi-form")[0];
                        if (!isEmptyLadiPage(O)) {
                            var k = e.runtime.eventData[i.id];
                            if (!isEmptyLadiPage(k)) {
                                if (k["option.is_add_to_cart"]) return;
                                _ = k["option.form_config_id"], y = isObjectLadiPage(k["option.form_setting"]) ? k["option.form_setting"].otp_config_id : null, f = i.id, v = i, P = k, L = parseFloatLadiPage(k["option.form_purchase_value"]) || 0, N && (L = e.getCartCheckoutPrice(L), E = e.getCartProducts())
                            }
                            var D = null, R = null, F = null, q = null;
                            if (s) {
                                if (isEmptyLadiPage(l)) return;
                                if (M(O, s), !B(O, s, g)) return;
                                if (a.captcha && !isEmptyLadiPage(k) && k["option.form_captcha"] && isObjectLadiPage(e.runtime.tmp.google_captcha)) {
                                    if (window.grecaptcha) if (e.runtime.tmp.google_captcha.enterprise && window.grecaptcha.enterprise) window.grecaptcha.enterprise.ready(function () {
                                        try {
                                            window.grecaptcha.enterprise.execute(e.runtime.tmp.google_captcha.api_key, {action: "submit"}).then(function (t) {
                                                U(i, {captcha_token: t}, s, l, g, A)
                                            })
                                        } catch (t) {
                                        }
                                    }); else if (e.runtime.tmp.google_captcha.checkbox) try {
                                        D = i.getElementsByClassName("ladi-google-recaptcha-checkbox")[0], R = i.getAttribute("data-button-submit-other"), isEmptyLadiPage(R) || (D = document.querySelector("#" + R + " .ladi-google-recaptcha-checkbox")), F = D.getAttribute("data-widget-id"), q = window.grecaptcha.getResponse(F), U(i, {captcha_token: q}, s, l, g, A)
                                    } catch (t) {
                                ...
                                Y(0, A, s, l, function (t) {
                                    var i = t.form_data.findIndex(function (t) {
                                        return t.name == g
                                    }), a = -1 != i ? t.form_data[i].value : null;
                                    !isEmptyLadiPage(e.runtime.tmp.capture_form_data_last[l + "_" + g]) && equalsLadiPage(e.runtime.tmp.capture_form_data_last[l + "_" + g], a) || (e.runtime.tmp.capture_form_data_last[l + "_" + g] = a, e.sendRequest("POST", e.const.API_FORM_DATA, JSON.stringify(t), !0, {"Content-Type": "application/json"}))
                                })
                            } else if (isEmptyLadiPage(k)) j(0, A, O, l); else if (isNullLadiPage(e.runtime.tmp.form_sending) && (e.runtime.tmp.form_sending = {}), isNullLadiPage(e.runtime.tmp.form_button_headline) && (e.runtime.tmp.form_button_headline = {}), !e.runtime.tmp.form_sending[i.id]) {
                                var G = function () {
                                ...
                                if (a.captcha && !isEmptyLadiPage(k) && k["option.form_captcha"] && isObjectLadiPage(e.runtime.tmp.google_captcha)) if (window.grecaptcha) if (G(), e.runtime.tmp.google_captcha.enterprise && window.grecaptcha.enterprise) window.grecaptcha.enterprise.ready(function () {
                                    try {
                                        window.grecaptcha.enterprise.execute(e.runtime.tmp.google_captcha.api_key, {action: "submit"}).then(function (t) {
                                            W(), U(i, {captcha_token: t}, s, l, g, A)
                                        }).catch(function () {
                                            H(), W()
                                        })
                                    } catch (t) {
                                    ...
                                    D = i.getElementsByClassName("ladi-google-recaptcha-checkbox")[0], R = i.getAttribute("data-button-submit-other"), isEmptyLadiPage(R) || (D = document.querySelector("#" + R + " .ladi-google-recaptcha-checkbox")), F = D.getAttribute("data-widget-id"), q = window.grecaptcha.getResponse(F), W(), U(i, {captcha_token: q}, s, l, g, A)
                                } catch (t) {
                                    H(), W()
                                } else window.grecaptcha.ready(function () {
                                    try {
                                ...
                                }); else e.showMessage(e.const.LANG.FORM_CAPTCHA_LOADING); else {
                                    var X = k["option.form_send_ladipage"], z = k["option.form_api_data"], K = k["option.thankyou_type"], J = k["option.thankyou_value"], $ = k["option.deeplink_value"], Z = k["option.form_auto_funnel"], Q = k["option.form_thankyou_funnel"], tt = function () {
                                        isObjectLadiPage(A) && isFunctionLadiPage(A.callbackOtpShowThankYouDone) && A.callbackOtpShowThankYouDone(), isFunctionLadiPage(o) && o();
                                        var a = !1;
                                        if (e.runtime.has_popupx && e.runtime.tmp.popupx_is_inline) a = !0; else if (K != e.const.FORM_THANKYOU_TYPE.url) {
                                            var n = e.findAncestor(i, "ladi-popup");
                                            isEmptyLadiPage(n) || (n = e.findAncestor(n, "ladi-element"), e.runRemovePopup(n.id, t))
                                        }
                                        var r = 0;
                                        if (!e.runtime.isDesktop && !isEmptyLadiPage($)) {
                                            r = 1e3;
                                            var s = e.convertDataReplaceStr($, !0, null, !1, p);
                                            window.ladi(s).open_url()
                                        }
                                        if (!Q || isEmptyLadiPage(h)) {
                                            if (K == e.const.FORM_THANKYOU_TYPE.default && (isEmptyLadiPage(J) || e.showMessage(J, p)), K == e.const.FORM_THANKYOU_TYPE.popup && (Z && e.setDataReplaceElement(!1, !1, p, J), window.ladi(J).show(!1, {formThankyouPopupXInline: a})), K == e.const.FORM_THANKYOU_TYPE.url && !isEmptyLadiPage(J)) {
                                                var l = window.ladi(J).get_url(d, Z, !1);
                                                e.runTimeout(function () {
                                                    window.ladi(l).open_url()
                                                }, r)
                                            }
                                        } else {
                                            var c = window.ladi(h).get_url(d, Z, !1);
                                            e.runTimeout(function () {
                                                window.ladi(c).open_url()
                                            }, r)
                                        }
                                    };
                                    if (k["option.only_facebook_widget"]) {
                                        if (isObjectLadiPage(window.LadiFlow) && isFunctionLadiPage(window.LadiFlow.confirmCheckbox)) for (var et = i.getElementsByClassName("ladiflow-widget"), it = 0; it < et.length; it++) window.LadiFlow.confirmCheckbox(et[it].id);
                                        return e.runEventTracking(i.id, {is_form: !0}, r), void tt()
                                    }
                                    if (isEmptyLadiPage(_) && isEmptyLadiPage(k["option.sync_ladisales_form_account_id"]) && isEmptyLadiPage(k["option.sync_ladiflow_form_account_id"]) && isEmptyLadiPage(k["option.sync_ladishare_form_account_id"]) && isEmptyLadiPage(k["option.sync_ladichat_form_account_id"])) j(0, A, O, l); else if (M(O, s), B(O, s, g)) {
                                        var at = 0, nt = 0, ot = null, rt = [], dt = !1, st = !1, lt = !0, ct = function (t) {
                                            t && V(O), W()
                                        }, ut = function (t) {
                                            if (-1 != [e.const.FORM_CONFIG_TYPE.sapo, e.const.FORM_CONFIG_TYPE.shopify, e.const.FORM_CONFIG_TYPE.haravan, e.const.FORM_CONFIG_TYPE.wordpress].indexOf(e.runtime.shopping_product_type) && e.runtime.tmp.cart.length > 0) {
                                                ...
                                                return a = JSON.stringify(a), a = encodeURIComponent(a), void e.removeAddToCartProduct(a, !1, i, function (e) {
                                                    e ? ut(t) : isFunctionLadiPage(t) && t()
                                                })
                                            }
                                            -1 != [e.const.FORM_CONFIG_TYPE.ladisales].indexOf(e.runtime.shopping_product_type) && (window.ladi("_cart_token").delete_cookie(), window.ladi("_checkout_token").delete_cookie(), e.createCartData()), isFunctionLadiPage(t) && t()
                                        }, pt = function (t, a, n, o) {
                                            if (n.readyState == XMLHttpRequest.DONE) {
                                                ...
                                                s = isObjectLadiPage(s) ? s : {}, o == e.const.API_FORM_DATA ? 200 == s.code ? at++ : (1 != s.code || isEmptyLadiPage(s.message) || (ot = s.message), nt++, lt = !1) : 200 == a || 201 == a ? at++ : e.getElementAHref(o).host == e.const.DOMAIN_GOOGLE_DOCS ? at++ : nt++, at + nt == rt.length && (lt && !dt && at >= 1 ? (dt = !0, isFunctionLadiPage(A.callbackOtp) && A.callbackOtp(!0), isObjectLadiPage(A) && isFunctionLadiPage(A.callbackThankyou) ? (W(), A.callbackThankyou(A, function () {
                                                    ut(function () {
                                                        ct(!0), e.runtime.tmp.current_use_coupon = null
                                                    })
                                                })) : (d = e.copy(r), p = e.copy(u), Object.keys(e.runtime.replaceStr).forEach(function (t) {
                                                    d.hasOwnProperty(t) || (d[t] = e.runtime.replaceStr[t]), p.hasOwnProperty(t) || (p[t] = e.runtime.replaceStr[t])
                                                }), function (t, i, a) {
                                                    var n = null, o = !1, r = function (t, i) {
                                                        o || (isFunctionLadiPage(a) && a(t, i), e.removeTimeout(n), o = !0)
                                                    };
                                                    n = e.runTimeout(r, 3e3), C("FormSubmit", {ladi_form_id: t, total_revenue: i}, r)
                                                }(i.id, L, function (t, a) {
                                                    e.runEventTracking(i.id, {is_form: !0}, r), window.ladi("_capture_" + i.id).delete_cookie(), isObjectLadiPage(A) && isFunctionLadiPage(A.callbackOtpDone) && A.callbackOtpDone(), ut(function () {
                                                        e.runTimeout(function () {
                                                            ct(!0), e.runtime.tmp.current_use_coupon = null, tt()
                                                        }, 500)
                                                    })
                                                }))) : !st && nt >= 1 && (isFunctionLadiPage(A.callbackOtp) && A.callbackOtp(!1), st = !0, e.showMessage(ot || e.const.LANG.REQUEST_SEND_ERROR), ct(!1)))
                                            }
                                        }, mt = function (t) {
                                            rt.push({url: e.const.API_FORM_DATA, data: JSON.stringify(t), async: !0, headers: {"Content-Type": "application/json"}, callback: pt})
                                        };
                                        X && Y(0, A, s, l, mt), isArrayLadiPage(z) && z.forEach(function (t) {
                                            if (!isEmptyLadiPage(t.api_url) && isArrayLadiPage(t.custom_fields)) {
                                                var i = e.getElementAHref(t.api_url).host == e.const.DOMAIN_GOOGLE_DOCS, a = {}, n = null, o = null, r = null, d = null;
                                                t.custom_fields.forEach(function (t) {
                                                    if (N && ("cart_products" == t.ladi_name && (n = t.name), "cart_revenue" == t.ladi_name && (o = t.name), "cart_shipping" == t.ladi_name && (r = t.name), "cart_coupon_amount" == t.ladi_name && (d = t.name)), !c[t.ladi_name]) {
                                                        var e = u[t.ladi_name];
                                                        isNullLadiPage(e) || (isArrayLadiPage(e) ? 0 == e.length ? a[t.name] = "" : a[t.name] = JSON.stringify(e) : a[t.name] = e)
                                                    }
                                                }), isEmptyLadiPage(n) || isNullLadiPage(E) || (a[n] = JSON.stringify(E)), isEmptyLadiPage(o) || isNullLadiPage(L) || (a[o] = L), isEmptyLadiPage(r) || isNullLadiPage(e.runtime.tmp.add_to_cart_shipping_method_id) || (a[r] = e.runtime.tmp.add_to_cart_shipping_method_id + "|" + (e.runtime.tmp.add_to_cart_fee_shipping || 0)), isEmptyLadiPage(d) || isEmptyLadiPage(e.runtime.tmp.current_use_coupon) || (a[d] = e.runtime.tmp.add_to_cart_discount || 0);
                                                var s = {};
                                                ...
                                                if (!i) a.link = window.location.href, e.runtime.has_popupx && (a.origin_link = e.runtime.tmp.popupx_origin_url), Object.keys(LadiFormApi).forEach(function (t) {
                                                    a[t] = LadiFormApi[t]
                                                }), x.forEach(function (t) {
                                                    var e = I[t];
                                                    isNullLadiPage(e) || (a[t] = e)
                                                });
                                                var p = null, m = t.content_type || e.const.CONTENT_TYPE.form_urlencoded;
                                                if (m == e.const.CONTENT_TYPE.form_urlencoded && (s["Content-Type"] = "application/x-www-form-urlencoded", p = Object.keys(a).reduce(function (t, e) {
                                                    return t.push(e + "=" + encodeURIComponent(a[e])), t
                                                }, []).join("&")), m == e.const.CONTENT_TYPE.json && (s["Content-Type"] = "application/json", p = JSON.stringify(a)), m == e.const.CONTENT_TYPE.form_data) p = new FormData, Object.keys(a).forEach(function (t) {
                                                    p.append(t, a[t])
                                                });
                                                rt.push({url: t.api_url, data: p, async: !0, headers: s, callback: pt})
                                            }
                                        });
                                        (rt.length > 0 || !X) && G(), e.runTimeout(function () {
                                            0 == rt.length && (X ? j(0, A, O, l) : Y(0, A, s, l, mt)), rt.forEach(function (t) {
                    ...
                    if (!isEmptyLadiPage(i)) {
                        ...
                        for (var n = i.querySelectorAll('[ladi-checkbox-required="true"]'), o = -1, d = 0; d < n.length; d++) if (0 == n[d].querySelectorAll('[type="checkbox"]:checked').length) {
                            o = d;
                            break
                        }
                        if (-1 == o) {
                            var s = function (t) {
                                var e = !1, n = null;
                                isEmptyLadiPage(a["option.form_config_id"]) || ((a["option.form_auto_capture"] || t.isFormOtp) && (n = q(i.id, a["option.form_config_id"])), a["option.form_auto_capture"] && (e = !0));
                                var o = {captcha: !0};
                                (t.isResendOtp || t.isSendOtp) && (o.captcha = !1), t.isFormOtp && (t.isCapture = e), U(i, o, !1, n, null, t)
                            }, l = function (t) {
                                window.ladi("_capture_" + i.id).delete_cookie(), window.ladi("_otp_id_" + i.id).delete_cookie();
                                var n = [];
                                isObjectLadiPage(a["option.form_setting"]) && (n = a["option.form_setting"].mapping_form_id || []), n.forEach(function (i) {
                                ...
                                t.isFormOtp && !t.isResendOtp && function () {
                                    ...
                                    var o = [];
                                    isObjectLadiPage(a["option.form_setting"]) && (o = a["option.form_setting"].mapping_form_id || []), o.forEach(function (i) {
                                        (t = {})["_otp_time_" + i] = null, (n = Object.keys(t)).forEach(function (e) {
                                            t[e] = window.ladi(e).get_cookie()
                                        }), e.runtime.tmp["cookie_cache_otp_" + i] = t
                                    }), e.runtime.tmp["form_data_ladi_" + i.id] = e.runtime.tmp["form_data_ladi_tmp_" + i.id]
                                }(), l(!1), G(i, a, !1, null, {isRunTracking: !1, getOtp: _, beforeRunOtp: c}), isFunctionLadiPage(n) && n()
                            };
                            if (!isEmptyLadiPage(a) && a["option.is_form_login"]) !function (t, i) {
                                ...
                                if (!isEmptyLadiPage(a) && !isEmptyLadiPage(a.value)) {
                                    ...
                                    e.sendRequest("POST", e.const.API_ACCESS_KEY_LOGIN, JSON.stringify({tokens: n.removeSpace(), url: window.location.href, code: a.value.toUpperCase()}), !0, {"Content-Type": "application/json"}, function (t, i, a, r) {
                                        if (a.readyState == XMLHttpRequest.DONE) {
                                            var d = {}, s = e.const.LANG.FORM_LOGIN_SEND_ERROR;
                                            try {
                                                if (200 == (d = JSON.parse(t)).code) {
                                                    ...
                                                    var c = e.getElementAHref(d.data.url, !0), u = window.location.search;
                                                    return (u.startsWith("?") || u.startsWith("&")) && (u = u.substring(1)), isEmptyLadiPage(u) || (c.search = c.search + (isEmptyLadiPage(c.search) ? "?" : "&") + u), void window.ladi(c.href).open_url()
                                                }
                                                s = d.message || s
                                            } catch (t) {
                                            }
                            ...
                            }(i); else if (!isEmptyLadiPage(a) && isObjectLadiPage(a["option.form_setting"]) && a["option.form_setting"].is_multiple) a["option.form_setting"].is_multiple_otp ? (l(!0), _(!1, function (t) {
                                if (t) {
                                    var e = [];
                            ...
                            })) : G(i, a, !1, null, {isRunTracking: !0}); else {
                                if (e.runtime.shopping_product_type == e.const.FORM_CONFIG_TYPE.ladisales && !isNullLadiPage(e.runtime.shopping_config_checkout_id)) {
                                    ...
                                    if (!isEmptyLadiPage(f) && (f = e.findAncestor(f, "ladi-element"), !isEmptyLadiPage(f) && "POPUP_CHECKOUT" == f.id)) return function (t) {
                                        var i = window.ladi("_cart_token").get_cookie(), a = window.ladi("_checkout_token").get_cookie();
                                        u = {}, p = {}, m = [], T = [], S = [], M(t, !1);
                                        var n = r.email, o = r.phone;
                                        if (isEmptyLadiPage(i) || isEmptyLadiPage(a)) e.showMessage(e.const.LANG.FORM_INPUT_REQUIRED_ERROR); else if (isEmptyLadiPage(n) && isEmptyLadiPage(o)) e.showMessage(e.const.LANG.FORM_INPUT_REQUIRED_ERROR); else {
                                            var d = r.name, s = r.address, l = r.message, c = r.country || "";
                                            c = c.split(":")[0];
                                            var _ = r.state || "";
                                            _ = _.split(":")[0];
                                            var y = r.district || "";
                                            ...
                                            var f = r.ward || "";
                                            f = f.split(":")[0];
                                            var v = r.coupon, P = e.runtime.tmp.add_to_cart_shipping_method_id, h = e.getLadiSaleCheckoutCartProducts(), L = {
                                                cart_token: i,
                                                checkout_token: a,
                                                discount_code: v,
                                            ...
                                            I = e.getURLSearchParams(null, null, !1), x.forEach(function (t) {
                                                L.utm[t] = isNullLadiPage(I[t]) ? "" : I[t]
                                            }), e.runtime.has_popupx && (L.utm.origin_url_page = e.runtime.tmp.popupx_origin_url), isEmptyLadiPage(g) || (L.utm[e.const.REF_NAME] = g), L.custom_fields = {};
                                            var E = Object.keys(r);
                            ...
                            if (v.length > 0) {
                                ...
                                for (var P = 0; P < v.length; P++) v[P].removeEventListener("change", W), v[P].addEventListener("change", W);
                    ...
                    if (!isEmptyLadiPage(o)) {
                        ...
                        if (!(isEmptyLadiPage(r) || (a = i ? a : e.runtime.eventData[r.id], isEmptyLadiPage(a) || !a["option.is_buy_now"] && !a["option.is_add_to_cart"] || isEmptyLadiPage(a["option.product_type"]) || isEmptyLadiPage(a["option.product_id"])))) {
                            var d = function () {
                                var o = e.generateVariantProduct(a, !1, null, null, null, null, !0, !0, d);
                                if (isEmptyLadiPage(o) || isEmptyLadiPage(o.store_info) || isEmptyLadiPage(o.product)) isEmptyLadiPage(e.runtime.tmp.timeout_product_info[a["option.product_type"]][a["option.product_id"]]) && e.showMessage(e.const.LANG.ADD_TO_CART_NO_PRODUCT, {name: e.getMessageNameProduct()}); else {
                                    var s = -1, l = null;
                                    if (i) {
                                        var c = r.querySelector('[data-variant="true"]');
                                        l = e.getProductVariantId(c, o.product), isEmptyLadiPage(l) || (s = o.product.variants.findIndex(function (t) {
                                    ...
                                    if (-1 != s) {
                                        ...
                                        var p = o.product.name, m = o.product.variants[s].title, g = o.product.variants[s].price, _ = o.product.variants[s].quantity, y = o.product.variants[s].quantity_stock;
                                        _ = isNullLadiPage(y) ? _ : y;
                                        var f = isEmptyLadiPage(o.product.variants[s].src) ? "" : o.product.variants[s].src;
                                        f = isEmptyLadiPage(f) && isObjectLadiPage(o.product.image) ? o.product.image.src : f, isEmptyLadiPage(f) || !isStringLadiPage(f) || f.startsWith("http://") || f.startsWith("https://") || f.startsWith("//") || (f = "https://" + e.const.STATIC_W_DOMAIN + "/" + f);
                                        if (0 == o.product.select_many_service && isArrayLadiPage(e.runtime.tmp.cart) && -1 != e.runtime.tmp.cart.findIndex(function (t) {
                                            return t.product_id == u && t.product_variant_id != l && t.quantity > 0
                                        })) e.showMessage(e.const.LANG.ADD_TO_CART_PRODUCT_ONLY_ONE, {name: e.getMessageNameProduct(o.product.variants[s])}); else {
                                            var v = e.runtime.tmp.cart.findIndex(function (t) {
                                                return t.product_variant_id == l
                                            }), P = !1;
                                            if (-1 == v) {
                                                P = !0;
                                                var h = {store_id: o.store_info.id, product_id: u, product_variant_id: l, name: p, title: m, price: g, image: f, quantity: 0, min_buy: o.product.variants[s].min_buy, max_buy: o.product.variants[s].max_buy, inventory_checked: o.product.variants[s].inventory_checked, available_quantity: _, currency: o.store_info.currency, product_type: o.product.variants[s].product_type, package_quantity: o.product.variants[s].package_quantity};
                                                isObjectLadiPage(h.currency) && !isEmptyLadiPage(h.currency.code) && (h.currency.symbol = e.formatCurrency(null, h.currency.code, !1, !0)), e.runtime.tmp.cart.push(h), v = e.runtime.tmp.cart.length - 1
                                            }
                                            var L = r.querySelector('input[name="quantity"]');
                                            if (isEmptyLadiPage(L) || isEmptyLadiPage(L.value)) e.showMessage(e.const.LANG.ADD_TO_CART_QUANTITY_REQUIRED); else {
                                                ...
                                                var T = !1;
                                                if (!isEmptyLadiPage(w) && e.runtime.tmp.cart[v].quantity + E > w && (E = w - e.runtime.tmp.cart[v].quantity) <= 0 && (T = !0, b = w), 1 == o.product.variants[s].inventory_checked) {
                                                ...
                                                if (T || E <= 0 && _ > 0) e.showMessage(e.const.LANG.ADD_TO_CART_MAX_QUANTITY, {max: b, name: e.getMessageNameProduct(o.product.variants[s])}, function () {
                                                    var i = t.target;
                                                    ...
                                                    if (!isEmptyLadiPage(a)) {
                                                        ...
                                                        n.forEach(function (t) {
                                                            t.action_type == e.const.ACTION_TYPE.action && (t.type == e.const.DATA_ACTION_TYPE.popup_cart && window.ladi("POPUP_CART").show(), t.type == e.const.DATA_ACTION_TYPE.popup_checkout && (e.runtime.shopping_third_party ? e.getThirdPartyCheckoutUrl(!0) : window.ladi("POPUP_CHECKOUT").show()))
                                                        })
                                                    }
                                                }); else if (E > 0) {
                                                    var S = !isEmptyLadiPage(o.product.variants[s].start_date) && new Date(o.product.variants[s].start_date).getTime() > Date.now(), O = !isEmptyLadiPage(o.product.variants[s].end_date) && new Date(o.product.variants[s].end_date).getTime() < Date.now();
                                                    if (S) e.showMessage(e.const.LANG.ADD_TO_CART_PRODUCT_BEFORE_START_DATE, {name: e.getMessageNameProduct(o.product.variants[s])}); else if (O) e.showMessage(e.const.LANG.ADD_TO_CART_PRODUCT_AFTER_END_DATE, {name: e.getMessageNameProduct(o.product.variants[s])}); else {
                                                        var C = function () {
                                                            e.runtime.tmp.cart[v].quantity += E;
                                                            var t = {product_id: u, product_variant_id: l, quantity: E};
                                                            t.product_type = e.runtime.tmp.cart[v].product_type, t.package_quantity = e.runtime.tmp.cart[v].package_quantity, e.addCartCookie(o.store_info.id, t, function () {
                                                                isFunctionLadiPage(n) && n();
                                                                ...
                                                                e.runtime.tmp.generateCart(), e.changeTotalPriceCart(), e.runtime.tmp.is_click_add_to_cart = !1, 0 == e.runtime.tmp.cart.length && -1 != [e.const.FORM_CONFIG_TYPE.ladisales].indexOf(e.runtime.shopping_product_type) && (window.ladi("_cart_token").delete_cookie(), window.ladi("_checkout_token").delete_cookie()), e.runResizeAll()
                                                            })
                                                        };
                                                        if (isEmptyLadiPage(window.ladi("_cart_token").get_cookie())) if (e.runtime.tmp.is_click_add_to_cart) {
                                                            var N = function () {
                                                                e.runTimeout(function () {
                                                            ...
                                                            N()
                                                        } else e.runtime.tmp.is_click_add_to_cart = !0, C(); else C()
                                                    }
                        ...
                        if (!isEmptyLadiPage(a)) {
                            ...
                            n.forEach(function (t) {
                                if (t.action_type == e.const.ACTION_TYPE.action) {
                                    var i = null;
                                    t.type == e.const.DATA_ACTION_TYPE.popup_cart && (i = "POPUP_CART"), t.type == e.const.DATA_ACTION_TYPE.popup_checkout && (i = "POPUP_CHECKOUT"), t.type == e.const.DATA_ACTION_TYPE.popup_checkout && e.runtime.shopping_third_party ? e.getThirdPartyCheckoutUrl(!0) : isEmptyLadiPage(i) || window.ladi(i).show()
                                }
                        ...
                        if (!isEmptyLadiPage(a)) {
                            ...
                            if (!isEmptyLadiPage(n)) {
                                ...
                                if (isObjectLadiPage(n["option.form_setting"]) && n["option.form_setting"].is_multiple) {
                                    if (!n["option.form_setting"].is_multiple_otp) return void G(a, n, !0, t.target.getAttribute("name"), {isRunTracking: !0});
                                    o.isFormOtp = !0, o.isCapture = !0
                                }
                                if (n["option.form_auto_capture"] && !isEmptyLadiPage(n["option.form_config_id"])) {
                                    var r = q(a.id, n["option.form_config_id"]);
                                    U(a, {captcha: !0}, !0, r, t.target.getAttribute("name"), o)
                                }
                            }
                        }
                    }
                ...
                D.forEach(function (t) {
                    Z[t] = window.ladi("_ladipage_" + t).get_cookie(), isEmptyLadiPage(l[t]) || (Z[t] = l[t])
                }), i = s(Z);
                var Q = 0, tt = !1, et = function (t) {
                    for (var n = a[Q].querySelectorAll('.ladi-element .ladi-form-item-container [name="' + t + '"]'), o = null, r = 0; r < n.length; r++) {
                        var d = Z[t];
                        if (!isEmptyLadiPage(d) && "none" != getComputedStyle(n[r]).display) if ("true" != n[r].getAttribute("data-is-select-country") && (d = i[t]), "SELECT" == n[r].tagName) n[r].querySelectorAll('option[value="' + d + '"]').length > 0 && (n[r].value = d, tt && e.fireEvent(n[r], "change")); else {
                            if ("country" == t && "true" == n[r].getAttribute("data-is-select-country")) continue;
                            "INPUT" == n[r].tagName && "true" == n[r].getAttribute("data-is-select-country") && 2 == (o = d.split(":")).length && (d = o[1]), n[r].value = d, tt && e.fireEvent(n[r], "change")
                        }
                    }
                }, it = function (t) {
                ...
                for (Q = 0; Q < a.length; Q++) {
                    a[Q].onsubmit = X;
                    for (var nt = e.findAncestor(a[Q], "ladi-element"), ot = a[Q].getElementsByClassName("ladi-button"), rt = 0; rt < ot.length; rt++) {
                        var dt = a[Q].getElementsByClassName("ladi-button")[rt];
                        if (!isEmptyLadiPage(dt)) {
                            var st = e.findAncestor(dt, "ladi-element");
                            isEmptyLadiPage(nt) || isEmptyLadiPage(e.runtime.eventData[nt.id]) || !e.runtime.eventData[nt.id]["option.is_add_to_cart"] ? st.addEventListener("click", J) : (st.setAttribute("data-click", !1), st.addEventListener("click", K))
                        }
                    }
                    var lt = a[Q].querySelector('[data-is-select-country="true"][name="country"]');
                    if (!isEmptyLadiPage(lt) && "true" == lt.getAttribute("data-no-ward")) {
                        var ct = a[Q].querySelector('[data-is-select-country="true"][name="ward"]');
                        isEmptyLadiPage(ct) || ct.removeAttribute("required")
                    }
                    for (var ut = a[Q].querySelectorAll('input[data-type="date"]'), pt = 0; pt < ut.length; pt++) isEmptyLadiPage(ut[pt].getAttribute("placeholder")) || (e.runtime.isDesktop || e.runtime.isBrowserDesktop ? (ut[pt].setAttribute("type", "text"), ut[pt].addEventListener("focus", it), ut[pt].addEventListener("blur", at)) : ut[pt].value = (new Date).toISOString().substr(0, 10));
                    var mt = a[Q].querySelectorAll("[tabindex]"), gt = 0, _t = 0;
                    for (pt = 0; pt < mt.length; pt++) (_t = parseInt(mt[pt].getAttribute("tabindex")) || 0) > gt && (gt = _t), mt[pt].setAttribute("tabindex", e.runtime.tabindexForm + _t);
                    for (mt = a[Q].querySelectorAll("[data-tabindex]"), pt = 0; pt < mt.length; pt++) (_t = parseInt(mt[pt].getAttribute("data-tabindex")) || 0) > gt && (gt = _t), mt[pt].setAttribute("data-tabindex", e.runtime.tabindexForm + _t);
                    e.runtime.tabindexForm += gt;
                    for (var yt = 0; yt < R.length; yt++) {
                        var ft = a[Q].querySelector('.ladi-element .ladi-form-item-container input[name="' + R[yt] + '"]');
                        isEmptyLadiPage(ft) || ft.addEventListener("focusout", $)
                    }
                }
                var vt = function (t, i) {
                    for (tt = i, Q = 0; Q < a.length; Q++) {
                        var n = e.findAncestor(a[Q], "ladi-element");
                        !isEmptyLadiPage(e.runtime.eventData[n.id]) && e.runtime.eventData[n.id]["option.form_auto_complete"] && t.forEach(et)
                    }
                };
                vt(e.copy(D).except(e.runtime.list_set_value_name_country));
                e.runtime.tmp.listAfterLocation.push(function () {
                    var t = "", i = "", n = "", o = "", r = null, d = function (t, e) {
                        var i = String(r[t].name), a = String(r[e].name);
                        try {
                        ...
                        if (n = "", !isEmptyLadiPage(i) && isObjectLadiPage(i.data)) {
                            ...
                            r = i.data, a.sort(d), a.forEach(function (t) {
                                var e = i.data[t];
                                    ...
                                    if (!isEmptyLadiPage(s)) {
                                        ...
                                        if (!isEmptyLadiPage(l) && isObjectLadiPage(l.data)) {
                                            ...
                                            if (!isEmptyLadiPage(c)) {
                                                ...
                                                r = c.data, u.sort(d), u.forEach(function (t) {
                                                    var e = c.data[t];
                    ...
                    for (Q = 0; Q < a.length; Q++) {
                        var p = a[Q].querySelectorAll('.ladi-element .ladi-form-item-container [name="state"]'), m = 0, g = null;
                        for (m = 0; m < p.length; m++) if (g = e.findAncestor(p[m], "ladi-element"), !isEmptyLadiPage(g) && (i = e.runtime.eventData[g.id]["option.input_country"], !isEmptyLadiPage(i) && (t = "", i = i.split(":")[0], !isEmptyLadiPage(window.LadiLocation[i])))) {
                            var _ = window.LadiLocation[i].data, y = Object.keys(_);
                            r = _, y.sort(d), isArrayLadiPage(e.runtime.country_state_sort[i]) && (y = y.except(e.runtime.country_state_sort[i]), y = e.runtime.country_state_sort[i].concat(y)), y.forEach(s), p[m].innerHTML = p[m].querySelector("option").outerHTML + t, p[m].setAttribute("data-country", i), p[m].addEventListener("change", l)
                        }
                        var f = a[Q].querySelectorAll('.ladi-element .ladi-form-item-container [name="district"]');
                        for (m = 0; m < f.length; m++) f[m].addEventListener("change", c);
                        var v = a[Q].querySelectorAll('.ladi-element .ladi-form-item-container [name="ward"]');
                        for (m = 0; m < v.length; m++) v[m].addEventListener("change", u)
                    }
                }), e.runtime.tmp.listAfterLocation.push(function () {
                    vt(F, !0)
                }), e.runtime.tmp.buttonAddToCartClick = z
            }, K = function () {
                for (var t = document.querySelectorAll(".ladi-form .ladi-element .ladi-form-control-file"), i = function (t) {
                    var i = t.target, a = i.getAttribute("data-click-id") || e.randomId();
                    ...
                    n.setAttribute("data-file-click-id", a), "true" != n.getAttribute("data-event") && (n.setAttribute("data-event", !0), n.addEventListener("change", function (t) {
                        !function (t, i, a) {
                            if (i.length > e.const.FORM_UPLOAD_FILE_LENGTH) e.showMessage(e.const.LANG.FORM_UPLOAD_FILE_MAX_LENGTH_ERROR, {max_length: e.const.FORM_UPLOAD_FILE_LENGTH}); else {
                                for (var n = new FormData, o = 0, r = 0; r < i.length; r++) o += i[r].size, n.append("file[]", i[r]);
                                if (o > 1024 * e.const.FORM_UPLOAD_FILE_SIZE * 1024) e.showMessage(e.const.LANG.FORM_UPLOAD_FILE_MAX_SIZE_ERROR, {max_size: e.const.FORM_UPLOAD_FILE_SIZE}); else {
                                    var d = {ladipage_id: e.runtime.ladipage_id, lang: e.runtime.lang};
                                    n.append("json_data", JSON.stringify(d)), e.showLoadingBlur(), e.sendRequest("POST", e.const.API_FILE_UPLOAD, n, !0, null, function (i, a, n) {
                                        if (n.readyState == XMLHttpRequest.DONE) {
                                            if (e.hideLoadingBlur(), 200 == a) try {
                                                ...
                                                if (200 == o.code) {
                                                    ...
                                                    }), t.value = r.length > 0 ? "[" + r.join(", ") + "]" : "", void t.setAttribute("data-path-file", JSON.stringify(d))
                                                }
                ...
                if (e.runtime.isClient && !e.runtime.isDesktop && !isEmptyLadiPage(e.runtime.bodyFontSize)) {
                    ...
                    if (1 != i) for (var a = document.querySelectorAll(".ladi-paragraph, .ladi-list-paragraph, .ladi-headline, .ladi-countdown, .ladi-form, .ladi-table, .ladi-spin-lucky"), n = 0; n < a.length; n++) {
                ...
                for (var a = 0; a < i.length; a++) {
                    Z(i[a]) == e ? i[a].classList.add("selected") : i[a].classList.remove("selected")
                }
            }, tt = function (t) {
                ...
                var a = t.target;
                if (a.classList.contains("disabled")) for (var n = e.findAncestor(a, "ladi-element").querySelectorAll(".ladi-form-label-item"), o = 0; o < n.length; o++) n[o].classList.contains("no-value") ? n[o].classList.add("selected") : n[o].classList.remove("selected"), n[o].classList.remove("disabled");
                var r = Z(a);
                !t.is_fire_event && a.classList.contains("selected") && (r = "");
                var d = e.findAncestor(a, "ladi-form-label-container");
                Q(d, r), isFunctionLadiPage(i) && i(d)
            }, it = function (i, a, n, o) {
                if ("form" == a) {
                    ...
                    if (!isEmptyLadiPage(r) && r["option.is_add_to_cart"]) {
                        ...
                        if (!isEmptyLadiPage(d) && (!n || isEmptyLadiPage(e.findAncestor(d, "ladi-collection-item")))) {
                            ...
                            if (!isEmptyLadiPage(s)) {
                                ...
                                if (!isEmptyLadiPage(l)) {
                                    var c = r["option.product_type"], u = r["option.product_id"];
                                    if (!isEmptyLadiPage(c) && !isEmptyLadiPage(u)) {
                                        ...
                                        if (!(isEmptyLadiPage(p) || isEmptyLadiPage(p.store_info) || isEmptyLadiPage(p.product))) {
                                            var m = e.generateVariantProduct(r, !0, l["option.product_variant_type"], l["option.product_variant_title"], l["option.product_variant_price"], l["option.input_tabindex"], t, !0, function (t) {
                                                it(i, a, n, o)
                                            }), g = function (t) {
                                                e.updateProductVariantSelectOption(t, r, l, o, function () {
                                                    if (o) {
                                                        var a = e.generateVariantProduct(r, !1, null, null, null, null, !0, !0), n = e.getProductVariantId(t.target, a.product);
                                            ...
                                            e.showParentVisibility(s, function () {
                                                for (var t = s.clientHeight, i = t, a = s.querySelectorAll("select.ladi-form-control"), n = {}, o = 0; o < a.length; o++) n[a[o].getAttribute("data-store-id") + "_" + a[o].getAttribute("data-product-id") + "_" + a[o].getAttribute("data-product-option-id")] = a[o].value;
                                                var c = s.querySelectorAll(".ladi-form-label-container");
                                                for (o = 0; o < c.length; o++) n[c[o].getAttribute("data-store-id") + "_" + c[o].getAttribute("data-product-id") + "_" + c[o].getAttribute("data-product-option-id")] = tt(c[o]);
                                                s.innerHTML = m;
                                                for (var u = null, p = null, y = s.querySelectorAll("select.ladi-form-control"), f = 0; f < y.length; f++) y[f].addEventListener("change", g), u = n[y[f].getAttribute("data-store-id") + "_" + y[f].getAttribute("data-product-id") + "_" + y[f].getAttribute("data-product-option-id")], isNullLadiPage(u) && (p = y[f].querySelector("option"), isEmptyLadiPage(p) || (u = p.getAttribute("value"))), y[f].value = u;
                ...
                if (isObjectLadiPage(a) && isObjectLadiPage(a.variant) && isObjectLadiPage(a.product)) {
                    ...
                    if (isEmptyLadiPage(o) && (o = a.product.image, isObjectLadiPage(o) && (o = o.src)), !isEmptyLadiPage(o)) {
                        ...
                        var r = e.findAncestor(i, "ladi-collection-item"), d = [], s = 0, l = null;
                        if (isEmptyLadiPage(r)) {
                            var c = document.querySelectorAll("[data-runtime-id]");
                            for (s = 0; s < c.length; s++) r = e.findAncestor(c[s], "ladi-collection-item"), isEmptyLadiPage(r) && (l = e.runtime.eventData[c[s].id], isEmptyLadiPage(l) || l["option.product_type"] != n["option.product_type"] || l["option.product_id"] != n["option.product_id"] || d.push(c[s]))
                        } else d = r.querySelectorAll("[data-runtime-id]");
                        for (s = 0; s < d.length; s++) if (l = e.runtime.eventData[d[s].id], !isEmptyLadiPage(l) && !isEmptyLadiPage(l["option.product_mapping_name"])) {
                            var u = d[s].getElementsByClassName("ladi-gallery-view")[0], p = e.getOptimizeImage(o, u.clientWidth, u.clientHeight, !0, !1, !1, t);
                            p = 'url("' + p + '")';
                            var m = e.getOptimizeImage(o, 0, 0, !0, !1, !1, t);
                            m = 'url("' + m + '")';
                            for (var g = u.getElementsByClassName("ladi-gallery-view-item"), _ = 0; _ < g.length; _++) if (p == getComputedStyle(g[_]).backgroundImage || m == getComputedStyle(g[_]).backgroundImage) {
            ...
            }, nt = function (i, a, n, o, r, d, s, l) {
                var c = e.runtime.eventData[i];
                if (!isEmptyLadiPage(c)) {
                    var u = c["option.product_mapping_name"], p = !isEmptyLadiPage(u), m = c.type, g = JSON.stringify(c), y = null, f = null;
                    if (d) y = r.product[u]; else if (isEmptyLadiPage(o)) {
                        if (isEmptyLadiPage(c) || isEmptyLadiPage(c["option.product_type"]) || isEmptyLadiPage(c["option.product_id"]) || isEmptyLadiPage(u)) return;
                        var v = c["option.product_variant_id"], P = !1;
                        if (isEmptyLadiPage(v) && (a && (P = !function () {
                        ...
                        if (g === (y = (f = e.generateProductKey(!0, g, !0, c, P, v, o, function (t) {
                            nt(i, a, n, o, r, d, s)
                        })).value)) return
                    } else {
                        if ("form" == m && c["option.is_add_to_cart"]) return c["option.product_id"] = o.product_id, c["option.product_variant_id"] = o.product_variant_id, void it(i, m, !1, !0);
                        if (!p) return;
                        y = (y = (f = e.generateProductKey(!0, null, !0, c, !1, o.product_variant_id, o)).value) || ""
                    }
                    var L = null, E = null, b = null;
                    ...
                    if ("image" == m) {
                        ...
                        var w = "";
                        w = isEmptyLadiPage(b) ? "#" + i + "  > .ladi-image > .ladi-image-background {background-image: none;}" : "#" + i + '  > .ladi-image > .ladi-image-background {background-image: url("' + b + '");}', e.createStyleElement(E, w)
                    }
                    if ("gallery" == m) {
                        if (!isArrayLadiPage(y)) return;
                        if (L = document.getElementById(i), isEmptyLadiPage(L)) return;
                        if (n && "true" == L.getAttribute("data-loaded")) return void at(L, f, c);
                        ...
                        for (var C = L.getElementsByClassName("ladi-gallery-control-item"), N = function (t) {
                            G(t, L)
                        }; C.length < y.length;) {
                            var k = e.createTmpElement("div", '<div class="ladi-gallery-control-item" data-index="' + C.length + '"></div>', null, !0);
                        ...
                        var I = "";
                        y.length <= 1 && (I += "#" + i + " .ladi-gallery .ladi-gallery-view .ladi-gallery-view-arrow {display: none;}", I += "#" + i + " > .ladi-gallery > .ladi-gallery-view {height: 100%;}", I += "#" + i + " > .ladi-gallery > .ladi-gallery-control {display: none;}");
                        var x = L.getElementsByClassName("ladi-gallery-control-item")[0];
                        y.forEach(function (a, n) {
                            b = e.getOptimizeImage(a.src, T.clientWidth, T.clientHeight, !0, !1, !1, t), I += "#" + i + ' .ladi-gallery .ladi-gallery-view-item[data-index="' + n + '"] {background-image: url("' + b + '");}', b = e.getOptimizeImage(a.src, x.clientWidth, x.clientHeight, !0, !1, !1, t), I += "#" + i + ' .ladi-gallery .ladi-gallery-control-item[data-index="' + n + '"] {background-image: url("' + b + '");}'
                        }), L.setAttribute("data-max-item", y.length), L.setAttribute("data-loaded", !0), e.createStyleElement(E, I)
                    }
                }
            }, ot = function (t) {
                ...
                var n = e.runtime.eventData[t], o = document.getElementById(t), r = null, d = null, s = !1, l = !1, c = {width_device: e.runtime.desktop_width}, u = document.getElementById("style_container_desktop");
                if ((isEmptyLadiPage(u) || "print" == u.getAttribute("media")) && (c = {width_device: e.runtime.mobile_width}), !isEmptyLadiPage(n) && !isEmptyLadiPage(o)) {
                    ...
                    if ("popup" == n.type) {
                        r = {};
                        var m = n[e.runtime.device + ".option.popup_position"], g = !1;
                        if (isObjectLadiPage(a) && !isNullLadiPage(a.formThankyouPopupXInline) && (g = a.formThankyouPopupXInline), g) return m == e.const.POSITION_TYPE.default ? ot({group_id: e.runtime.tmp.popupx_iframe_id, popupx_url: window.location.origin + window.location.pathname, ladipage_id: e.runtime.ladipage_id, action_type: "show_popupx", action_value: t, action: {type: "run_action_force"}}) : ct(t, i), !0;
                        s = (d = st(t)).isCurrentPopup, l = d.isCurrentSection;
                        ["width", "height", "position", "margin", "top", "left", "bottom", "right", "z-index"].forEach(function (t) {
                            r[t] = p[t]
                        }), rt(r.width), c.width = r.width;
                        var _ = n[e.runtime.device + ".option.popup_backdrop"];
                        return ot({id: t, position: m, data_backdrop: _, data_scale: c, is_opacity: !s, set_scroll_popup: !0, dimension: r, action: {type: "set_iframe_dimension"}}), window.ladi(t).show(!0), dt(t, i, s, l), !0
                    }
                    if ("section" == n.type) {
                        if (s = (d = st(t)).isCurrentPopup, l = d.isCurrentSection, n[e.runtime.device + ".option.sticky"]) {
                            r = {height: p.height};
                            var y = o.getElementsByClassName("ladi-container")[0], f = getComputedStyle(y);
                            rt(f.width), c.width = f.width, c.is_sticky_bar = !0, ot({id: t, data_scale: c, dimension: r, element: n, device: e.runtime.device, action: {type: "set_iframe_sticky"}}), window.ladi(t).show(!0), dt(t, i, s, l)
                        }
                        return !0
                    }
                }
                ...
                var a = e.runtime.eventData[t], n = document.getElementById(t), o = null;
                if (!isEmptyLadiPage(a) && !isEmptyLadiPage(n)) {
                    var r = getComputedStyle(n), d = st(t), s = d.isCurrentPopup, l = d.isCurrentSection, c = {width_device: e.runtime.desktop_width}, u = document.getElementById("style_container_desktop");
                    if ((isEmptyLadiPage(u) || "print" == u.getAttribute("media")) && (c = {width_device: e.runtime.mobile_width}), o = {width: r.width, height: r.height}, "popup" == a.type && (c.width = o.width), "section" == a.type) {
                        var p = n.getElementsByClassName("ladi-container")[0], m = getComputedStyle(p);
                        o.width = m.width, c.width = m.width, c.is_sticky_bar = !0
                    }
                    return rt(o.width), ot({id: t, data_scale: c, dimension: o, action: {type: "set_iframe_dimension"}}), window.ladi(t).show(!0), dt(t, i, s, l), !0
                }
                return !1
            }, ut = function (t) {
                ...
                var i;
                e.changeTotalPriceCart(), e.runtime.tmp.generateLadiSaleProduct(!0), e.runtime.shopping && e.createCartData(), e.loadDataset(null, null, null, null, null, !0, t), _.forEach(function (i) {
                    ...
                    isEmptyLadiPage(n) ? (function (t, i, a, n, o, r) {
                        ...
                        if (!isEmptyLadiPage(d) && (R(t), "section" == i && !isEmptyLadiPage(o) && !isEmptyLadiPage(r))) {
                            ...
                            isEmptyLadiPage(s) || (e.runtime.list_scroll_func[t] = function () {
                                if ((!e.runtime.isDesktop || a == e.const.BACKGROUND_STYLE.video) && (e.runtime.isDesktop || n == e.const.BACKGROUND_STYLE.video)) {
                                    var i = "", d = t + "_background_video";
                                    o == e.const.VIDEO_TYPE.youtube && (i = '<iframe id="' + d + '" class="ladi-section-background-video" style="position: absolute; width: 100%; height: 100%; top: 0; left: 0;" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"></iframe>', s.innerHTML += i, e.runEventPlayVideo(d, o, r, !0, !0, !1)), o == e.const.VIDEO_TYPE.direct && (i = '<video id="' + d + '" class="ladi-section-background-video" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover;"></video>', s.innerHTML += i, e.runEventPlayVideo(d, o, r, !0, !0, !1))
                                }
                            })
                        }
                    }(i, a.type, a[e.const.DESKTOP + ".option.background-style"], a[e.const.MOBILE + ".option.background-style"], a["option.background_video.video_type"], a["option.background_video.video_value"]), x(null, i, a.type, a), function (t, i, a) {
                    ...
                    }(i, a.type, a["option.data_event"] || a["option.data_action"]), D(null, i, a.type, a["option.data_event"] || a["option.data_hover"]), function (t, i, a, n, o, r, d) {
                        ...
                        "popup" == i && a && ((isEmptyLadiPage(n) || n < 0) && (n = 0), e.runTimeout(function () {
                            window.ladi(t).show()
                        }, 1e3 * n))
                    }(i, a.type, a["option.show_popup_welcome_page"], a["option.delay_popup_welcome_page"]), F(i, null, a.type, a["option.countdown_type"], a["option.countdown_minute"], a["option.countdown_daily_start"], a["option.countdown_daily_end"], a["option.countdown_endtime"]), q(i, null, a.type, a["option.countdown_item_type"]), function (t, i, a, n) {
                        if ("section" == i) {
                        ...
                        if ("form_item" == i) {
                            var n = null, o = null;
                            if ((a == e.const.INPUT_TYPE.select || a == e.const.INPUT_TYPE.select_multiple) && (n = document.getElementById(t), !isEmptyLadiPage(n))) for (var r = n.getElementsByClassName("ladi-form-control"), d = 0; d < r.length; d++) r[d].addEventListener("change", function (t) {
                            ...
                            if (a == e.const.INPUT_TYPE.radio) {
                                n = document.getElementById(t);
                                var p = function (t) {
                                    var i = e.findAncestor(t.target, "ladi-form-checkbox-item"), a = e.findAncestor(i, "ladi-form-checkbox");
                                    if (!isEmptyLadiPage(a)) {
                    ...
                    }(i, a.type, a["option.input_type"]), H(i, null, !1, a.type), e.startAutoScroll(i, a.type, a[e.const.DESKTOP + ".option.auto_scroll"], a[e.const.MOBILE + ".option.auto_scroll"]), it(i, a.type, !0, !1), function (t, i) {
                        if ("form" == i) {
                            var a = document.getElementById(t);
                            if (!isEmptyLadiPage(a)) {
                                ...
                                if (!isEmptyLadiPage(n)) {
                                        ...
                                        if (!isEmptyLadiPage(i.target.value)) {
                                            ...
                                            if (!isEmptyLadiPage(a) && a["option.is_add_to_cart"]) {
                                                ...
                                                if (!(isEmptyLadiPage(n) || isEmptyLadiPage(n.store_info) || isEmptyLadiPage(n.product))) {
                                                    ...
                                                    if (-1 != r) {
                                                        var d = n.product.variants[r].quantity, s = n.product.variants[r].quantity_stock;
                                                        d = isNullLadiPage(s) ? d : s;
                                                        var l = parseInt(i.target.value) || 0, c = 1;
                                                        c = n.product.variants[r].min_buy || c;
                                                        var u = n.product.variants[r].max_buy, p = 0, m = e.runtime.tmp.cart.findIndex(function (t) {
                                                            return t.product_id == n.product.variants[r].product_id && t.product_variant_id == n.product.variants[r].product_variant_id
                                                        });
                                                        -1 != m && (p = e.runtime.tmp.cart[m].quantity), c > l + p && (l = c - p), 1 == n.product.variants[r].inventory_checked && l + p > d && (l = d - p), !isEmptyLadiPage(u) && l + p > u && (l = u - p), l = l < 1 ? 1 : l, i.target.setAttribute("min", c), isEmptyLadiPage(u) || i.target.setAttribute("max", u), i.target.value = l
                                                    }
                                                }
                                            }
                                        }
                                    ...
                                    var r = a.querySelectorAll(".button")[0], d = a.querySelectorAll(".button")[1];
                        ...
                        if ("collection" == i) {
                            ...
                            if (!isEmptyLadiPage(a)) {
                                ...
                                if (!isEmptyLadiPage(n)) {
                                    var o = n["option.collection_setting.type"], r = a.getElementsByClassName("ladi-collection")[0];
                                    if (o == e.const.COLLECTION_TYPE.carousel) {
                                        ...
                                        var s = document.createElement("div");
                                        s.className = "ladi-collection-arrow ladi-collection-arrow-right opacity-0", r.appendChild(d), r.appendChild(s), d.addEventListener("click", function (i) {
                                            i.stopPropagation();
                                    ...
                                    if (o == e.const.COLLECTION_TYPE.readmore) {
                                        ...
                                        var l = document.createElement("div");
                                        l.className = "ladi-collection-button-next opacity-0", r.appendChild(l), l.addEventListener("click", function (i) {
                                            i.stopPropagation();
                                            var o = parseFloatLadiPage(a.getAttribute("data-page")) || 1;
                                            if (o += 1, a.hasAttribute("data-max-page")) {
                                                var r = parseFloatLadiPage(a.getAttribute("data-max-page")) || 1;
                        ...
                        if ("survey" == i) {
                            ...
                            if (!isEmptyLadiPage(o)) {
                                ...
                                for (var r, d = o.getElementsByClassName("ladi-survey-select-item")[0], s = o.getElementsByClassName("ladi-survey-radio-item"), l = o.getElementsByClassName("ladi-survey-checkbox-item"), c = o.getElementsByClassName("ladi-survey-option"), u = o.querySelector(".ladi-survey-button-next button"), p = [], m = n.mapping_form_name, g = n.mapping_form_id, _ = n.input_name, y = e.findAncestor(o, ["ladi-form", "ladi-element"]), f = e.runtime.eventData[t]["option.data_event"], v = function () {
                                    var i = window.ladi(t).value(), n = m || "";
                                    g.forEach(function (t) {
                                        var o = document.getElementById(t);
                                        if (!isEmptyLadiPage(o)) {
                                            for (var r = null; 0 != (r = o.querySelectorAll('.ladi-form-item-survey[data-name="' + n + '"]')).length;) r[0].parentElement.removeChild(r[0]);
                                            var d = [], s = o.querySelectorAll(".ladi-element .ladi-form-item-container [name]"), l = null, c = 0;
                                    ...
                                    for (var t = !1, e = 0; e < c.length; e++) if (c[e].classList.contains("selected")) {
                                        t = !0;
                                        break
                                    }
                                    return t
                                    ...
                                    if (!(!isEmptyLadiPage(d) || s.length > 0 || l.length > 0)) {
                                        ...
                                        var u = o.getAttribute("data-tabindex"), m = "";
                                        if (m += '<div class="ladi-form-item-container">', m += '   <div class="ladi-form-item-background"></div>', a) {
                                            m += '   <div class="ladi-form-item ladi-form-checkbox ladi-form-checkbox-vertical">', m += '       <div class="ladi-form-checkbox-box-item">';
                                    ...
                                    e.tapEventListener(t, function (e) {
                                        if (e.stopPropagation(), a) t.classList.contains("selected") ? t.classList.remove("selected") : t.classList.add("selected"); else for (var i = t.parentElement.getElementsByClassName("ladi-survey-option"), n = 0; n < i.length; n++) i[n] === t ? i[n].classList.add("selected") : i[n].classList.remove("selected");
                                        isEmptyLadiPage(y) ? (A(), isEmptyLadiPage(u) && L()) : h()
                                    })
                                }, b = function (t) {
                                    var e = t.getElementsByTagName("input")[0], i = t.getElementsByTagName("span")[0];
                                    isEmptyLadiPage(e) || e.addEventListener("change", function (t) {
                                        isEmptyLadiPage(i) || i.setAttribute("data-checked", t.target.checked)
                                    }), isEmptyLadiPage(i) || i.addEventListener("click", function (t) {
                                ...
                                for (isEmptyLadiPage(d) || d.addEventListener("change", function (t) {
                                    t.target.setAttribute("data-selected", t.target.value)
                                }), w = 0; w < s.length; w++) p.push(s[w].getElementsByTagName("input")[0].value), b(s[w]);
                                ...
                                if (isEmptyLadiPage(y)) {
                                    if (!isArrayLadiPage(f)) {
                                        ...
                                        if (f = [], isObjectLadiPage(T) && !isEmptyLadiPage(T.value)) {
                                            if (T.type != e.const.DATA_ACTION_TYPE.section && T.type != e.const.DATA_ACTION_TYPE.popup || f.push({action_type: e.const.ACTION_TYPE.complete, type: T.type, action: T.value}), T.type == e.const.DATA_ACTION_TYPE.section && T.is_hide_parent || T.type == e.const.DATA_ACTION_TYPE.popup) {
                                                var S = e.findAncestor(o, "ladi-popup"), O = e.findAncestor(o, "ladi-section"), C = null;
                                                isEmptyLadiPage(S) ? isEmptyLadiPage(O) || (C = O.id) : C = (S = e.findAncestor(S, "ladi-element")).id, isEmptyLadiPage(C) || f.push({action_type: e.const.ACTION_TYPE.complete, type: e.const.DATA_ACTION_TYPE.hidden_show, hidden_ids: [C], show_ids: []})
                                            }
                                            T.type == e.const.DATA_ACTION_TYPE.change_index && f.push({action_type: e.const.ACTION_TYPE.complete, type: T.type, action: T.value, change_index_type: T.change_index_type, change_index_number: T.change_index_number})
                                        }
                                    }
                                    isEmptyLadiPage(u) || u.addEventListener("click", function (t) {
                                        t.stopPropagation(), L()
                                    }), A(), e.runtime.list_loaded_func.push(v)
                                } else h()
                            }
                        }
                ...
                }), $(Date.now() + 1e3), z(), K(), function () {
                    for (var t = document.querySelectorAll(".ladi-form .ladi-element .ladi-form-otp"), i = function (t, a) {
                        var n = e.findAncestor(a, "ladi-form");
                        if (!isEmptyLadiPage(n) && (n = e.findAncestor(n, "ladi-element"), !isEmptyLadiPage(n))) {
                            var o = "_otp_time_" + n.id, r = window.ladi(o).get_cookie(), d = e.runtime.tmp["cookie_cache_otp_" + n.id];
                            isEmptyLadiPage(r) && isObjectLadiPage(d) && !isEmptyLadiPage(d[o]) && (r = d[o]);
                            var s = (r = parseFloatLadiPage(r) || 0) + e.runtime.time_otp - Date.now();
                            s = s < e.runtime.time_otp ? s : 0, r <= 0 || s <= 0 ? function (t) {
                                t.classList.add("otp-resend"), t.classList.remove("otp-countdown"), t.removeAttribute("data-countdown-time")
                            }(t) : (s = Math.ceil(s / 1e3), t.classList.remove("otp-resend"), t.classList.add("otp-countdown"), t.setAttribute("data-countdown-time", s), e.runTimeout(function () {
                                i(t, a)
                            }, 1e3))
                        }
                    }, a = function (t) {
                        ...
                        if (!isEmptyLadiPage(a) && (a = e.findAncestor(a, "ladi-element"), !isEmptyLadiPage(a))) {
                            var n = "_otp_time_" + a.id, o = !1, r = e.runtime.tmp["cookie_cache_otp_" + a.id], d = function () {
                            ...
                            if ("true" != a.getAttribute("data-start-countdown-otp")) {
                                ...
                                l = l < e.runtime.time_otp ? l : 0, (s <= 0 || l <= 0) && "true" != t.target.getAttribute("data-click") && isFunctionLadiPage(e.runtime.func_get_code_otp[a.id]) && (e.removeTimeout(e.runtime.tmp.timeout_is_wait_popup_id), e.runtime.tmp.is_wait_popup = !0, e.showLoadingBlur(), t.target.setAttribute("data-click", !0), e.runtime.func_get_code_otp[a.id](!0, function (i) {
                                    t.target.removeAttribute("data-click"), e.hideLoadingBlur(), i && d(), e.runtime.tmp.timeout_is_wait_popup_id = e.runTimeout(function () {
                        ...
                        var o = t[n], r = e.findAncestor(o, "ladi-form-item");
                        if (!isEmptyLadiPage(r)) {
                            r.classList.add("overflow-hidden");
                            var d = r.getElementsByClassName("button-get-code")[0];
                            isEmptyLadiPage(d) && ((d = document.createElement("div")).className = "button-get-code", d.innerHTML = e.const.LANG.GET_CODE_BUTTON_TEXT, d.addEventListener("click", a), r.appendChild(d)), d.classList.add("hide-visibility"), o.style.setProperty("padding-right", d.clientWidth + 5 + "px"), d.classList.remove("hide-visibility"), i(r, d)
                        }
                    }
                }(), (i = function () {
                    _.forEach(function (t) {
                        var i = e.runtime.eventData[t];
                        if ("countdown" == i.type) for (var a = document.querySelectorAll("#" + t), n = 0; n < a.length; n++) {
                            var o = a[n], r = o.getAttribute("data-type"), d = 0, s = 0, l = Date.now();
                            if (o.hasAttribute("data-date-start") || o.hasAttribute("data-date-end")) d = parseFloatLadiPage(o.getAttribute("data-date-start")) || 0, s = parseFloatLadiPage(o.getAttribute("data-date-end")) || 0; else {
                                ...
                                if (r == e.const.COUNTDOWN_TYPE.endtime && (s = parseInt(o.getAttribute("data-endtime")) || 0), r == e.const.COUNTDOWN_TYPE.daily) {
                                    var u = o.getAttribute("data-daily-start"), p = o.getAttribute("data-daily-end");
                            ...
                            if (g < 0) {
                                ...
                                "true" != o.getAttribute("data-end") && (o.setAttribute("data-end", !0), k(o, i["option.data_event"]), e.runEventTracking(o.id, {is_form: !1}))
                            }
                ...
                })(), e.runtime.interval_countdown = e.runInterval(i, 1e3), _.forEach(function (t) {
                    var e = document.getElementById(t);
                    isEmptyLadiPage(e) || W(t, e)
                }), e.runtime.interval_gallery = e.runInterval(U, 1e3), _.forEach(function (t) {
                    var i = e.runtime.eventData[t];
                    if ("carousel" == i.type) {
                        var a = document.getElementById(t);
                        if (!isEmptyLadiPage(a)) {
                            ...
                            var n = i[e.runtime.device + ".option.carousel_setting.autoplay"], o = i[e.runtime.device + ".option.carousel_setting.autoplay_time"], r = 0;
                            n && !isEmptyLadiPage(o) && (r = o);
                            var d = function (i) {
                            ...
                            a.getElementsByClassName("ladi-carousel-arrow-left")[0].addEventListener("click", function (e) {
                                e.stopPropagation(), a.getElementsByClassName("ladi-carousel-content")[0].style.removeProperty("transition-duration"), a.setAttribute("data-is-next", !1), a.setAttribute("data-next-time", Date.now() + 1e3 * r), X(t, !1)
                                ...
                                e.stopPropagation(), a.getElementsByClassName("ladi-carousel-content")[0].style.removeProperty("transition-duration"), a.setAttribute("data-is-next", !0), a.setAttribute("data-next-time", Date.now() + 1e3 * r), X(t, !1)
                        ...
                        if ("carousel" == i.type) {
                            ...
                            if (!isEmptyLadiPage(a) && "true" == a.getAttribute("data-scrolled") && "true" != a.getAttribute("data-stop")) {
                                ...
                                if (n && !isEmptyLadiPage(o) && (r = o), r > 0) {
                                    var d = a.getAttribute("data-next-time"), s = Date.now();
                                    isEmptyLadiPage(d) && (d = s + 1e3 * (r - 1), a.setAttribute("data-next-time", d)), s >= d && (X(t, !0), a.setAttribute("data-next-time", s + 1e3 * r))
                                }
                            }
                        }
                    })
                }, 1e3), function () {
                    var t = ["phone", "email", "coupon"], i = document.querySelectorAll(".ladi-form .ladi-button");
                    ...
                    for (var a = function (t, i) {
                        ...
                        if (isEmptyLadiPage(e.runtime.tmp.current_use_coupon)) {
                            var i = e.findAncestor(t.target, "ladi-form"), a = i.querySelector('input[name="coupon"]');
                                ...
                                if (!isEmptyLadiPage(c)) {
                                    ...
                                    if (!isEmptyLadiPage(u)) {
                                        ...
                                        if (isEmptyLadiPage(p) || isEmptyLadiPage(p["option.data_submit_form_id"])) {
                                            ...
                                            s.setAttribute("data-submit-form-id", p["option.data_submit_form_id"]), s.addEventListener("click", r), l.onsubmit = function () {
                                                return !1
                                            };
                    ...
                    }, f = 0; f < e.runtime.tmp.list_form_checkout.length; f++) for (var v = document.querySelectorAll("#" + e.runtime.tmp.list_form_checkout[f] + " .ladi-form-item input.ladi-form-control"), P = 0; P < v.length; P++) -1 != t.indexOf(v[P].getAttribute("name")) && (v[P].addEventListener("change", y), v[P].addEventListener("input", y))
                    ...
                    var t = 2500, i = 3800, a = 800, n = 50, o = 150, r = 500, d = 1300, s = 600, l = 1500, c = t, u = function (u) {
                        ...
                        if (e.const.ANIMATED_LIST.forEach(function (t) {
                            ...
                            if (!isEmptyLadiPage(m)) {
                                ...
                                if (0 != g.length) {
                                    var _ = !1, y = e.randomId(), f = function (i, a, n, o) {
                                        if (!_) {
                                        ...
                                        if (!_) {
                                            var r = a.parentElement, d = r.parentElement;
                                            ...
                                            isEmptyLadiPage(s) ? ((d.classList.contains("rotate-2") || d.classList.contains("rotate-3") || d.classList.contains("scale")) && r.style.setProperty("width", a.clientWidth + "px"), isEmptyLadiPage(e.findAncestor(a, "type")) || e.runTimeout(function () {
                                        ...
                                        _ || (isEmptyLadiPage(e.findAncestor(t, "type")) ? isEmptyLadiPage(e.findAncestor(t, "clip")) || (e.findAncestor(t, "ladipage-animated-words-wrapper").style.setProperty("width", t.clientWidth + 5 + "px"), e.runTimeout(function () {
                                            E(t)
                                        }, s + l)) : (v(t.querySelectorAll("i")[0], t, !1, i), t.classList.add("is-visible"), t.classList.remove("is-hidden")))
                                    }, E = function (l) {
                                        if (!_ && !isEmptyLadiPage(l)) {
                                            var c = P(l);
                                            if (isEmptyLadiPage(e.findAncestor(l, "type"))) if (isEmptyLadiPage(e.findAncestor(l, "letters"))) isEmptyLadiPage(e.findAncestor(l, "clip")) ? isEmptyLadiPage(e.findAncestor(l, "loading-bar")) ? (h(l, c), e.runTimeout(function () {
                                                E(c)
                                            }, t)) : (e.findAncestor(l, "ladipage-animated-words-wrapper").classList.remove("is-loading"), h(l, c), e.runTimeout(function () {
                                                E(c)
                                            }, i), e.runTimeout(function () {
                                                e.findAncestor(l, "ladipage-animated-words-wrapper").classList.add("is-loading")
                                            }, a)) : (e.findAncestor(l, "ladipage-animated-words-wrapper").style.setProperty("width", "2px"), e.runTimeout(function () {
                                                h(l, c), L(c)
                                            }, s)); else {
                                    ...
                                    u.parentElement.insertBefore(b, u.nextSibling), b.outerHTML = u.outerHTML, (b = u.nextSibling).classList.add("ladipage-animated-headline-duplicate"), e.runtime.list_scrolling_exec[y] = function () {
                                    ...
                                    if (u.classList.contains("type") && m.classList.add("waiting"), (u.classList.contains("type") || u.classList.contains("rotate-2") || u.classList.contains("rotate-3") || u.classList.contains("scale")) && u.classList.add("letters"), function (t) {
                                        if (!_) for (var i = 0; i < t.length; i++) {
                                            var a = t[i], n = a.textContent.trim().split(""), o = a.classList.contains("is-visible");
                                            for (var r in n) {
                                                " " == n[r] && (n[r] = "&nbsp;");
                                    ...
                                    }, a); else if (u.classList.contains("clip")) {
                    ...
                    for (var t = document.querySelectorAll(".ladi-button-group > .ladi-element"), i = function (t) {
                        ...
                        if (!isEmptyLadiPage(a)) for (var n = (a = e.findAncestor(a, "ladi-element")).querySelectorAll(".ladi-button-group > .ladi-element"), o = 0; o < n.length; o++) n[o].id != i.id && n[o].classList.remove("selected")
                    ...
                    if (0 != t.length) {
                        var i = e.runtime.shopping_ladisales_page_checkout_api_key, a = e.runtime.shopping_ladisales_checkout_config_id;
                        if (!isEmptyLadiPage(i)) {
                            for (var n = function (t) {
                                t.addEventListener("click", function (e) {
                                    if (e.stopPropagation(), isObjectLadiPage(window.LadiSales)) {
                                        ...
                                        "true" == t.getAttribute("data-buy-now-ladisales") && isFunctionLadiPage(window.LadiSales.buyNow) && window.LadiSales.buyNow(i), "true" == t.getAttribute("data-add-to-cart-ladisales") && isFunctionLadiPage(window.LadiSales.cartAdd) && window.LadiSales.cartAdd(i)
                                    }
                                })
                                ...
                                if (!isEmptyLadiPage(l)) {
                                    ...
                                    if (!isEmptyLadiPage(c)) {
                                        ...
                                        if (isObjectLadiPage(u) && isObjectLadiPage(u.store_info) && isObjectLadiPage(u.product)) {
                                            var p = e.getProductVariantIndex(s.id, l), m = document.querySelectorAll('[data-variant="true"]');
                                            if (-1 != p) for (var g = 0; g < m.length; g++) if (m[g].id != r.id && isEmptyLadiPage(e.findAncestor(m[g], "ladi-collection"))) {
                                                ...
                                                if (!isEmptyLadiPage(_)) {
                                                    ...
                                                    if (!isEmptyLadiPage(y)) {
                                                        ...
                                                        var P = null, h = null, L = null, E = 0;
                                                        if (_["option.product_variant_type"] == e.const.PRODUCT_VARIANT_TYPE.combobox) {
                                                            if (!isArrayLadiPage(u.product.variants)) continue;
                                                            if (h = u.product.variants[p], isStringLadiPage(h.option_ids)) for (L = h.option_ids.split("/"), E = 0; E < L.length; E++) P = document.querySelector("#" + m[g].id + ' .ladi-form-item select[data-product-option-id="' + L[E] + '"]'), isEmptyLadiPage(P) || P.getAttribute("data-store-id") != u.store_info.id || P.getAttribute("data-product-id") != h.product_id || (P.value = h["option" + (E + 1)])
                                                        }
                                                        if (_["option.product_variant_type"] == e.const.PRODUCT_VARIANT_TYPE.label) {
                                                            if (!isArrayLadiPage(u.product.variants)) continue;
                                                            if (h = u.product.variants[p], isStringLadiPage(h.option_ids)) for (L = h.option_ids.split("/"), E = 0; E < L.length; E++) P = document.querySelector("#" + m[g].id + ' .ladi-form-label-container[data-product-option-id="' + L[E] + '"]'), isEmptyLadiPage(P) || P.getAttribute("data-store-id") != u.store_info.id || P.getAttribute("data-product-id") != h.product_id || e.runtime.tmp.updateLabelValue(P, h["option" + (E + 1)])
                                                        }
                                                        if (_["option.product_variant_type"] == e.const.PRODUCT_VARIANT_TYPE.combined) {
                                                            if (P = m[g].querySelector("select.ladi-form-control"), isEmptyLadiPage(P) || P.getAttribute("data-store-id") != u.store_info.id || P.getAttribute("data-product-id") != u.product.product_id) continue;
                    ...
                    if ("cart" == a) {
                        ...
                        if (!isEmptyLadiPage(n)) {
                            ...
                            isEmptyLadiPage(o) || e.showParentVisibility(o, function () {
                                var i = parseFloatLadiPage(getComputedStyle(o).height) || 0, a = parseFloatLadiPage(o.getAttribute("data-height")) || 0;
        ...
        }, e.runtime.tmp.runButtonSectionClose = R, e.runtime.tmp.runOptionAction = x, e.runtime.tmp.runOptionHover = D, e.runtime.tmp.runElementClickSelected = J, e.runtime.tmp.runTrackingAnalytics = C, e.runtime.tmp.runLadiSaleProductKey = nt, e.runtime.tmp.eventClickGalleryControlItem = G, e.runtime.tmp.runGallery = H, e.runtime.tmp.setGalleryStart = W, e.runtime.tmp.updateImageGalleryProduct = at, e.runtime.tmp.runOptionCountdown = F, e.runtime.tmp.runOptionCountdownItem = q, e.runtime.tmp.getOptionLabelValue = Z, e.runtime.tmp.updateLabelValue = Q, e.runtime.tmp.getLabelValue = tt, e.runtime.tmp.clickLabelProductChangeCallback = et, e.runtime.tmp.fireEventLabelChange = function (t) {
            var i = t.querySelector(".ladi-form-label-item.selected");
            isEmptyLadiPage(i) || e.fireEvent(i, "click", {is_fire_event: !0})
        }, e.runtime.tmp.showPopupX = lt, e.runtime.tmp.runActionPopupX = ot, e.runtime.is_popupx ? (e.runtime.tmp.popupx_iframe_id = e.randomId(), ot({ladipage_id: e.runtime.ladipage_id, action: {type: "set_iframe_loaded"}}), window.addEventListener("message", function (t) {
            try {
                ...
                i.iframe_id == e.runtime.tmp.popupx_iframe_id && i.action.value.forEach(function (t) {
                    !function (t, i) {
                        ...
                        if ("callback_request_with_option" == t && isFunctionLadiPage(e.runtime.tmp["request_callback_id_" + i.callback_id]) && e.runtime.tmp["request_callback_id_" + i.callback_id](i.responseText, i.status, i.httpRequest, i.url), "set_style_device" == t) {
                            if (ut(i.is_desktop), n = document.getElementById(e.runtime.tmp.popupx_current_element_id), isEmptyLadiPage(n)) return;
                            "none" != getComputedStyle(n).display && (e.runtime.tmp.popupx_is_inline ? ct(e.runtime.tmp.popupx_current_element_id, !1) : lt(e.runtime.tmp.popupx_current_element_id, !1))
                        }
                        if ("set_iframe_info" == t) {
                            isEmptyLadiPage(f) && (f = i.ladi_client_id || e.randomId(), window.ladi("LADI_CLIENT_ID").set_cookie(f, 3650)), e.runtime.tmp.popupx_is_desktop = i.is_desktop, e.runtime.isDesktop = i.is_desktop, e.runtime.device = e.runtime.isDesktop ? e.const.DESKTOP : e.const.MOBILE, e.runtime.tmp.popupx_origin_store_id = i.origin_store_id, e.runtime.tmp.popupx_origin_referer = i.origin_referer, e.runtime.tmp.popupx_origin_domain = i.origin_domain, e.runtime.tmp.popupx_origin_url = i.origin_url, e.runtime.tmp.popupx_is_inline = i.is_inline, ut(i.is_desktop);
                            var o = "#" + e.runtime.builder_section_popup_id + " .ladi-container {width: 100% !important;}";
                            e.runtime.tmp.popupx_is_inline && (o += ".ladi-section > .ladi-section-close {display: none !important;}"), e.createStyleElement("style_popup_container", o), e.runtime.has_popupx = !0, pt()
                        }
                        "hide_popupx" == t && (a = e.runtime.eventData[i], n = document.getElementById(i), isEmptyLadiPage(a) || isEmptyLadiPage(n) || window.ladi(i).hide()), "show_popupx" == t && lt(i, !0), "show_popupx_inline_iframe" == t && ct(i, !0), "show_message_callback" == t && (isFunctionLadiPage(e.runtime.tmp.popupx_show_message_callback) && e.runtime.tmp.popupx_show_message_callback(), delete e.runtime.tmp.popupx_show_message_callback)
                    }(i.action.type, t)
                })
            } catch (t) {
            }
        })) : pt(), e.runtime.isRun = !0
    } else e.loadHtmlGlobal(t)
}, LadiPageScriptV2.prototype.getListProductByTagId = function (t, e, i, a, n) {
    var o = this, r = t["option.form_account_id"], d = t["option.product_type"], s = t["option.ladisale_store_id"] || null, l = t["option.product_tag_id"], c = t["option.data_setting.value"], u = t["option.data_setting.type_dataset"], p = t["option.collection_setting.type"], m = t["option.data_setting.sort_name"], g = t["option.data_setting.sort_by"], _ = null, y = null, f = null, v = null, P = null;
    if (isArrayLadiPage(l) && l.length > 0) {
        if (isEmptyLadiPage(o.runtime.tmp.product_tag_info[d]) && (o.runtime.tmp.product_tag_info[d] = {}), isEmptyLadiPage(o.runtime.tmp.timeout_product_tag_info[d]) && (o.runtime.tmp.timeout_product_tag_info[d] = {}), l.sort(), f = JSON.stringify(l) + "_page_" + i + "_limit_" + e, v = o.runtime.tmp.product_tag_info[d][f], -1 != [o.const.FORM_CONFIG_TYPE.ladisales, o.const.FORM_CONFIG_TYPE.sapo, o.const.FORM_CONFIG_TYPE.haravan, o.const.FORM_CONFIG_TYPE.shopify, o.const.FORM_CONFIG_TYPE.wordpress].indexOf(d)) {
            y = function () {
                var t = null;
                return isObjectLadiPage(v) && isArrayLadiPage(v.products) && (t = {products: v.products, total_record: v.total_record}, isEmptyLadiPage(o.runtime.tmp.product_info[d]) && (o.runtime.tmp.product_info[d] = {}), t.products.forEach(function (t) {
            ...
            if (isStringLadiPage(v) && (h = v, v = null), isNullLadiPage(v)) {
                ...
                return o.runLimitRequest(20, function () {
                    if (o.runtime.isClient) {
                        ...
                        d == o.const.FORM_CONFIG_TYPE.ladisales ? ((A = {"Content-Type": "application/json"})["Store-Id"] = s, b = JSON.stringify(b)) : d == o.const.FORM_CONFIG_TYPE.wordpress ? (w = "GET", a = window.location.origin + "/ladipage/api?action=product_list&category_ids=" + l.join("|") + "&page=" + i + "&limit=" + e, b = null) : (A = {"Content-Type": "application/json"}, a = o.const.API_COLLECTION_PRODUCT, b = {form_account_id: r, tags: l, limit: e}, isEmptyLadiPage(h) ? b.page = i : b.page_info = h, b = JSON.stringify(b)), o.sendRequest(w, a, b, !0, A, function (t, e, i) {
        ...
        if (isArrayLadiPage(P)) {
            var a = o.copy(P);
            t = {products: a = a.splice((i - 1) * e, e), total_record: P.length}, isEmptyLadiPage(o.runtime.tmp.product_info[d]) && (o.runtime.tmp.product_info[d] = {}), P.forEach(function (t) {
    ...
    var t = [];
    return isArrayLadiPage(this.runtime.tmp.cart) && this.runtime.tmp.cart.forEach(function (e) {
    ...
    var t = this, e = function () {
        var e = [];
        return t.runtime.tmp.cart.forEach(function (t) {
            if (!(t.quantity <= 0)) {
                var i = t.name;
    ...
    if (isEmptyLadiPage(e.runtime.shopping_product_type) || window.ladi("_shopping_product_type").get_cookie() != e.runtime.shopping_product_type && (window.ladi("_cart_token").delete_cookie(), window.ladi("_checkout_token").delete_cookie(), window.ladi("_shopping_product_type").set_cookie(e.runtime.shopping_product_type, 30)), -1 == [e.const.FORM_CONFIG_TYPE.sapo, e.const.FORM_CONFIG_TYPE.haravan, e.const.FORM_CONFIG_TYPE.wordpress].indexOf(e.runtime.shopping_product_type)) if (-1 == [e.const.FORM_CONFIG_TYPE.shopify].indexOf(e.runtime.shopping_product_type)) {
        var a = window.ladi("_cart_token").get_cookie(), n = {"Content-Type": "application/json"};
        if (!isEmptyLadiPage(a)) return n["cart-token"] = a, void this.sendRequest("POST", this.const.API_LADISALE_SHOW, JSON.stringify({type: "LP"}), !0, n, function (t, a, n) {
            if (n.readyState == XMLHttpRequest.DONE) {
                if (200 == a) try {
                    var o = JSON.parse(t);
                    200 == o.code && (e.runtime.tmp.ladisales_checkout_url = o.data.url, o.data.items.forEach(function (t) {
                        ...
                        }), n = t.quantity, r = t.option_name, d = t.price;
    ...
    var a = this.runtime.tmp.add_to_cart_fee_shipping || 0, n = this.runtime.tmp.add_to_cart_discount || 0, o = e + a - n;
    if (o = o < 0 ? 0 : o, t) return {cart_price: e, cart_checkout_price: o, cart_fee_shipping: a, cart_discount: n, total_quantity: i};
    var r = this.formatNumber(e, 3), d = this.formatNumber(o, 3), s = this.formatNumber(a, 3), l = this.formatNumber(n, 3);
    ...
    this.setDataReplaceStr("cart_price", r), this.setDataReplaceStr("cart_checkout_price", d), this.setDataReplaceStr("cart_fee_shipping", s), this.setDataReplaceStr("cart_discount", l), this.setDataReplaceStr("cart_quantity", i), this.setDataReplaceElement(!1)
}, LadiPageScriptV2.prototype.removeAddToCartProduct = function (t, e, i, a) {
    var n = this, o = {product_variant_id: t};
    try {
    ...
    -1 != d && (n.showLoadingBlur(), n.updateCartCookie({cart_item_key: n.runtime.tmp.cart[d].cart_item_key, product_variant_id: this.runtime.tmp.cart[d].product_variant_id, quantity: 0}, i, function () {
        ...
        var t = document.getElementsByClassName("ladi-form-remove-coupon")[0];
        isEmptyLadiPage(t) || t.click(), n.updateCartPromotion(), 0 == n.runtime.tmp.cart.length && -1 != [n.const.FORM_CONFIG_TYPE.ladisales].indexOf(n.runtime.shopping_product_type) && (window.ladi("_cart_token").delete_cookie(), window.ladi("_checkout_token").delete_cookie()), n.runResizeAll(), isFunctionLadiPage(a) && a(!0)
    }, function (t) {
    ...
    var a = this, n = {product_variant_id: e};
    try {
    ...
    if (-1 != r) {
        var d = !1, s = -1, l = 1, c = null, u = null, p = this.runtime.tmp.cart[r];
        isEmptyLadiPage(p) || (l = p.min_buy || l, c = p.max_buy);
        var m = this.runtime.tmp.cart[r].quantity;
        if (isEmptyLadiPage(t.value)) i && (t.value = l), this.runtime.tmp.cart[r].quantity = l; else {
            var g = parseInt(t.value) || 0;
            1 == this.runtime.tmp.cart[r].inventory_checked && g > (s = this.runtime.tmp.cart[r].available_quantity) && (g = s, d = !0, u = s), g = g < l ? l : g, !isEmptyLadiPage(c) && g > c && (g = c, d = !0, (isEmptyLadiPage(u) || u > c) && (u = c)), this.runtime.tmp.cart[r].quantity = g, t.value = g
        }
        ...
        y.product_type = this.runtime.tmp.cart[r].product_type, y.package_quantity = this.runtime.tmp.cart[r].package_quantity, this.updateCartCookie(y, !1, function () {
            var t = document.getElementsByClassName("ladi-form-remove-coupon")[0];
            ...
            if (a.changeTotalPriceCart(), -1 != (r = a.runtime.tmp.cart.findIndex(o))) {
                var e = a.runtime.tmp.cart[r].price * a.runtime.tmp.cart[r].quantity, i = a.formatNumber(e, 3);
                ...
                for (var n = document.querySelectorAll(".ladi-cart-price span[data-product-variant-id]"), d = 0; d < n.length; d++) if (n[d].getAttribute("data-store-id") == a.runtime.tmp.cart[r].store_id && n[d].getAttribute("data-product-id") == a.runtime.tmp.cart[r].product_id) {
                    ...
                    if (!isEmptyLadiPage(s)) {
                        var l = a.findAncestor(t, "ladi-element"), c = a.findAncestor(s, "ladi-element");
    ...
    var o = this, r = t.target, d = o.generateVariantProduct(e, !1, null, null, null, null, !0, !0, function (r) {
        o.updateProductVariantSelectOption(t, e, i, a, n)
    });
    if (isObjectLadiPage(d)) {
        var s = o.getProductVariantId(r, d.product), l = o.findAncestor(r, "ladi-collection-item"), c = [], u = 0;
        if (isEmptyLadiPage(l)) for (var p = document.querySelectorAll('[data-variant="true"]'), m = 0; m < p.length; m++) {
        ...
        var v = r.getAttribute("data-product-option-id"), P = null, h = null, L = null;
        if (isArrayLadiPage(d.product.variants) && 0 != d.product.variants.length) {
            if (isStringLadiPage(d.product.variants[0].option_ids)) {
                for (L = d.product.variants[0].option_ids.split("/"), u = 0; u < L.length; u++) if (L[u] == v) {
                    h = u;
                    break
                }
            ...
            for (var b = P, A = [], w = [], T = null, S = 0; S < y.length; S++) {
                ...
                if (!isEmptyLadiPage(O)) {
                    P = o.copy(b);
                    var C = 0, N = 0, k = 0, I = 0, x = null, D = null, R = null, F = null;
                    if (O["option.product_variant_type"] == o.const.PRODUCT_VARIANT_TYPE.combobox) {
                        if (T = y[S].querySelectorAll("select[data-product-option-id]"), isObjectLadiPage(P)) {
                            for (C = 0; C < T.length; C++) if ((x = T[C].getAttribute("data-product-option-id")) != v) for (isArrayLadiPage(P[x]) && -1 != P[x].indexOf(T[C].value) || (T[C].value = ""), D = T[C].getElementsByTagName("option"), N = 0; N < D.length; N++) isEmptyLadiPage(D[N].getAttribute("value")) || D[N].removeAttribute("disabled");
                            for (C = 0; C < T.length; C++) {
                                for (x = T[C].getAttribute("data-product-option-id"), P = {}, k = 0; k < d.product.variants.length; k++) if (F = d.product.variants[k], L = F.option_ids.split("/"), -1 != (h = L.indexOf(x)) && (isEmptyLadiPage(T[C].value) || T[C].value == F["option" + (h + 1)])) for (u = 0; u < L.length; u++) isArrayLadiPage(P[L[u]]) || (P[L[u]] = []), u != h && P[L[u]].push(F["option" + (u + 1)]);
                                for (I = 0; I < T.length; I++) if ((R = T[I].getAttribute("data-product-option-id")) != x) for (D = T[I].getElementsByTagName("option"), N = 0; N < D.length; N++) isEmptyLadiPage(D[N].getAttribute("value")) || isArrayLadiPage(P[R]) && -1 != P[R].indexOf(D[N].getAttribute("value")) || D[N].setAttribute("disabled", "")
                            }
                        }
                    ...
                    if (O["option.product_variant_type"] == o.const.PRODUCT_VARIANT_TYPE.label) {
                        if (T = y[S].querySelectorAll(".ladi-form-label-container[data-product-option-id]"), isObjectLadiPage(P)) {
                            for (C = 0; C < T.length; C++) if ((x = T[C].getAttribute("data-product-option-id")) != v) {
                                var q = o.runtime.tmp.getLabelValue(T[C]);
                                for (isArrayLadiPage(P[x]) && -1 != P[x].indexOf(q) || o.runtime.tmp.updateLabelValue(T[C], null), D = T[C].getElementsByClassName("ladi-form-label-item"), N = 0; N < D.length; N++) D[N].classList.contains("no-value") || D[N].classList.remove("disabled")
                            }
                            for (C = 0; C < T.length; C++) {
                                for (x = T[C].getAttribute("data-product-option-id"), P = {}, k = 0; k < d.product.variants.length; k++) if (F = d.product.variants[k], L = F.option_ids.split("/"), -1 != (h = L.indexOf(x))) {
                                ...
                                for (I = 0; I < T.length; I++) if ((R = T[I].getAttribute("data-product-option-id")) != x) for (D = T[I].getElementsByClassName("ladi-form-label-item"), N = 0; N < D.length; N++) if (!D[N].classList.contains("no-value")) {
            ...
            for (T = document.querySelectorAll(".ladi-form .ladi-form-label-container"), S = 0; S < T.length; S++) {
                ...
                var j = o.findAncestor(T[S], "ladi-form-item-box");
                isEmptyLadiPage(j) || (j = j.querySelector(".ladi-form-item-title-value"), isEmptyLadiPage(j) || (j.innerHTML = V))
            }
        }
    }
}, LadiPageScriptV2.prototype.updateProductVariantSelectOptionFirst = function (t, e, i) {
    var a = this, n = a.generateVariantProduct(t, !1, null, null, null, null, !0, !0, function () {
        a.updateProductVariantSelectOptionFirst(t, e, i)
    });
    if (isObjectLadiPage(n) && isObjectLadiPage(n.product)) {
        var o = i.querySelectorAll("select.ladi-form-control"), r = i.querySelectorAll(".ladi-form-label-container"), d = 0;
        if (isArrayLadiPage(n.product.variants) && 0 != n.product.variants.length) {
            var s = null, l = null;
            if (isEmptyLadiPage(t["option.product_variant_id"]) || (s = n.product.variants.find(function (e) {
                return e.product_variant_id == t["option.product_variant_id"]
            })), isEmptyLadiPage(s) && (s = n.product.variants[0]), e["option.product_variant_type"] == a.const.PRODUCT_VARIANT_TYPE.combined) for (d = 0; d < o.length; d++) l = o[d].querySelector('option[data-product-variant-id="' + s.product_variant_id + '"]'), isEmptyLadiPage(l) || (o[d].value = l.getAttribute("value"), a.fireEvent(o[d], "change"));
            e["option.product_variant_type"] == a.const.PRODUCT_VARIANT_TYPE.combobox && isStringLadiPage(s.option_ids) && s.option_ids.split("/").forEach(function (t, e) {
                for (d = 0; d < o.length; d++) o[d].getAttribute("data-product-option-id") == t && (o[d].value = s["option" + (e + 1)] || "", a.fireEvent(o[d], "change"))
            }), e["option.product_variant_type"] == a.const.PRODUCT_VARIANT_TYPE.label && isStringLadiPage(s.option_ids) && s.option_ids.split("/").forEach(function (t, e) {
    ...
    var a = this, n = [];
    if (i) n = a.runtime.tmp.cart; else {
        var o = window.$rootScope.getStoreCurrency();
        n = [{name: "Product Name", title: "Product Variant", price: 9999, image: window.$rootScope.logoUrlColor, quantity: 1, inventory_checked: 0, available_quantity: 999, currency: {code: o, symbol: a.formatCurrency(null, o, !1, !0)}}]
    }
    var r = "";
    if (r += "<tbody>", 0 == n.length) r += '<tr><td class="ladi-cart-no-product">' + e + "</td></tr>"; else {
        n.forEach(function (e, n) {
            if (!(e.quantity <= 0)) {
                ...
                r += '<tr class="ladi-cart-row' + (isObjectLadiPage(e.promotion) ? " has-promotion" : "") + '"><td class="ladi-cart-image"><img src="' + d + '" />', t == a.const.CART_LAYOUT.viewonly && (r += '<span class="ladi-cart-image-quantity">' + e.quantity + "</span>"), r += "</td>", r += '<td class="ladi-cart-title"><span class="ladi-cart-title-name">' + e.name + '</span><span class="ladi-cart-title-variant">' + (e.title || "") + "</span>", isObjectLadiPage(e.promotion) && (r += '<span class="promotion-name">' + e.promotion.discount.note + "</span>"), r += "</td>", t == a.const.CART_LAYOUT.editable && (r += '<td class="ladi-cart-quantity"><div class="ladi-cart-quantity-content"><div onclick="javascript: LadiPageScript.buttonAddToCartProductQuantity(this, -1);" class="button"><span>-</span></div><input type="number" min="1" value="' + e.quantity + '" oninput="javascript: LadiPageScript.changeAddToCartProductQuantity(this, \'' + o + '\', true);" /><div onclick="javascript: LadiPageScript.buttonAddToCartProductQuantity(this, 1);" class="button"><span>+</span></div></div></td>'), r += '<td class="ladi-cart-price"><span' + (isNullLadiPage(e.store_id) ? "" : ' data-store-id="' + e.store_id + '"') + ' data-product-id="' + e.product_id + '" data-product-variant-id="' + e.product_variant_id + '" data-cart-item-key="' + e.cart_item_key + '">';
                var s = e.price * e.quantity, l = a.formatNumber(s, 3);
                isObjectLadiPage(e.currency) && !isEmptyLadiPage(e.currency.symbol) && (l = a.formatCurrency(s, e.currency.symbol, !0)), r += l + "</span>", isObjectLadiPage(e.promotion) && (s = e.promotion.total, l = a.formatNumber(s, 3), isObjectLadiPage(e.currency) && !isEmptyLadiPage(e.currency.symbol) && (l = a.formatCurrency(s, e.currency.symbol, !0)), r += '<span class="price-compare">' + l + "</span>"), r += "</td>", t == a.const.CART_LAYOUT.editable && (r += '<td class="ladi-cart-action"><div onclick="javascript: LadiPageScript.removeAddToCartProduct(\'' + o + '\', true);" class="button"><span>X</span></div></td>', r += "</tr>")
            }
        })
    }
    return r += "</tbody>"
}, LadiPageScriptV2.prototype.getProductVariantId = function (t, e) {
    var i = null, a = this.findAncestor(t, "ladi-element");
    if (!isEmptyLadiPage(a)) {
        ...
        if (!isEmptyLadiPage(n) && (n["option.product_variant_type"] == this.const.PRODUCT_VARIANT_TYPE.combobox || n["option.product_variant_type"] == this.const.PRODUCT_VARIANT_TYPE.label)) {
            ...
            isArrayLadiPage(e.variants) && e.variants.forEach(function (t) {
                if (isEmptyLadiPage(i)) {
                    var e = !0;
                    if (isStringLadiPage(t.option_ids)) for (var a = t.option_ids.split("/"), n = 0; n < a.length; n++) if (s[a[n].trim()] != (t["option" + (n + 1)] || "").trim()) {
                        e = !1;
                        break
                    }
    ...
    var i = this, a = -1, n = e["option.product_type"], o = e["option.ladisale_store_id"] || null, r = e["option.product_id"], d = i.generateVariantProduct(e, !1, null, null, null, null, !0, !0);
                        ...
                        if (!isEmptyLadiPage(u)) {
                            ...
                            if (u["option.product_variant_type"] == i.const.PRODUCT_VARIANT_TYPE.combobox && (p = c.querySelectorAll(".ladi-form-item select[data-product-option-id]"), a = d.product.variants.findIndex(function (t) {
                                for (var e = !0, i = null, a = function (t) {
                                    return t == i
                                }, n = 0; n < p.length; n++) if (p[n].getAttribute("data-store-id") == d.store_info.id && p[n].getAttribute("data-product-id") == t.product_id) {
                                ...
                                for (var e = !0, a = null, n = function (t) {
                                    return t == a
                                }, o = 0; o < p.length; o++) if (p[o].getAttribute("data-store-id") == d.store_info.id && p[o].getAttribute("data-product-id") == t.product_id) {
    ...
    var l = a["option.product_type"], c = a["option.product_mapping_name"], u = s.generateVariantProduct(a, !1, null, null, null, null, !0, !0, function (i) {
    ...
    if (isObjectLadiPage(u) && isObjectLadiPage(u.product)) {
        ...
        var y = function () {
            if (-1 != [s.const.FORM_CONFIG_TYPE.ladisales, s.const.FORM_CONFIG_TYPE.sapo, s.const.FORM_CONFIG_TYPE.haravan, s.const.FORM_CONFIG_TYPE.shopify, s.const.FORM_CONFIG_TYPE.wordpress].indexOf(l)) {
                ...
                if (-1 != ["image"].indexOf(c) && (g = u.product[c], isObjectLadiPage(g) && (e = g.src, isEmptyLadiPage(e) || !isStringLadiPage(e) || e.startsWith("http://") || e.startsWith("https://") || e.startsWith("//") || (e = "https://" + s.const.STATIC_W_DOMAIN + "/" + e), t = !0)), -1 != ["images"].indexOf(c) && (g = u.product[c], isArrayLadiPage(g) && (e = [], g.forEach(function (t) {
                    isEmptyLadiPage(t.src) || (!isStringLadiPage(t.src) || t.src.startsWith("http://") || t.src.startsWith("https://") || t.src.startsWith("//") ? e.push({src: t.src}) : e.push({src: "https://" + s.const.STATIC_W_DOMAIN + "/" + t.src}))
                    ...
                    var f = null;
                    if (-1 != r && (f = u.product.variants[r], p = f), !t) if (-1 != r) if (-1 != ["variant_start_date", "variant_end_date"].indexOf(c)) {
                        g = f[c];
                        try {
                            (_ = new Date(g)).toISOString() == g && (g = _.getFullYear() + "-" + m(_.getMonth() + 1) + "-" + m(_.getDate()) + " " + m(_.getHours()) + ":" + m(_.getMinutes()) + ":" + m(_.getSeconds()))
                        } catch (t) {
                    ...
                    } else ["description"].indexOf(c), g = f[c], isEmptyLadiPage(g) || (e = g); else e = g = ""
                }
            } else {
                if (g = u.product[c], isBooleanLadiPage(g)) g = g ? s.const.LANG.OPTION_TRUE : s.const.LANG.OPTION_FALSE; else try {
                    (_ = new Date(g)).toISOString() == g && (g = _.getFullYear() + "-" + m(_.getMonth() + 1) + "-" + m(_.getDate()) + " " + m(_.getHours()) + ":" + m(_.getMinutes()) + ":" + m(_.getSeconds()))
                } catch (t) {
                }
                e = g
    ...
    var l = e ? "" : null, c = this, u = function (t) {
        ...
        if (isObjectLadiPage(t)) {
            ...
            i == c.const.PRODUCT_VARIANT_TYPE.combined && (d += '<div class="ladi-form-item-container"><div class="ladi-form-item-background"></div><div class="ladi-form-item"><select' + (isObjectLadiPage(t.store_info) && !isNullLadiPage(t.store_info.id) ? ' data-store-id="' + t.store_info.id + '"' : "") + ' data-product-id="' + t.product.product_id + '" required tabindex="' + o + '" class="ladi-form-control ladi-form-control-select" data-selected=""' + (r ? "" : ' onmousedown="javascript: event.preventDefault();"') + ">", c.runtime.isClient && (d += '<option value="" data-product-variant-id="">' + c.const.LANG.OPTION_NO_SELECT + "</option>"), isArrayLadiPage(t.product.variants) && t.product.variants.forEach(function (e, i) {
                ...
                if (e.is_tmp) d += '<div class="ladi-form-item-box"></div>'; else if (isArrayLadiPage(e.values) && 0 != e.values.length) {
    ...
    var p = t["option.form_account_id"], m = t["option.product_type"], g = t["option.ladisale_store_id"] || null, _ = t["option.product_id"], y = t["option.data_setting.value"], f = t["option.data_setting.type_dataset"], v = t["option.data_setting.sort_name"], P = t["option.data_setting.sort_by"], h = null, L = null;
    if (-1 != [c.const.FORM_CONFIG_TYPE.ladisales, c.const.FORM_CONFIG_TYPE.sapo, c.const.FORM_CONFIG_TYPE.haravan, c.const.FORM_CONFIG_TYPE.shopify, c.const.FORM_CONFIG_TYPE.wordpress].indexOf(m)) {
        if (!isEmptyLadiPage(_)) {
            if (isEmptyLadiPage(c.runtime.tmp.product_info[m]) && (c.runtime.tmp.product_info[m] = {}), isEmptyLadiPage(c.runtime.tmp.timeout_product_info[m]) && (c.runtime.tmp.timeout_product_info[m] = {}), _ = parseInt(_) || _, h = c.runtime.tmp.product_info[m][_], L = function () {
                return u(h)
            }, isNullLadiPage(h)) {
                ...
                var E = function () {
                    ...
                    if (h = isObjectLadiPage(c.runtime.tmp.product_info[m][_]) ? c.runtime.tmp.product_info[m][_] : t.data, isObjectLadiPage(h)) {
                        ...
                        if (m != c.const.FORM_CONFIG_TYPE.ladisales && (h.store_info.id = -1), isObjectLadiPage(h.store_info.currency) && !isEmptyLadiPage(h.store_info.currency.code) && (h.store_info.currency.symbol = c.formatCurrency(null, h.store_info.currency.code, !1, !0)), isObjectLadiPage(h.product) && isArrayLadiPage(h.product.options) && isArrayLadiPage(h.product.variants)) {
                            var i = h.product.options.map(function (t) {
                                return t.product_option_id
                            });
                            i = i.join("/");
                            for (var a = 0; a < h.product.variants.length; a++) -1 != [c.const.FORM_CONFIG_TYPE.ladisales].indexOf(m) && 1 == h.product.variants[a].allow_sold_out && (h.product.variants[a].inventory_checked = 0), isNullLadiPage(h.product.variants[a].compare_price) && (h.product.variants[a].compare_price = h.product.variants[a].price_compare), isNullLadiPage(h.product.variants[a].variant_start_date) && (h.product.variants[a].variant_start_date = h.product.variants[a].start_date), isNullLadiPage(h.product.variants[a].variant_end_date) && (h.product.variants[a].variant_end_date = h.product.variants[a].end_date), isNullLadiPage(h.product.variants[a].variant_timezone) && (h.product.variants[a].variant_timezone = h.product.variants[a].timezone), isEmptyLadiPage(h.product.variants[a].option_ids) && (h.product.variants[a].option_ids = i), -1 != [c.const.FORM_CONFIG_TYPE.sapo, c.const.FORM_CONFIG_TYPE.haravan, c.const.FORM_CONFIG_TYPE.shopify].indexOf(m) && 1 == h.product.variants.length && "Default Title" == h.product.variants[a].title && (h.product.variants[a].title = null, h.product.variants[a].option1 = null, h.product.options = []), -1 != [c.const.FORM_CONFIG_TYPE.wordpress].indexOf(m) && 1 == h.product.variants.length && h.product.variants[a].title == h.product.variants[a].product_name && (h.product.variants[a].title = null, h.product.variants[a].option1 = null, h.product.options = []), isEmptyLadiPage(h.product.variants[a].package_quantity) || isEmptyLadiPage(h.product.variants[a].package_quantity_unit) || (isNullLadiPage(h.product.variants[a].title_old) && (h.product.variants[a].title_old = h.product.variants[a].title), h.product.variants[a].title = h.product.variants[a].title_old + " (" + h.product.variants[a].package_quantity + " " + h.product.variants[a].package_quantity_unit + ")");
                            if (isArrayLadiPage(h.product.options) && 1 == h.product.options.length && isArrayLadiPage(h.product.options[0].values)) for (var n = null, o = function (t) {
                                return t.option1 == n
                            }, r = 0; r < h.product.options[0].values.length; r++) {
                                n = h.product.options[0].values[r].name;
                                var d = h.product.variants.find(o);
                                h.product.options[0].values[r].name_new = h.product.options[0].values[r].label || h.product.options[0].values[r].name, isEmptyLadiPage(d) || isEmptyLadiPage(d.package_quantity) || isEmptyLadiPage(d.package_quantity_unit) || (h.product.options[0].values[r].name_new = h.product.options[0].values[r].name_new + " (" + d.package_quantity + " " + d.package_quantity_unit + ")")
                            }
                        }
                        c.runtime.tmp.product_info[m][_] = h, l = L(), isFunctionLadiPage(s) && s(l)
                    } else E()
                }, A = {product_id: _}, w = null, T = "POST";
                return c.runLimitRequest(20, function () {
                    if (c.runtime.isClient) {
                        var t = c.const.API_LADISALE_SHOW_PRODUCT;
                        m == c.const.FORM_CONFIG_TYPE.ladisales ? ((w = {"Content-Type": "application/json"})["Store-Id"] = g, A = JSON.stringify(A)) : m == c.const.FORM_CONFIG_TYPE.wordpress ? (T = "GET", t = window.location.origin + "/ladipage/api?action=product_info&product_id=" + _, A = null) : (w = {"Content-Type": "application/json"}, t = c.const.API_SHOW_PRODUCT, A = {form_account_id: p, product_id: _}, A = JSON.stringify(A)), c.sendRequest(T, t, A, !0, w, function (t, e, i) {
                            if (i.readyState == XMLHttpRequest.DONE) try {
                                var a = JSON.parse(t);
                                b(a)
                            } catch (t) {
            ...
            !0 === h ? c.runtime.tmp.timeout_product_info[m][_] = c.runTimeout(function () {
                c.generateVariantProduct(t, e, i, a, n, o, r, !1, s)
            }, 100) : (l = L(), !d && isFunctionLadiPage(s) && s(l))
        }
    } else if (!isEmptyLadiPage(_)) {
        if (isEmptyLadiPage(c.runtime.tmp.product_info[m]) && (c.runtime.tmp.product_info[m] = {}), isEmptyLadiPage(c.runtime.tmp.timeout_product_info[m]) && (c.runtime.tmp.timeout_product_info[m] = {}), _ = String(_), h = c.runtime.tmp.product_info[m][_], L = function () {
            return e ? "" : isObjectLadiPage(h) ? h : null
        }, isNullLadiPage(h)) return c.runtime.tmp.product_info[m][_] = !0, c.loadDataset(y, y, f, v, P, !0, c.runtime.isClient, function (t) {
    ...
    e instanceof LadiPageScriptV2 || (e = LadiPageScript);
    var i = function (t, i) {
        window.ladi("_ladipage_" + t).set_cookie(i, 365, "/", window.location.host), isArrayLadiPage(e.runtime.DOMAIN_SET_COOKIE) && e.runtime.DOMAIN_SET_COOKIE.forEach(function (e) {
    ...
    var a = function (t, i) {
        ...
        for (var a = null, n = e.runtime.tmp.add_to_cart_shipping_method_id, o = function (t) {
            s.setAttribute("data-selected", t.target.value || ""), e.runtime.tmp.add_to_cart_shipping_method_id = isEmptyLadiPage(s.getAttribute("data-selected")) ? null : s.getAttribute("data-selected"), (parseFloatLadiPage(e.runtime.tmp.add_to_cart_shipping_method_id) || 0) == e.runtime.tmp.add_to_cart_shipping_method_id && (e.runtime.tmp.add_to_cart_shipping_method_id = parseFloatLadiPage(e.runtime.tmp.add_to_cart_shipping_method_id) || 0), a = t.target.querySelector('option[value="' + t.target.value + '"]'), e.runtime.tmp.add_to_cart_fee_shipping = isEmptyLadiPage(a) ? 0 : parseFloatLadiPage(a.getAttribute("data-fee")) || 0, e.changeTotalPriceCart()
        }, r = document.querySelectorAll('select[data-combobox-type="' + e.const.COMBOBOX_TYPE.delivery_method + '"]'), d = 0; d < r.length; d++) {
            var s = r[d], l = s.getElementsByTagName("option");
            for ("true" != s.getAttribute("data-event") && (s.setAttribute("data-event", !0), s.addEventListener("change", o)), isNullLadiPage(s.getAttribute("data-placeholder")) && s.setAttribute("data-placeholder", l[0].innerHTML); l.length > 0;) l[0].parentElement.removeChild(l[0]);
    ...
    e.runtime.tmp.timeout_reload_fee_shipping = e.runTimeout(function () {
        if (0 != e.runtime.tmp.list_form_checkout.length) {
            var n = null;
            if (n = isEmptyLadiPage(t) ? document.getElementById(e.runtime.tmp.list_form_checkout[0]) : e.findAncestor(t.target, "ladi-form"), isEmptyLadiPage(n)) a(0); else {
                var o = n.querySelector('.ladi-form-item select[name="state"]'), r = n.querySelector('.ladi-form-item [name="district"]'), d = n.querySelector('.ladi-form-item [name="ward"]');
                if (isEmptyLadiPage(o) || isEmptyLadiPage(r) || isEmptyLadiPage(d)) a(0); else {
                    var s = o.value, l = r.value, c = d.value;
                    if (isEmptyLadiPage(s) || isEmptyLadiPage(l)) return void a(0);
                    var u = {state_id: s.split(":")[0], district_id: l, ward_id: c};
                    u.state_id = parseInt(u.state_id) || u.state_id, "SELECT" == r.tagName && (u.district_id = u.district_id.split(":")[0], u.district_id = parseInt(u.district_id) || u.district_id), "SELECT" == d.tagName && (u.ward_id = u.ward_id.split(":")[0], u.ward_id = parseInt(u.ward_id) || u.ward_id);
                    var p = null, m = null, g = null;
                    if (e.runtime.shopping_product_type == e.const.FORM_CONFIG_TYPE.sapo) return m = function (t, n) {
                        t = t.querySelector("#checkoutForm"), (p = new FormData).append("_method", "patch"), p.append("billingProvince", u.state_id), p.append("billingDistrict", u.district_id), p.append("billingWard", u.ward_id), e.sendRequest("POST", window.location.origin + t.getAttribute("action"), p, !0, g, function (t, n, o) {
                            if (o.readyState == XMLHttpRequest.DONE) {
                                if (200 == n) try {
                                    for (var r = 0, d = [], c = e.createTmpElement("div", t, null, !1).querySelectorAll('[for^="shippingMethod-"]'), u = 0; u < c.length; u++) {
                                        var p = "", m = 0, g = "", _ = c[u].querySelector("span.radio__label__primary");
                                        isEmptyLadiPage(_) || (p = _.textContent.trim()), _ = c[u].querySelector("span.content-box__emphasis"), isEmptyLadiPage(_) || (m = parseFloatLadiPage(_.textContent.trim().replaceAll(".", "").replaceAll(",", ".")) || 0);
                                        var y = e.findAncestor(c[u], "content-box__row");
                                        isEmptyLadiPage(y) || (y = y.querySelector('input[name="shippingMethod"]'), isEmptyLadiPage(y) || (g = y.value)), isEmptyLadiPage(p) || isEmptyLadiPage(g) || d.push({name: p, fee: m, shipping_method_id: g})
                                    }
                                    return -1 == d.findIndex(function (t) {
                                        return t.shipping_method_id == e.runtime.tmp.add_to_cart_shipping_method_id
                                    }) && (e.runtime.tmp.add_to_cart_shipping_method_id = null), d.forEach(function (t) {
                                        isEmptyLadiPage(e.runtime.tmp.add_to_cart_shipping_method_id) && (e.runtime.tmp.add_to_cart_shipping_method_id = t.shipping_method_id), e.runtime.tmp.add_to_cart_shipping_method_id == t.shipping_method_id && (r = t.fee || 0)
                                    }), i("state", s), i("district", l), void a(r, d)
                                } catch (t) {
                                }
                                a(0)
                            }
                    ...
                    if (e.runtime.shopping_product_type == e.const.FORM_CONFIG_TYPE.haravan) return m = function (t) {
                        ...
                        n.search = n.search + (isEmptyLadiPage(n.search) ? "?" : "&") + "customer_shipping_province=" + u.state_id + "&customer_shipping_district=" + u.district_id + "&form_name=form_update_location", t = n.href, e.sendRequest("GET", t, null, !0, g, function (t, n, o) {
                            if (o.readyState == XMLHttpRequest.DONE) {
                                if (200 == n) try {
                                    for (var r = 0, d = [], c = e.createTmpElement("div", t, null, !1).querySelectorAll('[for^="shipping_rate_id_"]'), u = 0; u < c.length; u++) {
                                        var p = "", m = 0, g = "", _ = c[u].querySelector("span.radio-label-primary");
                                        isEmptyLadiPage(_) || (p = _.textContent.trim()), _ = c[u].querySelector("span.content-box-emphasis"), isEmptyLadiPage(_) || (m = parseFloatLadiPage(_.textContent.trim().replaceAll(",", "")) || 0);
                    ...
                    var _ = window.ladi("_cart_token").get_cookie(), y = window.ladi("_checkout_token").get_cookie();
                    if (isEmptyLadiPage(_) || isEmptyLadiPage(y)) return void a(0);
                    g = {"Content-Type": "application/json", "cart-token": _}, e.sendRequest("POST", e.const.API_LADISALE_GET_SHIPPING.format(y), JSON.stringify(u), !0, g, function (t, i, n) {
                        if (n.readyState == XMLHttpRequest.DONE) {
                            if (200 == i) try {
                                var o = JSON.parse(t);
                                if (200 == o.code) {
                                    var r = 0;
                                    if (isArrayLadiPage(o.data.shipping_methods)) -1 == o.data.shipping_methods.findIndex(function (t) {
                                        return t.shipping_method_id == e.runtime.tmp.add_to_cart_shipping_method_id
    ...
    var i = this, a = window.location.origin + "/checkout", n = function (n, o, r) {
    ...
    t.getCheckoutSapo(null, function (e, i) {
        var a = 0, n = (e = e.querySelector("#checkoutForm")).querySelector("#discountCode .discount-code span.ui-tag__label");
        if (!isEmptyLadiPage(n)) {
    ...
    t.getCheckoutHaravan(null, function (e, i) {
        var a = 0, n = e.querySelector(".applied-reduction-code-information");
        if (!isEmptyLadiPage(n)) {
    ...
    this.getCheckoutWordpress(null, function (e, i) {
        var a = 0, n = e.querySelector("#order_review .cart-discount");
        if (!isEmptyLadiPage(n)) {
    ...
    var e = this;
    e instanceof LadiPageScriptV2 || (e = LadiPageScript);
    var i = e.runtime.tmp.current_use_coupon, a = function (n, o) {
        e.runtime.tmp.add_to_cart_discount = n, e.runtime.tmp.is_click_check_price_discount = !1, e.changeTotalPriceCart();
        var r = null, d = document.getElementsByClassName("ladi-form-remove-coupon")[0];
        ...
        if (isEmptyLadiPage(s) || s.classList.remove("pointer-events-none"), !isEmptyLadiPage(e.runtime.tmp.current_use_coupon)) {
            ...
            (d = document.createElement("span")).className = "ladi-form-remove-coupon", d.innerHTML = "⌫", d.addEventListener("click", function (t) {
                t.stopPropagation();
                var i = e.runtime.tmp.current_use_coupon;
                if (s.value = "", e.fireEvent(s, "change"), e.runtime.tmp.current_use_coupon = null, a(0), -1 != [e.const.FORM_CONFIG_TYPE.sapo, e.const.FORM_CONFIG_TYPE.haravan, e.const.FORM_CONFIG_TYPE.shopify, e.const.FORM_CONFIG_TYPE.wordpress].indexOf(e.runtime.shopping_product_type)) {
            ...
            }), e.findAncestor(s, "ladi-form-item").appendChild(d), s.classList.add("pointer-events-none")
        }
    ...
    isEmptyLadiPage(t) || isEmptyLadiPage(t.discount_price) ? e.runtime.tmp.is_click_check_price_discount || isEmptyLadiPage(t) && isEmptyLadiPage(e.runtime.tmp.current_use_coupon) || (isEmptyLadiPage(e.runtime.tmp.timeout_reload_price_discount) || e.removeTimeout(e.runtime.tmp.timeout_reload_price_discount), e.runtime.tmp.timeout_reload_price_discount = e.runTimeout(function () {
        if (0 != e.runtime.tmp.list_form_checkout.length) {
            var i = null;
            if (isEmptyLadiPage(t) ? i = document.getElementById(e.runtime.tmp.list_form_checkout[0]) : (i = e.findAncestor(t.target, "ladi-form"), isEmptyLadiPage(i) || (i = i.querySelector("[data-submit-form-id]"), isEmptyLadiPage(i) || (i = document.getElementById(i.getAttribute("data-submit-form-id"))))), isEmptyLadiPage(i)) a(0); else {
                var n = null, o = i.querySelector('.ladi-form-item input[name="email"]'), r = i.querySelector('.ladi-form-item input[name="phone"]'), d = i.querySelector('.ladi-form-item input[name="coupon"]');
                if (isEmptyLadiPage(d)) a(0); else {
                    ...
                    var c = null, u = null, p = null;
                    if (e.runtime.shopping_product_type == e.const.FORM_CONFIG_TYPE.sapo) return u = function (i, o) {
                        i = i.querySelector("#checkoutForm"), (p = new FormData).append("_method", "patch"), p.append("reductionCode", n.discount_code), p.append("email", n.email), e.sendRequest("POST", window.location.origin + i.getAttribute("action"), p, !0, c, function (i, n, o) {
                            if (o.readyState == XMLHttpRequest.DONE) {
                                if (200 == n) try {
                                    var r = 0, d = e.createTmpElement("div", i, null, !1), s = d.querySelector("#discountCode .discount-code span.ui-tag__label");
                                    if (isEmptyLadiPage(s)) {
                    ...
                    if (e.runtime.shopping_product_type == e.const.FORM_CONFIG_TYPE.haravan) return u = function (i) {
                        c = {"X-Requested-With": "XMLHttpRequest"};
                        var o = e.createTmpElement("a", "", {href: i});
                        isEmptyLadiPage(n.discount_code) ? o.search = o.search + (isEmptyLadiPage(o.search) ? "?" : "&") + "form_name=form_discount_remove" : o.search = o.search + (isEmptyLadiPage(o.search) ? "?" : "&") + "discount.code=" + n.discount_code + "&form_name=form_discount_add", i = o.href, e.sendRequest("GET", i, null, !0, c, function (i, n, o) {
                            if (o.readyState == XMLHttpRequest.DONE) {
                                if (200 == n) try {
                                    var r = 0, d = e.createTmpElement("div", i, null, !1), s = d.querySelector(".applied-reduction-code-information");
                    ...
                    if (e.runtime.shopping_product_type == e.const.FORM_CONFIG_TYPE.wordpress) {
                        ...
                        return isEmptyLadiPage(n.discount_code) ? m += "?action=remove_coupon&coupon=" + (isEmptyLadiPage(t) ? "" : t.couponOld) : m += "?action=apply_coupon&coupon=" + n.discount_code, void e.sendRequest("GET", m, null, !0, c, function (i, n, o) {
                            if (o.readyState == XMLHttpRequest.DONE) {
                                if (200 == n) try {
                                    var r = JSON.parse(i);
                    ...
                    var g = window.ladi("_cart_token").get_cookie(), _ = window.ladi("_checkout_token").get_cookie();
                    if (isEmptyLadiPage(g) || isEmptyLadiPage(_)) return void a(0);
                    c = {"Content-Type": "application/json", "cart-token": g}, e.sendRequest("POST", e.const.API_LADISALE_VALIDATE_DISCOUNT.format(_), JSON.stringify(n), !0, c, function (i, n, o) {
                        if (o.readyState == XMLHttpRequest.DONE) {
                            if (200 == n) try {
                                var r = JSON.parse(i);
                                if (200 == r.code) return isEmptyLadiPage(r.data.discount_error) ? e.runtime.tmp.current_use_coupon = l : isEmptyLadiPage(t) || e.showMessage(r.data.discount_error), void a(r.data.discount_price)
                            } catch (t) {
                            }
                            a(0)
                        }
    ...
    }, isEmptyLadiPage(t) ? 1e3 : 0)) : a(t.discount_price, t.docCrawl)
    ...
    var a = this, n = function (t) {
        for (var e = 0; e < a.runtime.tmp.cart.length; e++) {
            ...
            if (i.product_id == t.product_id && i.product_variant_id == t.product_variant_id) {
                ...
                for (var n = document.querySelectorAll('.ladi-cart .ladi-cart-row .ladi-cart-price span[data-product-variant-id="' + i.product_variant_id + '"]'), o = 0; o < n.length; o++) {
                    var r = a.findAncestor(n[o], "ladi-cart-row"), d = r.querySelector(".ladi-cart-price"), s = r.querySelector(".ladi-cart-title"), l = d.querySelector("span.price-compare"), c = s.querySelector("span.promotion-name");
                    if (isObjectLadiPage(i.promotion)) {
                        ...
                        isObjectLadiPage(i.currency) && !isEmptyLadiPage(i.currency.symbol) && (u = a.formatCurrency(t.total, i.currency.symbol, !0)), l.innerHTML = u, isEmptyLadiPage(c) && ((c = document.createElement("span")).className = "promotion-name", s.appendChild(c)), c.innerHTML = i.promotion.discount.note
        ...
        var t = [];
        return isArrayLadiPage(a.runtime.tmp.cart) && a.runtime.tmp.cart.forEach(function (e) {
            var i = e.quantity;
            t.push({product_id: e.product_id, product_variant_id: e.product_variant_id, quantity: i})
        }), {variants: t}
    }, r = o(), d = JSON.stringify(r);
    if (isObjectLadiPage(a.runtime.tmp.info_update_cart_promotion) || (a.runtime.tmp.info_update_cart_promotion = {}), !isEmptyLadiPage(t)) {
        var s = [], l = a.runtime.tmp.cart;
        a.runtime.tmp.cart = [];
        return -1 != [a.const.FORM_CONFIG_TYPE.sapo, a.const.FORM_CONFIG_TYPE.haravan, a.const.FORM_CONFIG_TYPE.shopify].indexOf(a.runtime.shopping_product_type) && t.items.forEach(function (e) {
            var i = null;
            -1 != [a.const.FORM_CONFIG_TYPE.sapo].indexOf(a.runtime.shopping_product_type) && e.name == e.title && "Default Title" == e.variant_title && (e.variant_title = null), -1 != [a.const.FORM_CONFIG_TYPE.haravan, a.const.FORM_CONFIG_TYPE.shopify].indexOf(a.runtime.shopping_product_type) && e.product_title == e.title && "Default Title" == e.variant_title && (e.variant_title = null), -1 != [a.const.FORM_CONFIG_TYPE.sapo, a.const.FORM_CONFIG_TYPE.haravan].indexOf(a.runtime.shopping_product_type) && (i = {
                store_id: -1,
                ...
                min_buy: 1,
                max_buy: null
            }), -1 != [a.const.FORM_CONFIG_TYPE.shopify].indexOf(a.runtime.shopping_product_type) && (i = {store_id: -1, product_id: e.product_id, product_variant_id: e.variant_id, name: e.product_title, title: e.variant_title, image: e.image, quantity: e.quantity, inventory_checked: 0, available_quantity: 0, min_buy: 1, max_buy: null});
            var n = a.runtime.currency;
            a.runtime.isClient || (n = window.$rootScope.getStoreCurrency()), -1 == [a.const.FORM_CONFIG_TYPE.shopify].indexOf(a.runtime.shopping_product_type) || isEmptyLadiPage(t.currency) || (n = t.currency), i.currency = {code: n, symbol: a.formatCurrency(null, n, !1, !0)};
            ...
            if (-1 != [a.const.FORM_CONFIG_TYPE.sapo, a.const.FORM_CONFIG_TYPE.haravan].indexOf(a.runtime.shopping_product_type)) {
                if (i.price = e.price_original, isObjectLadiPage(e.properties)) {
                    ...
                    c.length > 0 && (r = e.properties[c[0]], -1 != [a.const.FORM_CONFIG_TYPE.haravan].indexOf(a.runtime.shopping_product_type) && ((r = r.split("-")).shift(), r = (r = r.join("-")).trim()), d = {product_id: e.product_id, product_variant_id: e.variant_id, sub_total: e.line_price_original, total: e.line_price, discount: {note: r}}, i.promotion = d, s.push(d))
                }
                isEmptyLadiPage(i.promotion) && -1 != [a.const.FORM_CONFIG_TYPE.sapo].indexOf(a.runtime.shopping_product_type) && (i.price = e.price)
            }
            -1 != [a.const.FORM_CONFIG_TYPE.shopify].indexOf(a.runtime.shopping_product_type) && (i.price = e.original_price, e.original_line_price != e.line_price && isArrayLadiPage(e.discounts) && e.discounts.length > 0 && (r = e.discounts[0].title, d = {
                product_id: e.product_id,
                product_variant_id: e.variant_id,
                sub_total: e.original_line_price,
                total: e.line_price,
                discount: {note: r}
            }, i.promotion = d, s.push(d))), -1 != [a.const.FORM_CONFIG_TYPE.haravan, a.const.FORM_CONFIG_TYPE.shopify].indexOf(a.runtime.shopping_product_type) && (i.price = i.price / 100, isEmptyLadiPage(i.promotion) || (i.promotion.total = i.promotion.total / 100, i.promotion.sub_total = i.promotion.sub_total / 100)), a.runtime.tmp.cart.push(i)
            ...
            var i = {store_id: -1, product_id: t.product_id, product_variant_id: t.variation_id, name: t.product_name, title: e, min_buy: 1, max_buy: null, price: t.price, image: t.image || "", quantity: t.quantity, inventory_checked: 0, available_quantity: 0}, n = t.currency;
        ...
        }), r = o(), d = JSON.stringify(r), s.forEach(n), void (a.runtime.tmp.info_update_cart_promotion[d] = s)
    }
    if (!0 !== a.runtime.tmp.info_update_cart_promotion[d]) {
        ...
        if (a.runtime.tmp.info_update_cart_promotion[d] = !0, -1 == [a.const.FORM_CONFIG_TYPE.sapo, a.const.FORM_CONFIG_TYPE.haravan, a.const.FORM_CONFIG_TYPE.shopify].indexOf(a.runtime.shopping_product_type)) if (-1 == [a.const.FORM_CONFIG_TYPE.wordpress].indexOf(a.runtime.shopping_product_type)) {
            var c = window.ladi("_cart_token").get_cookie(), u = {"Content-Type": "application/json"};
            isEmptyLadiPage(c) || (u["cart-token"] = c), a.sendRequest("POST", a.const.API_LADISALE_PROMOTION, JSON.stringify(r), !0, u, function (t, e, o) {
                if (o.readyState == XMLHttpRequest.DONE) {
                    if (200 == e) try {
                        var r = JSON.parse(t);
                        if (200 == r.code && isObjectLadiPage(r.data) && isArrayLadiPage(r.data.variants)) return r.data.variants.forEach(n), a.runtime.tmp.info_update_cart_promotion[d] = r.data.variants, a.changeTotalPriceCart(), void (isFunctionLadiPage(i) && i())
                    } catch (t) {
                    }
            ...
            if (o.readyState == XMLHttpRequest.DONE) {
                if (200 == n) try {
                    ...
                    delete a.runtime.tmp.info_update_cart_promotion[d];
                    a.updateCartPromotion(r);
                    return e && a.runtime.tmp.cart.length > 0 && (-1 != [a.const.FORM_CONFIG_TYPE.sapo].indexOf(a.runtime.shopping_product_type) && a.reloadCheckoutSapo(), -1 != [a.const.FORM_CONFIG_TYPE.haravan].indexOf(a.runtime.shopping_product_type) && a.reloadCheckoutHaravan(), [a.const.FORM_CONFIG_TYPE.shopify].indexOf(a.runtime.shopping_product_type)), a.changeTotalPriceCart(), void (isFunctionLadiPage(i) && i())
                } catch (t) {
                }
                delete a.runtime.tmp.info_update_cart_promotion[d], isFunctionLadiPage(i) && i()
            }
    ...
    var o = this, r = {}, d = null, s = null;
    if (-1 != [o.const.FORM_CONFIG_TYPE.sapo, o.const.FORM_CONFIG_TYPE.haravan, o.const.FORM_CONFIG_TYPE.shopify].indexOf(o.runtime.shopping_product_type)) return -1 != [o.const.FORM_CONFIG_TYPE.sapo].indexOf(o.runtime.shopping_product_type) && (d = {"Content-Type": "application/x-www-form-urlencoded", "X-Requested-With": "XMLHttpRequest"}, s = {variantId: e.product_variant_id, quantity: e.quantity}, s = Object.keys(s).reduce(function (t, e) {
        return t.push(e + "=" + encodeURIComponent(s[e])), t
    }, []).join("&")), -1 != [o.const.FORM_CONFIG_TYPE.haravan].indexOf(o.runtime.shopping_product_type) && (d = {"Content-Type": "application/x-www-form-urlencoded", "X-Requested-With": "XMLHttpRequest"}, s = {id: e.product_variant_id, quantity: e.quantity}, s = Object.keys(s).reduce(function (t, e) {
        return t.push(e + "=" + encodeURIComponent(s[e])), t
    }, []).join("&")), -1 != [o.const.FORM_CONFIG_TYPE.shopify].indexOf(o.runtime.shopping_product_type) && (d = {"Content-Type": "application/x-www-form-urlencoded", "X-Requested-With": "XMLHttpRequest"}, s = {id: e.product_variant_id, quantity: e.quantity, form_type: "product"}, s = Object.keys(s).reduce(function (t, e) {
        return t.push(e + "=" + encodeURIComponent(s[e])), t
    }, []).join("&")), void this.sendRequest("POST", window.location.origin + "/cart/add.js", s, !0, d, function (t, e, d) {
        if (d.readyState == XMLHttpRequest.DONE) {
            if (200 == e) try {
    ...
    if (-1 == [o.const.FORM_CONFIG_TYPE.wordpress].indexOf(o.runtime.shopping_product_type)) {
        ...
        var c = e.quantity;
        s = JSON.stringify({type: "LP", product_variant_id: e.product_variant_id, quantity: c}), this.sendRequest("POST", this.const.API_LADISALE_ADD, s, !0, d, function (t, e, d) {
            if (d.readyState == XMLHttpRequest.DONE) {
                if (200 == e) try {
                    if (200 == (r = JSON.parse(t)).code) return window.ladi("_cart_token").set_cookie(r.data.cart_token, 30), window.ladi("_checkout_token").set_cookie(r.data.checkout_token, 30), o.runtime.tmp.ladisales_checkout_url = r.data.url, isFunctionLadiPage(i) && i(), isFunctionLadiPage(n) && n(), o.reloadPriceDiscount(), void o.reloadFeeShipping()
                } catch (t) {
                }
                isFunctionLadiPage(a) && a(r), isFunctionLadiPage(n) && n()
            }
        })
    } else this.sendRequest("POST", window.location.origin + "/ladipage/api?action=cart_add&product_id=" + e.product_id + "&variant_id=" + e.product_variant_id + "&qty=" + e.quantity, s, !0, d, function (t, e, d) {
        if (d.readyState == XMLHttpRequest.DONE) {
            if (200 == e) try {
    ...
    var o = this, r = {}, d = null, s = null, l = null;
    if (-1 == [o.const.FORM_CONFIG_TYPE.sapo, o.const.FORM_CONFIG_TYPE.haravan, o.const.FORM_CONFIG_TYPE.shopify].indexOf(o.runtime.shopping_product_type)) {
        if (-1 != [o.const.FORM_CONFIG_TYPE.wordpress].indexOf(o.runtime.shopping_product_type)) return l = window.location.origin + "/ladipage/api?action=cart_update_item_qty&cart_item_key=" + t.cart_item_key + "&qty=" + t.quantity, e && (l = 0 == t.quantity ? window.location.origin + "/ladipage/api?action=cart_empty" : window.location.origin + "/ladipage/api?action=cart_update_item_qty&qty=" + t.quantity), void this.sendRequest("POST", l, d, !0, s, function (t, e, d) {
            if (d.readyState == XMLHttpRequest.DONE) {
                if (200 == e) try {
                    if (200 == (r = JSON.parse(t)).code) return o.updateCartPromotion(r), isFunctionLadiPage(i) && i(), isFunctionLadiPage(n) && n(), o.reloadPriceDiscount(), void o.reloadFeeShipping()
                } catch (t) {
        ...
        var u = t.quantity;
        d = JSON.stringify({product_variant_id: t.product_variant_id, quantity: u}), this.sendRequest("POST", this.const.API_LADISALE_UPDATE, d, !0, s, function (t, e, d) {
            if (d.readyState == XMLHttpRequest.DONE) {
                if (200 == e) try {
        ...
        if (-1 != [o.const.FORM_CONFIG_TYPE.sapo].indexOf(o.runtime.shopping_product_type) && (l = window.location.origin + "/cart/change.js", s = {"Content-Type": "application/x-www-form-urlencoded", "X-Requested-With": "XMLHttpRequest"}, d = {variantId: t.product_variant_id, quantity: t.quantity}, d = Object.keys(d).reduce(function (t, e) {
            return t.push(e + "=" + encodeURIComponent(d[e])), t
        }, []).join("&")), -1 != [o.const.FORM_CONFIG_TYPE.haravan].indexOf(o.runtime.shopping_product_type) && (l = window.location.origin + "/cart/update.js", s = {"Content-Type": "application/x-www-form-urlencoded", "X-Requested-With": "XMLHttpRequest"}, d = o.runtime.tmp.cart.reduce(function (i, a) {
            var n = a.quantity;
    ...
    var o = this, r = e["option.product_type"], d = e["option.ladisale_store_id"], s = e["option.product_tag_id"], l = e["option.collection_setting.type"], c = o.runtime.eventData[t];
    if (!isEmptyLadiPage(c) && "collection" == c.type) {
        var u = this.runtime.isDesktop ? this.const.DESKTOP : this.const.MOBILE, p = parseFloatLadiPage(c[u + ".option.collection_setting.row"]) || 0, m = parseFloatLadiPage(c[u + ".option.collection_setting.column"]) || 0, g = parseFloatLadiPage(c[u + ".option.collection_setting.margin"]) || 0, _ = function (t, e, i, a, n, r) {
            if (i = o.copy(i), Object.keys(a).forEach(function (t) {
                ...
                var d = o.generateVariantProduct(i, !0, a["option.product_variant_type"], a["option.product_variant_title"], a["option.product_variant_price"], a["option.input_tabindex"], o.runtime.isClient, !0, function (o) {
                    ...
                    o.updateProductVariantSelectOption(e, i, a, !1, function () {
                        var i = o.getProductVariantId(e.target, n), a = n.variants.findIndex(function (t) {
                            return t.product_variant_id == i
                        }), d = o.findAncestor(e.target, "ladi-element");
                        if (!isEmptyLadiPage(d)) {
                            var s = o.findAncestor(d, "ladi-collection-item");
                            if (!isEmptyLadiPage(s)) for (var l = s.querySelectorAll('[data-variant="true"]'), c = 0; c < l.length; c++) if (l[c].id != d.id) {
                                var u = o.runtime.eventData[l[c].id], p = null, m = null, g = null, _ = 0;
                                if (u["option.product_variant_type"] == o.const.PRODUCT_VARIANT_TYPE.combobox && (m = n.variants[a], isObjectLadiPage(m) && isStringLadiPage(m.option_ids))) for (g = m.option_ids.split("/"), _ = 0; _ < g.length; _++) p = l[c].querySelector('select[data-product-option-id="' + g[_] + '"]'), isEmptyLadiPage(p) || (p.value = m["option" + (_ + 1)]);
                                if (u["option.product_variant_type"] == o.const.PRODUCT_VARIANT_TYPE.label && (m = n.variants[a], isObjectLadiPage(m) && isStringLadiPage(m.option_ids))) for (g = m.option_ids.split("/"), _ = 0; _ < g.length; _++) p = l[c].querySelector('.ladi-form-label-container[data-product-option-id="' + g[_] + '"]'), isEmptyLadiPage(p) || o.runtime.tmp.updateLabelValue(p, m["option" + (_ + 1)]);
                ...
                }, l = o.runtime.tmp.getOptionLabelValue, c = o.runtime.tmp.updateLabelValue, u = o.runtime.tmp.getLabelValue, p = function (t) {
                ...
                o.showParentVisibility(e, function () {
                    ...
                    e.innerHTML = d;
                    for (var y = e.querySelectorAll("select.ladi-form-control"), f = null, v = null, P = 0; P < y.length; P++) y[P].removeEventListener("change", s), y[P].addEventListener("change", s), f = m[y[P].getAttribute("data-store-id") + "_" + y[P].getAttribute("data-product-id") + "_" + y[P].getAttribute("data-product-option-id")], isNullLadiPage(f) && (v = y[P].querySelector("option"), isEmptyLadiPage(v) || (f = v.getAttribute("value"))), y[P].value = f;
                    ...
                    for (P = 0; P < h.length; P++) {
                        ...
                        f = m[h[P].getAttribute("data-store-id") + "_" + h[P].getAttribute("data-product-id") + "_" + h[P].getAttribute("data-product-option-id")], isNullLadiPage(f) && (v = L[1], isEmptyLadiPage(v) || (f = l(v))), c(h[P], f)
                    }
            ...
            if (a["option.input_type"] == o.const.INPUT_TYPE.number) {
                var m = e.querySelector('input[name="quantity"]'), g = function (t) {
                    if (!isEmptyLadiPage(t.target.value)) {
                        ...
                        if (!(isEmptyLadiPage(e) || isEmptyLadiPage(e.store_info) || isEmptyLadiPage(e.product))) {
                            ...
                            var n = o.getProductVariantId(a, e.product), r = e.product.variants.findIndex(function (t) {
                                return t.product_variant_id == n
                            });
                            if (-1 != r) {
                                var d = e.product.variants[r].quantity, s = e.product.variants[r].quantity_stock;
                                d = isNullLadiPage(s) ? d : s;
                                var l = parseInt(t.target.value) || 0, c = 1;
                                c = e.product.variants[r].min_buy || c;
                                var u = e.product.variants[r].max_buy, p = 0, m = o.runtime.tmp.cart.findIndex(function (t) {
                                    return t.product_id == e.product.variants[r].product_id && t.product_variant_id == e.product.variants[r].product_variant_id
                                });
                                -1 != m && (p = o.runtime.tmp.cart[m].quantity), c > l + p && (l = c - p), 1 == e.product.variants[r].inventory_checked && l + p > d && (l = d - p), !isEmptyLadiPage(u) && l + p > u && (l = u - p), l = l < 1 ? 1 : l, t.target.setAttribute("min", c), isEmptyLadiPage(u) || t.target.setAttribute("max", u), t.target.value = l
                            }
                        }
                    }
                };
                m.addEventListener("input", g), o.fireEvent(m, "input");
                var y = e.querySelectorAll(".button")[0], f = e.querySelectorAll(".button")[1];
            ...
            if ("button" == a.type && (a["option.is_buy_now"] || a["option.is_add_to_cart"])) {
                var v = function () {
                    ...
                    t.forEach(function (t) {
                        t.action_type == o.const.ACTION_TYPE.action && (t.type == o.const.DATA_ACTION_TYPE.popup_cart && (window.ladi("POPUP_CART").show(), o.runEventTracking(e.id, {is_form: !1})), t.type == o.const.DATA_ACTION_TYPE.popup_checkout && (o.runtime.shopping_third_party ? o.getThirdPartyCheckoutUrl(!0) : window.ladi("POPUP_CHECKOUT").show(), o.runEventTracking(e.id, {is_form: !1})))
                    })
                };
            ...
            var d = !isEmptyLadiPage(e["option.product_mapping_name"]), s = JSON.stringify(e), l = null, c = null;
            if (d) if (a && isEmptyLadiPage(i)) l = ""; else if (!isEmptyLadiPage(e["option.product_id"]) && s === (l = (c = o.generateProductKey(!0, s, !0, e, !0, i, null, function (o) {
                y(t, e, i, a, n, r)
            })).value)) return;
            var u = e.type, p = null, m = null;
            if (d && "headline" == u && (m = t.getElementsByClassName("ladi-headline")[0], isEmptyLadiPage(m) || (m.innerHTML = isNullLadiPage(l) ? "" : l)), d && "paragraph" == u && (m = t.getElementsByClassName("ladi-paragraph")[0], isEmptyLadiPage(m) || (m.innerHTML = isNullLadiPage(l) ? "" : l)), d && "image" == u) {
            ...
            if ("gallery" == u) {
                ...
                if (isEmptyLadiPage(P) || P.style.removeProperty("left"), d) {
                    ...
                    for (var E = t.getElementsByClassName("ladi-gallery-control-item"), b = function (e) {
                    ...
                    for (var w = t.querySelectorAll(".ladi-gallery .ladi-gallery-view .ladi-gallery-view-arrow"), T = 0; T < w.length; T++) l.length <= 1 ? w[T].style.setProperty("display", "none") : w[T].style.removeProperty("display");
            ...
            var c = p * m, u = o.getListProductByTagId(e, c, i, !0, function () {
                f(t, e)
            });
            if (isObjectLadiPage(u) && isArrayLadiPage(u.products)) {
                ...
                var b = v.getElementsByClassName("ladi-collection-arrow-left")[0], A = v.getElementsByClassName("ladi-collection-arrow-right")[0], w = v.getElementsByClassName("ladi-collection-button-next")[0];
                if (isEmptyLadiPage(b) || b.classList.remove("opacity-0"), isEmptyLadiPage(A) || A.classList.remove("opacity-0"), isEmptyLadiPage(w) || w.classList.remove("opacity-0"), 1 == v.getAttribute("data-page") && l == o.const.COLLECTION_TYPE.carousel && (isEmptyLadiPage(b) || b.classList.add("opacity-0")), v.getAttribute("data-page") == v.getAttribute("data-max-page") && (l == o.const.COLLECTION_TYPE.readmore && (isEmptyLadiPage(w) || w.classList.add("opacity-0")), l == o.const.COLLECTION_TYPE.carousel && (isEmptyLadiPage(A) || A.classList.add("opacity-0"))), P < i) return;
                var T = v.getElementsByClassName("ladi-collection-item");
                if (0 == T.length) return;
                var S = 0, O = 0;
                if (v.hasAttribute("data-max-option-length")) S = parseFloatLadiPage(v.getAttribute("data-max-option-length")); else {
                ...
                var k = v.getElementsByClassName("ladi-collection-content")[0], I = {className: T[0].className, innerHTML: T[0].innerHTML};
                a && T[0].parentElement.removeChild(T[0]);
                for (var x = k.getElementsByClassName("ladi-collection-page"); x.length < i;) {
                    var D = document.createElement("div");
                    D.className = "ladi-collection-page", k.appendChild(D)
                }
                var R = x[i - 1], F = R.getElementsByClassName("ladi-collection-item");
                ...
                var q = function (t, i, a, n, l, c) {
                    ...
                    for (var u = function (t, e) {
                        ...
                        isEmptyLadiPage(m) || (u(t[p], m), m["option.product_type"] = r, m["option.ladisale_store_id"] = d, m["option.product_tag_id"] = s, m["option.product_id"] = i.id, a && (isFunctionLadiPage(o.runtime.tmp.runOptionAction) && o.runtime.tmp.runOptionAction(t[p], t[p].id, m.type, m), isFunctionLadiPage(o.runtime.tmp.runOptionHover) && o.runtime.tmp.runOptionHover(t[p], t[p].id, m.type, m["option.data_event"] || m["option.data_hover"]), _(t, t[p], e, m, i, q)), y(t[p], m, n, l, a, c))
                    }
                };
                ...
                for (v.setAttribute("data-max-option-length", S), O = 0; O < u.products.length; O++) if (!(F.length > O)) {
                    var B = document.createElement("div");
                    B.className = I.className, R.appendChild(B), B.innerHTML = I.innerHTML;
                ...
                h && (R.classList.add("last"), L && R.classList.add("not-full")), l == o.const.COLLECTION_TYPE.carousel && function (t) {
                    var e = document.getElementById(t);
                    if (!isEmptyLadiPage(e) && e.hasAttribute("data-page")) {
                        var i = "0", a = getComputedStyle(e).width, n = a, r = parseFloatLadiPage(e.getAttribute("data-page")) || 1, d = e.getElementsByClassName("ladi-collection-content")[0].getElementsByClassName("ladi-collection-page"), s = d[d.length - 1].getElementsByClassName("ladi-collection-item"), l = m - s.length, c = "", u = "";
                        l > 0 ? (n = "calc(" + a + " * " + d.length + " - (" + a + " / " + m + " * " + l + ") + calc(" + g + "px / " + m + " * " + s.length + "))", r > 1 && (r != d.length ? i = "calc(-" + a + " * " + (r - 1) + ")" : (i = "calc(-" + a + " * " + (r - 1) + " + (" + a + " / " + m + " * " + l + "))", u = "margin-left: calc(-" + g + "px / " + m + " * " + s.length + ");")), c += "#" + t + " .ladi-collection .ladi-collection-content .ladi-collection-page.last.not-full .ladi-collection-item:first-child {", c += "margin-left: " + g + "px;", c += "}", c += "#" + t + " .ladi-collection-content .ladi-collection-page.last {", c += "width: calc(" + getComputedStyle(e).width + " / " + m + " * " + s.length + " + calc(" + g + "px / " + m + " * " + s.length + "));", c += "}") : (r > 1 && (i = "calc(-" + a + " * " + (r - 1) + ")"), n = "calc(" + a + " * " + d.length + ")");
                        var p = "style_collection_" + t, _ = document.getElementById(p);
                        isEmptyLadiPage(_) || _.parentElement.removeChild(_);
                        var y = "#" + t + " .ladi-collection-content {";
                        y += "width: " + n + ";", y += "left: " + i + ";", y += u, y += "}", y += c, o.createStyleElement(p, y)
                    }
                }(t), n && l == o.const.COLLECTION_TYPE.readmore && function (t) {
                    var e = document.getElementById(t);
                    if (!isEmptyLadiPage(e)) {
                        var i = e.getElementsByClassName("ladi-collection-content")[0];
                        if (e.hasAttribute("data-max-page")) {
                            var a = i.querySelector(".ladi-collection-page.last"), n = a.getElementsByClassName("ladi-collection-item"), r = Math.ceil(n.length / m);
                            if (p == r) a.style.removeProperty("height"); else {
                        ...
                        var s = parseFloatLadiPage(getComputedStyle(e).height) || 0, l = i.scrollHeight;
                        if (s != l) {
...
var lightbox_run = function (t, e, i, a, n, o, r, d) {
    ...
    if (!isEmptyLadiPage(s)) {
        ...
        var c = JSON.stringify({html: t, url: e, is_video: i, video_type: o, video_value: r}), u = Object.keys(LadiPageScript.runtime.list_lightbox_id);
        -1 == u.indexOf(c) && (LadiPageScript.runtime.list_lightbox_id[c] = u.length + 1);
        var p = LadiPageScript.runtime.list_lightbox_id[c];
        n = n + "_" + p;
        var m = document.getElementById(n), g = !1;
        ...
        var y = function () {
            if (m = document.getElementById(n), !isEmptyLadiPage(m)) {
                if ("IFRAME" == m.tagName) {
                    var t = parseFloatLadiPage(getComputedStyle(m).width) || 0, e = parseFloatLadiPage(getComputedStyle(m).height) || 0;
                    if (t > 0 || e > 0) {
                        var i = .8 * document.body.clientWidth, a = .8 * LadiPageScript.getHeightDevice(), o = i, r = e / t * o;
                ...
                if (_ = s.getElementsByClassName("lightbox-close")[0], !isEmptyLadiPage(_)) {
                    var d = LadiPageScript.getElementBoundingClientRect(m), l = 10, c = 10;
                    d.x - 5 - _.clientWidth > c && (c = d.x - 5 - _.clientWidth), d.y - 5 - _.clientHeight > l && (l = d.y - 5 - _.clientHeight), c += LadiPageScript.runtime.widthScrollBar, l -= 6, c -= 6, _.style.setProperty("right", c + "px"), _.style.setProperty("top", l + "px")
                }
        ...
        if (i && o == LadiPageScript.const.VIDEO_TYPE.direct && (v = "loadedmetadata"), g && (m.addEventListener(v, f), m.addEventListener("error", f)), i) {
            var P = e;
            o == LadiPageScript.const.VIDEO_TYPE.youtube && (e = null, P = r), g ? LadiPageScript.runEventPlayVideo(n, o, P, !1, !1, !0, !1, d, !1, function (t) {
        ...
        var E = function () {
            l(), s.style.removeProperty("display"), m = document.getElementById(n), isEmptyLadiPage(m) || (a && !i ? m.parentElement.removeChild(m) : (m.classList.add("lightbox-hidden"), i && LadiPageScript.runEventReplayVideo(n, o, !1))), _ = s.getElementsByClassName("lightbox-close")[0], isEmptyLadiPage(_) || _.parentElement.removeChild(_);
        ...
        isEmptyLadiPage(s.getAttribute("data-load-event")) && (s.setAttribute("data-load-event", !0), s.addEventListener("click", function (t) {
    ...
    if (!isEmptyLadiPage(t)) {
        var r = "margin: auto; position: absolute; top: 0; left: 0; bottom: 0; right: 0; max-width: 80%; max-height: 80%;", d = '<iframe id="' + (i = i || "lightbox_iframe") + '" class="lightbox-item" style="' + r + '" frameborder="0" allowfullscreen></iframe>', s = t, l = LadiPageScript.createTmpElement("iframe", s, null, !0);
...
LadiPageLibraryV2.prototype.get_url = function (t, e, i) {
    ...
    if (!isEmptyLadiPage(this.id)) if (LadiPageScript.runtime.has_popupx) LadiPageScript.runtime.tmp.runActionPopupX({url: this.id, target: t, nofollow: e, action: {type: "open_url"}}); else {
        var i = this.id, a = null;
    ...
    if (!isEmptyLadiPage(i)) if (LadiPageScript.runtime.has_popupx) this.show(); else {
        t && "none" == getComputedStyle(i).display && this.show();
        for (var a = document.querySelectorAll("#" + LadiPageScript.runtime.builder_section_popup_id + " .ladi-container > .ladi-element"), n = 0; n < a.length; n++) if (a[n].id != this.id && a[n].hasAttribute("data-popup-backdrop") && "none" != getComputedStyle(a[n]).display) {
        ...
        var r = isObjectLadiPage(LadiPageScript.runtime.story_page), d = function (t, e, i) {
            ...
            var o = "left" == t ? window.innerWidth : window.innerHeight, d = i - n;
            if (0 != d) {
                var s = d < 0 ? -1 * d : d, l = 0, c = 1e3;
                c = s <= 4 * o ? 750 : c, c = s <= 2 * o ? 525 : c, c = s <= o ? 300 : c, c = r ? 300 : c;
                var u = "left" == t ? "scrollLeft" : "scrollTop", p = window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || window.msRequestAnimationFrame || window.oRequestAnimationFrame, m = null, g = null, _ = function (i) {
    ...
    if (!isEmptyLadiPage(a)) {
        var n = [], o = !1, r = 0, d = isArrayLadiPage(t) ? t : [t], s = a.querySelectorAll('.ladi-form-item > [data-is-select-country="true"]');
        if (4 == s.length) if (isNullLadiPage(t)) {
            ...
            var l = document.querySelectorAll("#" + this.id + " > ." + ["ladi-button .ladi-headline", "ladi-headline", "ladi-paragraph", "ladi-list-paragraph"].join(", #" + this.id + " > .")), c = document.querySelectorAll("#" + this.id + " > ." + ["ladi-form-item-container .ladi-form-item > input", "ladi-form-item-container .ladi-form-item > textarea", "ladi-form-item-container .ladi-form-item > select"].join(", #" + this.id + " > .")), u = document.querySelectorAll("#" + this.id + " > ." + ["ladi-form-item-container .ladi-form-checkbox-item > input"].join(", #" + this.id + " > .")),
                p = document.querySelectorAll("#" + this.id + " > .ladi-image .ladi-image-background"), m = document.querySelectorAll("#" + this.id + " > .ladi-shape"), g = document.querySelectorAll("#" + this.id + " > .ladi-video"), _ = document.querySelectorAll("#" + this.id + " > .ladi-survey > .ladi-survey-option"), y = function (t) {
                    var e = [];
                    return isArrayLadiPage(t) && t.forEach(function (t) {
                        e.push(t.name)
                    }), e = e.length > 0 ? "[" + e.join(", ") + "]" : ""
                };
            for (r = 0; r < l.length; r++) if (isNullLadiPage(t)) isObjectLadiPage(i) && i.only_text ? n.push(l[r].innerText) : n.push(l[r].innerHTML); else if (l[r].innerHTML = t, !isEmptyLadiPage(e)) {
                var f = LadiPageScript.findAncestor(l[r], "ladi-element");
                isEmptyLadiPage(f) || f.classList.add(e)
            }
            for (r = 0; r < c.length; r++) if (isNullLadiPage(t)) if (c[r].classList.contains("ladi-form-control-file")) {
                var v = c[r].getAttribute("data-path-file") || "[]";
                v = JSON.parse(v), n.push(v)
            } else n.push(c[r].value); else c[r].classList.contains("ladi-form-control-file") ? (c[r].setAttribute("data-path-file", JSON.stringify(t)), c[r].value = y(t)) : (c[r].value = t, "date" == c[r].getAttribute("data-type") && (isEmptyLadiPage(t) ? c[r].setAttribute("type", "text") : c[r].setAttribute("type", "date")));
            var P = !1;
            for (r = 0; r < u.length; r++) isNullLadiPage(t) ? (u[r].checked && n.push(u[r].value), "checkbox" == u[r].getAttribute("type").toLowerCase() && (o = !0)) : (P = !1, "checkbox" == u[r].getAttribute("type").toLowerCase() && -1 != d.indexOf(u[r].value) && (P = !0), "radio" == u[r].getAttribute("type").toLowerCase() && d.length > 0 && d[0] == u[r].value && (P = !0), P ? u[r].checked || u[r].click() : u[r].checked && u[r].click());
            for (r = 0; r < p.length; r++) if (isNullLadiPage(t)) {
            ...
            } else if (isEmptyLadiPage(t)) p[r].style.setProperty("background-image", "none"); else {
                var L = LadiPageScript.findAncestor(p[r], "ladi-element"), E = LadiPageScript.getOptimizeImage(t, L.clientWidth, L.clientHeight, !0, !1, !1, !0);
                p[r].style.setProperty("background-image", 'url("' + E + '")')
            }
            for (r = 0; r < m.length; r++) if (isNullLadiPage(t)) n.push(m[r].innerHTML); else try {
            ...
            for (r = 0; r < g.length; r++) {
                ...
                if (isNullLadiPage(t)) isEmptyLadiPage(b) || n.push({type: b["option.video_type"], value: b["option.video_value"]}); else {
                    b["option.video_value"] = t;
                    var A = g[r].getElementsByClassName("iframe-video-preload")[0], w = null;
                    if (b["option.video_type"] == LadiPageScript.const.VIDEO_TYPE.youtube) {
                        var T = "https://img.youtube.com/vi/" + (w = LadiPageScript.getVideoId(b["option.video_type"], t)) + "/hqdefault.jpg", S = g[r].getElementsByClassName("ladi-video-background")[0];
                        isEmptyLadiPage(S) || S.style.setProperty("background-image", 'url("' + T + '")')
                    }
                    if (isEmptyLadiPage(A)) LadiPageScript.playVideo(this.id, b["option.video_type"], b["option.video_value"], b["option.video_control"]); else {
                        LadiPageScript.pauseAllVideo();
                        var O = !1;
                        if (b["option.video_type"] == LadiPageScript.const.VIDEO_TYPE.youtube) {
            ...
            for (r = 0; r < _.length; r++) isNullLadiPage(t) ? (_[r].classList.contains("selected") && n.push(_[r].getAttribute("data-value")), "true" == a.getAttribute("data-multiple") && (o = !0)) : (P = !1, -1 != d.indexOf(_[r].getAttribute("data-value")) && (P = !0), P ? _[r].classList.contains("selected") || _[r].click() : _[r].classList.contains("selected") && _[r].click())
        }
    ...
    if (!isEmptyLadiPage(e)) {
        ...
        var a = LadiPageScript.runtime.tmp.value_2nd_source[i] || this.value(), n = parseFloatLadiPage(e.getAttribute("data-count-click")) || 0;
    ...
    var t = this.doc || document.getElementById(this.id);
    if (!isEmptyLadiPage(t) && t.classList.contains("ladi-section")) try {
    ...
    if (0 != t.length) for (var e = 0; e < t.length; e++) if (t[e].classList.contains("selected")) {
        var i = e - 1;
    ...
    var t = this.doc || document.getElementById(this.id);
    if (isEmptyLadiPage(t)) this.prevSectionTabs(); else {
        var e = LadiPageScript.runtime.eventData[this.id];
        if (!isEmptyLadiPage(e)) {
            var i = null;
            if ("gallery" == e.type && (i = t.querySelector(".ladi-gallery-view-arrow.ladi-gallery-view-arrow-left")), "carousel" == e.type && (i = t.querySelector(".ladi-carousel-arrow.ladi-carousel-arrow-left")), "collection" == e.type && (i = t.querySelector(".ladi-collection-arrow.ladi-collection-arrow-left")), "tabs" == e.type) {
                ...
                return isEmptyLadiPage(a) && (a = t.querySelector(".ladi-tabs > .ladi-element")), void (isEmptyLadiPage(a) || isEmptyLadiPage(a.previousElementSibling) || (a.previousElementSibling.classList.add("selected"), a.classList.remove("selected"), LadiPageScript.reloadLazyload(!1)))
            }
    ...
    var t = this.doc || document.getElementById(this.id);
    if (isEmptyLadiPage(t)) this.nextSectionTabs(); else {
        var e = LadiPageScript.runtime.eventData[this.id];
        if (!isEmptyLadiPage(e)) {
            var i = null;
            if ("gallery" == e.type && (i = t.querySelector(".ladi-gallery-view-arrow.ladi-gallery-view-arrow-right")), "carousel" == e.type && (i = t.querySelector(".ladi-carousel-arrow.ladi-carousel-arrow-right")), "collection" == e.type && (i = t.querySelector(".ladi-collection-arrow.ladi-collection-arrow-right, .ladi-collection-button-next")), "survey" == e.type && (i = t.querySelector(".ladi-survey-button-next button")), "tabs" == e.type) {
                var a = t.querySelector(".ladi-tabs > .ladi-element.selected[data-index]");
                return isEmptyLadiPage(a) && (a = t.querySelector(".ladi-tabs > .ladi-element")), void (isEmptyLadiPage(a) || isEmptyLadiPage(a.nextElementSibling) || (a.nextElementSibling.classList.add("selected"), a.classList.remove("selected"), LadiPageScript.reloadLazyload(!1)))
            }
            isEmptyLadiPage(i) || i.click()
        }
    }
    ...
    var e = this.doc || document.getElementById(this.id);
    if (isEmptyLadiPage(e)) this.indexSectionTabs(t); else {
    ...
    var e = this, i = this.doc || document.getElementById(this.id);
    if (!isEmptyLadiPage(i)) {
        var a = null;
        if (i.classList.contains("ladi-section")) a = i.getElementsByClassName("ladi-section-arrow-down")[0], isEmptyLadiPage(a) || a.click(); else {
    ...
    if (!isEmptyLadiPage(e) && !e.classList.contains("ladi-section")) {
        ...
        if (isEmptyLadiPage(i)) {
            var a = isNullLadiPage(t), n = document.querySelector(["#" + this.id + " > .ladi-headline", "#" + this.id + " > .ladi-paragraph", "#" + this.id + " > .ladi-list-paragraph"].join(", ")), o = isEmptyLadiPage(n), r = 0, d = 0, s = null, l = this, c = function (t) {
            ...
            if ("none" == getComputedStyle(e).display) {
                if (a || t) if (a && o) {
                    ...
                    e.classList.remove("height-0"), e.classList.remove("overflow-hidden"), e.classList.remove("transition-collapse"), l.show(), d = parseFloatLadiPage(getComputedStyle(e).height) || 0, e.classList.add("overflow-hidden"), e.classList.add("height-0"), s = LadiPageScript.runTimeout(function () {
                        e.classList.add("transition-collapse"), e.classList.remove("height-0"), s = LadiPageScript.runTimeout(function () {
                            e.classList.remove("overflow-hidden"), e.classList.remove("transition-collapse"), e.removeAttribute("data-timeout-id")
                        }, 1e3 * parseFloatLadiPage(getComputedStyle(e).transitionDuration)), e.setAttribute("data-timeout-id", s), c(!0)
                    }, 100), e.setAttribute("data-timeout-id", s)
                } else l.show(), d = parseFloatLadiPage(getComputedStyle(e).height) || 0, c()
            } else if (a || !t) if (a && o) {
                if (s = parseFloatLadiPage(e.getAttribute("data-timeout-id")) || null, !isEmptyLadiPage(s)) return;
                e.classList.remove("height-0"), e.classList.remove("overflow-hidden"), e.classList.remove("transition-collapse"), r = parseFloatLadiPage(getComputedStyle(e).height) || 0, e.classList.add("overflow-hidden"), s = LadiPageScript.runTimeout(function () {
                    e.classList.add("transition-collapse"), e.classList.add("height-0"), s = LadiPageScript.runTimeout(function () {
    ...
    if (!(isEmptyLadiPage(a) || "true" != a.getAttribute("data-dropbox") || i && a.getAttribute("data-from-doc-id") == t.id && "true" != a.getAttribute("data-dropbox-backdrop") && "block" == getComputedStyle(a).display)) {
        ...
        var o = LadiPageScript.getElementBoundingClientRect(t), r = LadiPageScript.getElementBoundingClientRect(a), d = "";
        ...
        var s = "dropbox-" + a.id;
        if (i && !isEmptyLadiPage(d)) d = "#" + a.id + ":before {" + d + "}", LadiPageScript.createStyleElement(s, d); else {
            var l = document.getElementById(s);
            isEmptyLadiPage(l) || l.parentElement.removeChild(l)
        }
        if (i) a.removeAttribute("data-dropbox-backdrop"); else a.setAttribute("data-dropbox-backdrop", !0), document.getElementById(LadiPageScript.runtime.backdrop_dropbox_id).style.setProperty("display", "block");
    ...
    if (!isEmptyLadiPage(t) && "true" == t.getAttribute("data-dropbox")) {
        ...
        var a = "dropbox-" + t.id, n = document.getElementById(a);
    ...
    var a = this.doc || document.getElementById(this.id);
    if (!isEmptyLadiPage(a)) {
        var n = e.action_type, o = "set-style-" + t.id + "-" + a.id + "-" + n, r = "set-style-" + t.id + "-" + a.id + "-" + n + "-transition", d = document.getElementById(i ? r : o);
        isEmptyLadiPage(d) || d.parentElement.removeChild(d), a.classList.remove(o);
        var s = {};
        isEmptyLadiPage(e.color) || (s.color = e.color), isEmptyLadiPage(e.background_color) || (s.background = "none", s["background-color"] = e.background_color), isEmptyLadiPage(e.border_color) || (s["border-color"] = e.border_color), isEmptyLadiPage(e.opacity) || (s.opacity = e.opacity / 100), isEmptyLadiPage(e.transform_scale) || (s.transform = "scale(" + e.transform_scale / 100 + ")"), e.ontop && (s["z-index"] = "9000000090 !important"), isObjectLadiPage(e.custom_css) && Object.keys(e.custom_css).forEach(function (t) {
            s[t] = e.custom_css[t]
        });
        var l = [], c = "", u = "", p = "", m = "", g = "", _ = "", y = !1;
        Object.keys(s).forEach(function (t) {
            "z-index" != t.toLowerCase() ? "background" == t.toLowerCase() || t.toLowerCase().startsWith("background-") ? p += t + ": " + s[t] + ";" : "color" == t.toLowerCase() || "font" == t.toLowerCase() || t.toLowerCase().startsWith("font-") || t.toLowerCase().startsWith("text-") || t.toLowerCase().startsWith("line-") ? m += t + ": " + s[t] + ";" : u += t + ": " + s[t] + ";" : _ += t + ": " + s[t] + ";"
        });
        var f = function (t) {
...
isArrayLadiPage(window.ladi_fbq_data) && (window.ladi_fbq_data.forEach(function (t) {
    ...
    var i = function () {
    }, a = "top_left", n = "top_center", o = "top_right", r = "bottom_left", d = "bottom_center", s = "bottom_right";
    return i.prototype.run = function (e, i) {
        ...
        var l = t["option.sheet_id"], c = t.dataset_value, u = document.getElementById(e);
        if (u.classList.add("ladi-hidden"), !isEmptyLadiPage(l) || !isEmptyLadiPage(c)) {
            var p = i ? LadiPageScript.const.DESKTOP : LadiPageScript.const.MOBILE, m = t[p + ".option.position"], g = 1e3 * (parseFloatLadiPage(t["option.time_show"]) || 5), _ = 1e3 * (parseFloatLadiPage(t["option.time_delay"]) || 10);
            _ = _ < 501 ? 501 : _;
            var y = "https://w.ladicdn.com/source/notify.svg", f = [{key: "gsx$title", className: ".ladi-notify-title"}, {key: "gsx$content", className: ".ladi-notify-content"}, {key: "gsx$time", className: ".ladi-notify-time"}, {key: "gsx$image", className: ".ladi-notify-image img"}];
            u.classList.remove("ladi-hidden");
            var v = function () {
                u.style.setProperty("opacity", 0), m != a && m != n && m != o || u.style.setProperty("top", -u.clientHeight - 100 + "px"), m != r && m != d && m != s || u.style.setProperty("bottom", -u.clientHeight - 100 + "px")
            };
            ...
            var P = function (t) {
                ...
                var i = -1, l = function () {
                    if (i + 1 < t.length) {
                        var c = t[++i], p = Object.keys(c);
                        u.style.removeProperty("opacity"), m != a && m != n && m != o || u.style.removeProperty("top"), m != r && m != d && m != s || u.style.removeProperty("bottom"), f.forEach(function (t) {
            ...
            isEmptyLadiPage(c) || h(c), isEmptyLadiPage(l) || LadiPageScript.sendRequest("GET", "https://docs.google.com/spreadsheets/d/" + l + "/gviz/tq?tqx=out:json", null, !0, null, function (t, e, i) {
                if (i.readyState == XMLHttpRequest.DONE && 200 == e) {
                    t = (t = t.substr(t.indexOf('"table":{') + '"table":'.length)).substr(0, t.indexOf("});"));
                    var a = JSON.parse(t), n = [], o = a.cols;
    ...
    return i.prototype.getEventTrackingCategory = function () {
        ...
        var n = t["option.spinlucky_setting.list_value"], o = t.dataset_value, r = t["option.spinlucky_setting.result_popup_id"], d = t["option.spinlucky_setting.result_message"], s = t["option.spinlucky_setting.max_turn"], l = a(e);
        if (!isEmptyLadiPage(n) || !isEmptyLadiPage(o)) {
            n = n || o, LadiPageScript.setDataReplaceStr("spin_turn_left", s - l);
            var c = document.getElementById(e), u = c.getElementsByClassName("ladi-spin-lucky-start")[0], p = c.getElementsByClassName("ladi-spin-lucky-screen")[0], m = "";
            n.forEach(function (t, e) {
                var i = Base64.decode(t).split("|");
                if (3 == i.length) {
                    var a = 360 / n.length * e + 180 / n.length, o = "rotate(" + (a *= -1) + "deg) translateY(-50%)";
                    m += '<div class="ladi-spin-lucky-label" style="transform: ' + o + "; -webkit-transform: " + o + ';">' + decodeURIComponentLadiPage(i[1].trim()) + "</div>"
                }
            }), p.innerHTML = m;
            var g = !1;
            u.addEventListener("click", function (t) {
                if (t.stopPropagation(), !g) if ((l = a(e)) >= s) LadiPageScript.showMessage(LadiPageScript.const.LANG.GAME_MAX_TURN_MESSAGE.format(s)); else {
                    g = !0;
                    var i = [], o = 0, c = 1;
                    n.forEach(function (t, e) {
                        var a = Base64.decode(t).split("|"), n = decodeURIComponentLadiPage(a[0].trim()), r = decodeURIComponentLadiPage(a[1].trim()), d = parseFloatLadiPage(decodeURIComponentLadiPage(a[2].trim())) || 0;
                        i.push({min: c, max: c + d - 1, value: n, text: r, percent: d, index: e}), c += d, o += d
                    });
                    for (var u = LadiPageScript.randomInt(1, o), m = null, _ = 0; _ < i.length; _++) if (i[_].min <= u && i[_].max >= u) {
                        m = i[_];
                        break
                    }
                    if (isEmptyLadiPage(m)) g = !1; else {
                        var y = parseFloatLadiPage(p.getAttribute("data-rotate")) || 0, f = m.index * (360 / i.length) + 360 * (4 + Math.ceil(y / 360)) + 180 / i.length, v = "rotate(" + f + "deg)";
                        p.setAttribute("data-rotate", f), p.style.setProperty("transform", v), p.style.setProperty("-webkit-transform", v), "NEXT_TURN" != m.value.toUpperCase() && (l++, window.ladi("_total_turn_" + e).set_cookie(l, 1));
                        LadiPageScript.runTimeout(function () {
                            "NEXT_TURN" == m.value.toUpperCase() ? isEmptyLadiPage(m.text) || LadiPageScript.showMessage(m.text) : (LadiPageScript.setDataReplaceStr("coupon", m.value), LadiPageScript.setDataReplaceStr("coupon_code", m.value), LadiPageScript.setDataReplaceStr("coupon_text", m.text), LadiPageScript.setDataReplaceStr("spin_turn_left", s - l), LadiPageScript.setDataReplaceElement(!0, !1, null, null, ["coupon", "coupon_code", "coupon_text", "spin_turn_left"]), r == LadiPageScript.const.GAME_RESULT_TYPE.default ? isEmptyLadiPage(d) || LadiPageScript.showMessage(d) : window.ladi(r).show(), LadiPageScript.runEventTracking(e, {is_form: !1})), g = !1
